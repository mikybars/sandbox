...
@XmlRootElement(name = "GETEMPLEADOSDESPENT")
public class GETEMPLEADOSDESPENT implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GETEMPLEADOSDESPENT that = ((GETEMPLEADOSDESPENT) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GETEMPLEADOSDESPENT) {
            final GETEMPLEADOSDESPENT copy = ((GETEMPLEADOSDESPENT) draftCopy);
            {
