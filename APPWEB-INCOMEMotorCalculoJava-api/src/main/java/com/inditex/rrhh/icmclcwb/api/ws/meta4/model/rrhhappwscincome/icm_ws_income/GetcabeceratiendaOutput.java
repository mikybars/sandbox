...
public class GetcabeceratiendaOutput implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GetcabeceratiendaOutput that = ((GetcabeceratiendaOutput) object);
        {
            double lhsReturn;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GetcabeceratiendaOutput) {
            final GetcabeceratiendaOutput copy = ((GetcabeceratiendaOutput) draftCopy);
            {
