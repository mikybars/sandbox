 ...
 *         &lt;element name="Icm_GlobalempleadoRecordSet" type="{http://schemas.meta4.com/}ArrayOfIcm_GlobalempleadoRecord"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IcmGlobalempleadoBlock {
    ...
    @XmlElement(name = "Icm_GlobalempleadoRecordSet", required = true, nillable = true)
    protected ArrayOfIcmGlobalempleadoRecord icmGlobalempleadoRecordSet;
    ...
    /**
     * Obtiene el valor de la propiedad icmGlobalempleadoRecordSet.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfIcmGlobalempleadoRecord }
     *     
     */
    public ArrayOfIcmGlobalempleadoRecord getIcmGlobalempleadoRecordSet() {
        return icmGlobalempleadoRecordSet;
    }

    /**
     * Define el valor de la propiedad icmGlobalempleadoRecordSet.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfIcmGlobalempleadoRecord }
     *     
     */
    public void setIcmGlobalempleadoRecordSet(ArrayOfIcmGlobalempleadoRecord value) {
        this.icmGlobalempleadoRecordSet = value;
    }
