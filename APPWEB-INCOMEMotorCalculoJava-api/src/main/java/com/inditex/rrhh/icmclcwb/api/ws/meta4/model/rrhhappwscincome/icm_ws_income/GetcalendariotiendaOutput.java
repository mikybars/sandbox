...
public class GetcalendariotiendaOutput implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GetcalendariotiendaOutput that = ((GetcalendariotiendaOutput) object);
        {
            double lhsReturn;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GetcalendariotiendaOutput) {
            final GetcalendariotiendaOutput copy = ((GetcalendariotiendaOutput) draftCopy);
            {
