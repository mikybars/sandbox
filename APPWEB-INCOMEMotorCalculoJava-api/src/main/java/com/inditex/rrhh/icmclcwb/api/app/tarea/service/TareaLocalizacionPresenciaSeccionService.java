...
public interface TareaLocalizacionPresenciaSeccionService {

    List<TareaLocalizacionPresenciaSeccionDto> save(@Valid final List<PtrPresenciaTotalizadoResultItemDto> dto,
