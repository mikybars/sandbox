...
public enum TipoCalculoEnum {
    ...
    POR_VENTA_INDIVIDUAL("009"), CHALLENGE_PRECIO_HORA_TIENDA("010"), CHALLENGE_PRECIO_HORA_SECCION("011"),
    CHALLENGE_IMPORTE_TIENDA("012"), CHALLENGE_IMPORTE_SECCION("013"), PRECIO_HORA("014");
