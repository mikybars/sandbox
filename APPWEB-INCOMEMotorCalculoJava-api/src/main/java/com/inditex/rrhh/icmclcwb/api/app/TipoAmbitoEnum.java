...
public enum TipoAmbitoEnum {
    ...
    SOCIEDAD(1L, "1", new TipoAmbitoDto(1L)), ORIGEN(2L, "2", new TipoAmbitoDto(2L)),
    EMPRESA(3L, "3", new TipoAmbitoDto(3L)), LOCALIZACION(4L, "4", new TipoAmbitoDto(4L)),
    PERSONA(5L, "5", new TipoAmbitoDto(5L));
