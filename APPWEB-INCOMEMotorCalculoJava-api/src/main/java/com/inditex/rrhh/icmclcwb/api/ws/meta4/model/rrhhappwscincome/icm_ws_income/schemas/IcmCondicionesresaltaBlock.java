 ...
 *         &lt;element name="Icm_CondicionesresaltaRecordSet" type="{http://schemas.meta4.com/}ArrayOfIcm_CondicionesresaltaRecord"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IcmCondicionesresaltaBlock {
    ...
    @XmlElement(name = "Icm_CondicionesresaltaRecordSet", required = true, nillable = true)
    protected ArrayOfIcmCondicionesresaltaRecord icmCondicionesresaltaRecordSet;
    ...
    /**
     * Obtiene el valor de la propiedad icmCondicionesresaltaRecordSet.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfIcmCondicionesresaltaRecord }
     *     
     */
    public ArrayOfIcmCondicionesresaltaRecord getIcmCondicionesresaltaRecordSet() {
        return icmCondicionesresaltaRecordSet;
    }

    /**
     * Define el valor de la propiedad icmCondicionesresaltaRecordSet.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfIcmCondicionesresaltaRecord }
     *     
     */
    public void setIcmCondicionesresaltaRecordSet(ArrayOfIcmCondicionesresaltaRecord value) {
        this.icmCondicionesresaltaRecordSet = value;
    }
