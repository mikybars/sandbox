...
public class IcmCondicionespoliticasBlock implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IcmCondicionespoliticasBlock that = ((IcmCondicionespoliticasBlock) object);
        {
        ...
        {
            List<IcmCondicionespoliticasRecord> lhsIcmCondicionespoliticasRecordSet;
            lhsIcmCondicionespoliticasRecordSet = (((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty()))?this.getIcmCondicionespoliticasRecordSet():null);
            List<IcmCondicionespoliticasRecord> rhsIcmCondicionespoliticasRecordSet;
            rhsIcmCondicionespoliticasRecordSet = (((that.icmCondicionespoliticasRecordSet!= null)&&(!that.icmCondicionespoliticasRecordSet.isEmpty()))?that.getIcmCondicionespoliticasRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmCondicionespoliticasRecordSet", lhsIcmCondicionespoliticasRecordSet), LocatorUtils.property(thatLocator, "icmCondicionespoliticasRecordSet", rhsIcmCondicionespoliticasRecordSet), lhsIcmCondicionespoliticasRecordSet, rhsIcmCondicionespoliticasRecordSet, ((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty())), ((that.icmCondicionespoliticasRecordSet!= null)&&(!that.icmCondicionespoliticasRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<IcmCondicionespoliticasRecord> theIcmCondicionespoliticasRecordSet;
            theIcmCondicionespoliticasRecordSet = (((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty()))?this.getIcmCondicionespoliticasRecordSet():null);
            strategy.appendField(locator, this, "icmCondicionespoliticasRecordSet", buffer, theIcmCondicionespoliticasRecordSet, ((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmCondicionespoliticasRecord> theIcmCondicionespoliticasRecordSet;
            theIcmCondicionespoliticasRecordSet = (((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty()))?this.getIcmCondicionespoliticasRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmCondicionespoliticasRecordSet", theIcmCondicionespoliticasRecordSet), currentHashCode, theIcmCondicionespoliticasRecordSet, ((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmCondicionespoliticasBlock) {
            final IcmCondicionespoliticasBlock copy = ((IcmCondicionespoliticasBlock) draftCopy);
            {
            ...
            {
                Boolean icmCondicionespoliticasRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty())));
                if (icmCondicionespoliticasRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<IcmCondicionespoliticasRecord> sourceIcmCondicionespoliticasRecordSet;
                    sourceIcmCondicionespoliticasRecordSet = (((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty()))?this.getIcmCondicionespoliticasRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmCondicionespoliticasRecord> copyIcmCondicionespoliticasRecordSet = ((List<IcmCondicionespoliticasRecord> ) strategy.copy(LocatorUtils.property(locator, "icmCondicionespoliticasRecordSet", sourceIcmCondicionespoliticasRecordSet), sourceIcmCondicionespoliticasRecordSet, ((this.icmCondicionespoliticasRecordSet!= null)&&(!this.icmCondicionespoliticasRecordSet.isEmpty()))));
                    copy.icmCondicionespoliticasRecordSet = null;
                    if (copyIcmCondicionespoliticasRecordSet!= null) {
                        List<IcmCondicionespoliticasRecord> uniqueIcmCondicionespoliticasRecordSetl = copy.getIcmCondicionespoliticasRecordSet();
                        uniqueIcmCondicionespoliticasRecordSetl.addAll(copyIcmCondicionespoliticasRecordSet);
                    }
                } else {
                    if (icmCondicionespoliticasRecordSetShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.icmCondicionespoliticasRecordSet = null;
                    }
                }
            }
