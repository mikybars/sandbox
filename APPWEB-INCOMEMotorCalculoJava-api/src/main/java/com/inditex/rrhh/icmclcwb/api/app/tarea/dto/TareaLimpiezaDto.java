...
public class TareaLimpiezaDto implements Serializable {
    ...
    @ApiModelProperty(value = "Fecha en la que se realizó la limpieza", required = false, accessMode = AccessMode.READ_ONLY, hidden = true)
    private LocalDateTime fechaHoraLimpieza;
    
    @ApiModelProperty(value = "Nombre del usuario que solicito la limpieza", required = false, accessMode = AccessMode.READ_ONLY, hidden = true, example = "IAGOML")
