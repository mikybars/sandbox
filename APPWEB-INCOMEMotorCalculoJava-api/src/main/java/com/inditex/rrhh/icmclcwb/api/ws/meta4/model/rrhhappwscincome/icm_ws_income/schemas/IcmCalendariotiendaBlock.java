 ...
 *         &lt;element name="Icm_CalendariotiendaRecordSet" type="{http://schemas.meta4.com/}ArrayOfIcm_CalendariotiendaRecord"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class IcmCalendariotiendaBlock {
    ...
    @XmlElement(name = "Icm_CalendariotiendaRecordSet", required = true, nillable = true)
    protected ArrayOfIcmCalendariotiendaRecord icmCalendariotiendaRecordSet;
    ...
    /**
     * Obtiene el valor de la propiedad icmCalendariotiendaRecordSet.
     * 
     * @return
     *     possible object is
     *     {@link ArrayOfIcmCalendariotiendaRecord }
     *     
     */
    public ArrayOfIcmCalendariotiendaRecord getIcmCalendariotiendaRecordSet() {
        return icmCalendariotiendaRecordSet;
    }

    /**
     * Define el valor de la propiedad icmCalendariotiendaRecordSet.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayOfIcmCalendariotiendaRecord }
     *     
     */
    public void setIcmCalendariotiendaRecordSet(ArrayOfIcmCalendariotiendaRecord value) {
        this.icmCalendariotiendaRecordSet = value;
    }
