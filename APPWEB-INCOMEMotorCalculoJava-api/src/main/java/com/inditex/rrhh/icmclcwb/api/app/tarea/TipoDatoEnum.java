...
public enum TipoDatoEnum {
    ...
    OPERACION_DEVOLUCION_ONLINE_IPOD_LOCALIZACION_SECCION(2014), VENTA_RANGO_CONGELADA_FISICA_CAJA_LOCALIZACION(2015),
    VENTA_RANGO_CONGELADA_FISICA_CAJA_LOCALIZACION_SECCION(2016), VENTA_RANGO_CONGELADA_FISICA_DEVOLUCION_LOCALIZACION(2017),
    VENTA_RANGO_CONGELADA_FISICA_DEVOLUCION_LOCALIZACION_SECCION(2018), VENTA_RANGO_CONGELADA_ONLINE_ENTREGADOMICILIO_LOCALIZACION(2019),
    VENTA_RANGO_CONGELADA_ONLINE_ENTREGADOMICILIO_LOCALIZACION_SECCION(2020), VENTA_RANGO_CONGELADA_ONLINE_IPOD_LOCALIZACION(2021),
    VENTA_RANGO_CONGELADA_ONLINE_IPOD_LOCALIZACION_SECCION(2022), VENTA_RANGO_CONGELADA_ONLINE_SINT_LOCALIZACION(2023),
    VENTA_RANGO_CONGELADA_ONLINE_SINT_LOCALIZACION_SECCION(2024), VENTA_RANGO_CONGELADA_ONLINE_ENTREGATIENDA_LOCALIZACION(2025),
    VENTA_RANGO_CONGELADA_ONLINE_ENTREGATIENDA_LOCALIZACION_SECCION(2026), VENTA_RANGO_FISICA_CAJA_LOCALIZACION(2027),
    VENTA_RANGO_FISICA_CAJA_LOCALIZACION_SECCION(2028), VENTA_RANGO_FISICA_DEVOLUCION_LOCALIZACION(2029),
    VENTA_RANGO_FISICA_DEVOLUCION_LOCALIZACION_SECCION(2030), VENTA_RANGO_ONLINE_ENTREGADOMICILIO_LOCALIZACION(2031),
    VENTA_RANGO_ONLINE_ENTREGADOMICILIO_LOCALIZACION_SECCION(2032), VENTA_RANGO_ONLINE_IPOD_LOCALIZACION(2033),
    VENTA_RANGO_ONLINE_IPOD_LOCALIZACION_SECCION(2034), VENTA_RANGO_ONLINE_SINT_LOCALIZACION(2035),
    VENTA_RANGO_ONLINE_SINT_LOCALIZACION_SECCION(2036), VENTA_RANGO_ONLINE_ENTREGATIENDA_LOCALIZACION(2037),
    VENTA_RANGO_ONLINE_ENTREGATIENDA_LOCALIZACION_SECCION(2038), VENTA_RANGO_CONGELADA_LOCALIZACION(2039),
    VENTA_RANGO_CONGELADA_LOCALIZACION_SECCION(2040), VENTA_RANGO_LOCALIZACION(2041), VENTA_RANGO_LOCALIZACION_SECCION(2042),
    ...
    PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_INCLUDIOVENTA(5014),
    /* 4000 (Presencia) */
