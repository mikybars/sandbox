...
public enum TipoDatoEnum {
    ...
    VENTA_ONLINE_ENTREGADOMICILIO_LOCALIZACION_SECCION_TRASLADADA_SECCION(3028), DEVOLUCION_LOCALIZACION(3029),
    VENTA_INDIVIDUAL_LOCALIZACION_SECCION(3030), VENTA_INDIVIDUAL_LOCALIZACION(3031), VENTA_LOCALIZACION_EMPLEADOS_POR_VENTA_SIMPLIFICADO(3032),
    VENTA_LOCALIZACION_EMPLEADOS_POR_VENTA(3033),
    /* 4000 (Presencia) */
