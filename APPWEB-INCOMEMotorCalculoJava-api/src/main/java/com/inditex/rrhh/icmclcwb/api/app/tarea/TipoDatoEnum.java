...
public enum TipoDatoEnum {
    ...
    VENTA_ONLINE_ENTREGADOMICILIO_LOCALIZACION_SECCION_TRASLADADA(3012),
    /* 4000 (Presencia) */
    ...
    PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA(5003), PRESENCIA_LOCALIZACION_SECCION_INCLUIDOECOMMERCE(5004),
    PRESENCIA_AGRUPACIONONLINE_INCLUIDOECOMMERCE(5005), INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA(5006),
    INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO(5007),
    /* 6000 (Localizacion) */
