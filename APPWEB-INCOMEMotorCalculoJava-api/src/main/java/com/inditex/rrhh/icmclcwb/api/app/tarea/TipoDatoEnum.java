...
public enum TipoDatoEnum {
    ...
    VENTA_LOCALIZACION_EMPLEADOS_POR_VENTA(3033), VENTA_SIN_DEVOLUCION_LOCALIZACION_SECCION(3034), IMPORTE_COMISION_VENTA_LOCALIZACION_POR_VENTA(3035),
    IMPORTE_COMISION_DEVOLUCIONES_LOCALIZACION_POR_VENTA(3036),
    /* 4000 (Presencia) */
