...
public class RunTareaValidarCondicionesHistoricoChallengeIncluidoPorcentajeServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesHistoricoChallengeIncluidoPorcentajeService runTareaAmbitoValidarCondicionesHistoricoChallengeIncluidoPorcentajeService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesHistoricoChallengeIncluidoPorcentajeServiceImpl runTareaValidarCondicionesHistoricoChallengeIncluidoPorcentajeService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesHistoricoChallengeIncluidoPorcentajeService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesHistoricoChallengeIncluidoPorcentajeService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesHistoricoChallengeIncluidoPorcentajeService, timeout(1000).times(1))
        .execute(
