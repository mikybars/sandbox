...
public class DirectoVentaManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaManualV1RunAlgoritmo directoVentaManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaManualV1RunAlgoritmo.execute(runTarea, algoritmo);
