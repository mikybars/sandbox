...
public class TareaPersonaEstructuraPoliticaDecoratorTest {
    ...
    void tareaPersonaEstructuraPoliticaDtoToTareaPersonaEstructuraPoliticaTest (
        ...
        doReturn(tareaPersonaEstructuraPolitica).when(this.delegate).tareaPersonaEstructuraPoliticaDtoToTareaPersonaEstructuraPolitica
            (this.tareaPersonaEstructuraPoliticaDto);

        doReturn(politica).when(this.tipoPoliticaService).findByIdMeta4
            (this.tareaPersonaEstructuraPoliticaDto.getIdTipoPolitica());
    ...
    void estructurasPolResultItemDtoToTareaPersonaEstructuraPoliticaTest (
        ...
        List<TareaPersonaEstructuraPolitica> result = this.tareaPersonaEstructuraPoliticaDecorator
            .estructurasPolResultItemDtoToTareaPersonaEstructuraPolitica
                (this.estructurasPolResultItemDtoList, this.tarea);
