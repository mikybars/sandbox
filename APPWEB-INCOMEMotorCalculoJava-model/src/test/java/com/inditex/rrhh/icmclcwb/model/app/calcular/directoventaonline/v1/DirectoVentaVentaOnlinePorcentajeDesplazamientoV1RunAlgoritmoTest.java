...
class DirectoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
    ...
    @Mock
    private TareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom
        tareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom;
    ...
    @InjectMocks
    private DirectoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo
        directoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo;
    ...
    void getSqlCalcularTest(@Random final AlgoritmoDTO algoritmo) {
        ...
        final String result = this.directoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);

        verify(this.tareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom, times(1))
    ...
    void calcularTest(@Random final AlgoritmoDTO algoritmo, @Random final RunTareaDto runTarea,
        ...
        when(this.tareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom.ids(any(AlgoritmoDTO.class),
            any(TareaDto.class)))
            .thenReturn(personas);
        when(this.tareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom
        ...
        verify(this.log, times(1)).info(
            ...
            "DirectoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea);
        verify(this.log, times(1)).info(
            "Trabajo[{}]Tarea[{}] :: Fin :: {} :: Ids: {}",
            "DirectoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea, personas);
        verify(this.log, times(1)).info(
            "Trabajo[{}]Tarea[{}] :: Inicio :: {} :: Personas: {}",
            "DirectoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea, 3);
        verify(this.log, times(1)).info(
    ...
    void calcularExceptionTest(@Random final AlgoritmoDTO algoritmo, @Random final RunTareaDto runTarea,
        ...
        doThrow(exception).when(this.tareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom).calcular(
        ...
        verify(this.log, times(1)).error(
            ...
            "DirectoVentaVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea, 3, exception);
