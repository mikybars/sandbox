...
public class ResaltamanualDesplazamientoBaseV1RunAlgoritmoTest {
    ...
    @InjectMocks
    private ResaltaManualDesplazamientoBaseV1RunAlgoritmo resaltaManualDesplazamientoBaseV1RunAlgoritmo;

    @Test
    public void getSqlCalcularTest() {
        when(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);
        assertEquals(SQL_CALCULAR,
                this.resaltaManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto()));
    }
    ...
    public void calcularTest() {
        ...
        this.resaltaManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(this.log, times(1)).info("Inicio :: ResaltaManualDesplazamientoBaseV1RunAlgoritmo :: Personas: {}", 3);
        verify(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info("Fin :: ResaltaManualDesplazamientoBaseV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom)
        ...
        verify(this.log, times(1))
            .error("ResaltaManualDesplazamientoBaseV1RunAlgoritmo :: KO :: Personas: {}", 2, exception);
