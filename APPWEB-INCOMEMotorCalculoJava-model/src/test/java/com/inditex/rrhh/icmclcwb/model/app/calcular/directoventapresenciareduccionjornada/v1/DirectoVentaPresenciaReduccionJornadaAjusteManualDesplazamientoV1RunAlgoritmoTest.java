...
public class DirectoVentaPresenciaReduccionJornadaAjusteManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaPresenciaReduccionJornadaAjusteManualDesplazamientoV1RunAlgoritmo directoVentaPresenciaReduccionJornadaAjusteManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaPresenciaReduccionJornadaAjusteManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaPresenciaReduccionJornadaAjusteManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
