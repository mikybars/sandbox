...
public class DirectoVentaAjusteManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaAjusteManualV1RunAlgoritmo directoVentaAjusteManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaAjusteManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaAjusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);
