...
public class TareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImpl,
                "sqlCalcular",
                SQL_CALCULAR, true);
        FieldUtils.writeField(this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImpl,
    ...
    public void idsTest() {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImpl
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        final Map<String, Object> result = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImpl
    ...
    public void calcularTest() {
        ...
        this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImpl.calcular(algoritmo, tarea,
                personas);
    ...
    public void getSqlCalcularTest() {
        ...
        final String result = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeV1RepositoryCustomImpl
