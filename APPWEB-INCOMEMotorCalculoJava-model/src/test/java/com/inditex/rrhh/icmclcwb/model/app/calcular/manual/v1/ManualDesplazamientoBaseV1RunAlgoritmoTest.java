...
public class ManualDesplazamientoBaseV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.log, times(1)).info("Inicio :: ManualDesplazamientoBaseV1RunAlgoritmo :: Personas: {}", 3);
        verify(this.tareaCalculoAlgoritmoManualDesplazamientoBaseV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info("Fin :: ManualDesplazamientoBaseV1RunAlgoritmo :: Personas: {}", 3);
    }
