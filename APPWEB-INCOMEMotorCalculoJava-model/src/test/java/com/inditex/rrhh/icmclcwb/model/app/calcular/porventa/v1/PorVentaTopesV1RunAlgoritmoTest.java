...
public class PorVentaTopesV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaTopesV1RunAlgoritmo porVentaTopesV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaTopesV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaTopesV1RunAlgoritmo.execute(runTarea, algoritmo);
