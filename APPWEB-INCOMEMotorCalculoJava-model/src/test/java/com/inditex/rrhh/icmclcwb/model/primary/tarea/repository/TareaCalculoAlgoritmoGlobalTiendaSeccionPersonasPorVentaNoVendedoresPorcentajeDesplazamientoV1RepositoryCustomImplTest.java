...
class TareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustomImplTest {
  ...
  @Spy
  @InjectMocks
  TareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom;
  ...
  void idsTest(@Random(type = IdPersonaLocalDto.class, size = 2) final List<IdPersonaLocalDto> idPersonaLocalDtoList) {
    ...
    final List<IdPersonaLocalDto> result =
        this.tareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom
  ...
  void getSqlCalcularTest() {
    ...
    verify(this.tareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom,
