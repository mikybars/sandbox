...
public class GlobalTiendaManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaManualDesplazamientoV1RunAlgoritmo globalTiendaManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
