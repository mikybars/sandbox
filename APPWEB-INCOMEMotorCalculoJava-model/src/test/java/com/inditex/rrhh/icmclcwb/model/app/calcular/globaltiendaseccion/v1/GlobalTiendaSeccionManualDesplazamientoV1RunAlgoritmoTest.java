...
public class GlobalTiendaSeccionManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaSeccionManualDesplazamientoV1RunAlgoritmo globalTiendaSeccionManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaSeccionManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaSeccionManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
