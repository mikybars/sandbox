...
public class TareaConfiguracionChallengeDiasMinimosRepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaConfiguracionChallengeDiasMinimosRepositoryCustomImpl, "batchSize", 100, true);
    FieldUtils.writeField(this.tareaConfiguracionChallengeDiasMinimosRepositoryCustomImpl, "sqlSave", SQL_SAVE,
        true);
  }

  @Test
  public void save() {
    final List<TareaConfiguracionChallengeDiasMinimos> items = Collections
        .singletonList(mock(TareaConfiguracionChallengeDiasMinimos.class));
    this.tareaConfiguracionChallengeDiasMinimosRepositoryCustomImpl.save(items);
