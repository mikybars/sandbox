...
public class RunTareaValidarCondicionesResaltaSinChallengeServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesResaltaSinChallengeService runTareaAmbitoValidarCondicionesResaltaSinChallengeService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesResaltaSinChallengeServiceImpl runTareaValidarCondicionesResaltaSinChallengeServiceImpl;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesResaltaSinChallengeService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesResaltaSinChallengeServiceImpl.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesResaltaSinChallengeService, timeout(1000).times(1))
        .execute(
