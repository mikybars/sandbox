...
public class TareaFaseAccionRepositoryCustomImplTest {
    ...
    private final static String SQL_FIND_TAREA_FASE_ACCION_DTO_BY_ID_TAREA_AND_ID_FASE_AND_ID_PUNTO_EJECUCION = "SQL FIND TAREA FASE ACCION DTO BY ID TAREA AND ID FASE AND ID PUNTO EJECUCION";

    private final static String SQL_FIND_TAREA_FASE_ACCION_DTO_BY_ID_TAREA_AND_ID_FASE_AND_ID_ACCION_AND_ID_PUNTO_EJECUCION = "SQL FIND TAREA FASE ACCION DTO BY ID TAREA AND ID FASE AND ID ACCION AND ID PUNTO EJECUCION";

    private final static String SQL_FIND_VALIDACION_PESO_BY_ID_TAREA_AND_ID_FASE_AND_ID_PUNTO_EJECUCION = "SQL FIND VALIDACION PESO BY ID TAREA AND ID FASE AND ID PUNTO EJECUCION";
    ...
    private final static String SQL_UPDATE_FECHA_INICIO_FECHA_FIN_AND_ESTADO_AND_ACTIVO_BY_ID_TAREA_AND_ESTADO_ACTUAL = "SQL UPDATE FECHA INICIO FECHA FIN AND ESTADO AND ACTIVO BY ID TAREA AND ESTADO ACTUAL";

    private final static String SQL_COUNT_REINTENTOS_BY_ID_TAREA_AND_ID_ACCION_AND_ID_ESTADO = "SQL COUNT REINTENTOS BY ID TAREA AND ID ACCION AND ID ESTADO";
