...
public class GlobalTiendaSeccionManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaSeccionManualV1RunAlgoritmo globalTiendaSeccionManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaSeccionManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaSeccionManualV1RunAlgoritmo.execute(runTarea, algoritmo);
