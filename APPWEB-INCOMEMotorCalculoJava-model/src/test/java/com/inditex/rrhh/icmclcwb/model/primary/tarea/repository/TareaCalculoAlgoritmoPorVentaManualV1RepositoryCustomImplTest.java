...
public class TareaCalculoAlgoritmoPorVentaManualV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoPorVentaManualV1RepositoryCustomImpl
        tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
            tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom.ids(algoritmo, tarea);
...
//        when(persona1.getStdOrHrPeriod()).thenReturn("01");
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
...
//        when(persona2.getStdOrHrPeriod()).thenReturn("02");
        ...
        tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom.calcular(algoritmo, tarea, personas);
...
//        when(algoritmo.getId()).thenReturn(21);
        ...
        String result = tareaCalculoAlgoritmoPorVentaManualV1RepositoryCustom
