...
public class TareaCalculoAjusteBajaItRepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAjusteBajaItRepositoryCustomImpl, "sqlAjustar", SQL_AJUSTAR, true);
        FieldUtils.writeField(tareaCalculoAjusteBajaItRepositoryCustomImpl, "sqlAjustarBase", SQL_AJUSTAR_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
                tareaCalculoAjusteBajaItRepositoryCustomImpl.ids(tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAjusteBajaItRepositoryCustomImpl.getMapValues(algoritmoAjuste, tarea, persona1);
        ...
        assertEquals(Arrays.asList(TipoPoliticaEnum.ANTIGUEDAD.getIdMeta4()), result.get(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_POLITICA_AJUSTE));
