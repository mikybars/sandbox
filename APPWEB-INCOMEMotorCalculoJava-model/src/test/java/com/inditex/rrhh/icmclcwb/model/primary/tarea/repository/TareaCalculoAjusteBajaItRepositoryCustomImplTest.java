...
public class TareaCalculoAjusteBajaItRepositoryCustomImplTest {
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAjusteBajaItRepositoryCustomImpl.ids(tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAjusteBajaItRepositoryCustomImpl.getMapValues(algoritmoAjuste, tarea,
                persona1);
