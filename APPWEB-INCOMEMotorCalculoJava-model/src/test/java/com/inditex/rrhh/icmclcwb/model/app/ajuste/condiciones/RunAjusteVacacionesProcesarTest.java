...
class RunAjusteVacacionesProcesarTest {
  ...
  @BeforeEach
  public void setup() {
    when(this.tareaCalculoAjusteVacacionesRepositoryCustom.ids(any(TareaDto.class)))
  ...
  void getSqlCalcularTest() {
    ...
    this.runAjusteVacacionesProcesar.getSqlCalcular(algoritmoAjuste);
    verify(this.tareaCalculoAjusteVacacionesRepositoryCustom, times(1)).getSqlAjustar(algoritmoAjuste);
  }
  ...
  void executeLogIdsTareaTrabajoInicioTest() {
    ...
    verify(this.log, times(1)).info("Trabajo[{}]Tarea[{}] :: Inicio :: RunAjusteVacacionesProcesar :: Ids",
        ID_TRABAJO,
        ID_TAREA);
  }
  ...
  void executeLogIdsTareaTrabajoFinTest() {
    ...
    verify(this.log, times(1)).info("Trabajo[{}]Tarea[{}] :: Fin :: RunAjusteVacacionesProcesar :: Ids: {}",
        ID_TRABAJO,
  ...
  void executeLogInicioTest() {
    ...
    verify(this.log, times(1)).info("Trabajo[{}]Tarea[{}] :: Inicio :: RunAjusteVacacionesProcesar :: Personas: {}",
  ...
  void executeLogFinTest() {
    ...
    verify(this.log, times(1)).info("Fin :: RunAjusteVacacionesProcesar :: Personas: {}",
  ...
  void executeIdsPersonaTest() {
    ...
    verify(this.tareaCalculoAjusteVacacionesRepositoryCustom, times(1)).ids(runTarea.getTarea());
  }
  ...
  void executeExceptionTest() {
    ...
    verify(this.log, times(1)).error("RunAjusteVacacionesProcesar :: KO :: Personas: {}", personas.size(),
        exception);
