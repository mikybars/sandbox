...
public class DirectoVentaPresenciaReduccionJornadaManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaPresenciaReduccionJornadaManualV1RunAlgoritmo directoVentaPresenciaReduccionJornadaManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaPresenciaReduccionJornadaManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaPresenciaReduccionJornadaManualV1RunAlgoritmo.execute(runTarea, algoritmo);
