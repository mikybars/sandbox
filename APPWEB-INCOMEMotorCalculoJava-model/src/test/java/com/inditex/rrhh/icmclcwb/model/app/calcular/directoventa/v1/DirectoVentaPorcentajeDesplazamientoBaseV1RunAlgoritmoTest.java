...
public class DirectoVentaPorcentajeDesplazamientoBaseV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.log, times(1)).info(
                "Inicio :: DirectoVentaPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}",
                3);
        ...
        verify(this.log, times(1)).info("Fin :: DirectoVentaPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}",
                3);
    }
