...
public class PorVentaSimplificadoManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaSimplificadoManualV1RunAlgoritmo porVentaSimplificadoManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaSimplificadoManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaSimplificadoManualV1RunAlgoritmo.execute(runTarea, algoritmo);
