...
class TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustom,
  ...
  void getMapValuesTest(@Random final AlgoritmoDTO algoritmo, @Random final AlgoritmoDTO algoritmo2, @Random final TareaDto tarea,
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustom
    ...
    final Map<String, Object> result2 = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustom
  ...
  void calcularTest(@Random final AlgoritmoDTO algoritmo, @Random final TareaDto tarea,
    ...
    this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustom.calcular(algoritmo,
        tarea,
        personas);
  ...
  void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoV1RepositoryCustom
