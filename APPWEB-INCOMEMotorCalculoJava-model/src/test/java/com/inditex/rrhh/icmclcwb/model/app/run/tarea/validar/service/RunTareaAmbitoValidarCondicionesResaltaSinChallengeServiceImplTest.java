...
public class RunTareaAmbitoValidarCondicionesResaltaSinChallengeServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesResaltaSinChallengeServiceImpl runTareaAmbitoValidarCondicionesResaltaSinChallengeServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesResaltaSinChallenge(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesResaltaSinChallengeServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);

    verify(this.comisAsyncService, timeout(1000).times(1))
        .findCondicionesResaltaSinChallenge(
