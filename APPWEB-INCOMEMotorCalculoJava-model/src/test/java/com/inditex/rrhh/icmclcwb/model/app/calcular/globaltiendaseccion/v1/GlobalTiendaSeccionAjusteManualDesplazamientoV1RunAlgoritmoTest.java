...
public class GlobalTiendaSeccionAjusteManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaSeccionAjusteManualDesplazamientoV1RunAlgoritmo globalTiendaSeccionAjusteManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaSeccionAjusteManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaSeccionAjusteManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
