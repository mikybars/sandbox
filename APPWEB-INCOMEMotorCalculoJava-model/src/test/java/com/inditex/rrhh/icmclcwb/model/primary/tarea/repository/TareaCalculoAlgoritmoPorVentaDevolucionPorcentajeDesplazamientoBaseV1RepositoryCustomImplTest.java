...
class TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustomImpl tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom;

  @BeforeEach
  void setup() throws IllegalAccessException {
    FieldUtils.writeField(
        this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom,
  ...
  void getMapValuesTest(@Random final AlgoritmoDTO algoritmo, @Random final AlgoritmoDTO algoritmo2, @Random final TareaDto tarea,
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom
  ...
  void calcularTest(@Random final AlgoritmoDTO algoritmo, @Random final TareaDto tarea,
    ...
    this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom.calcular(algoritmo,
        tarea,
        personas);
  ...
  void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom
