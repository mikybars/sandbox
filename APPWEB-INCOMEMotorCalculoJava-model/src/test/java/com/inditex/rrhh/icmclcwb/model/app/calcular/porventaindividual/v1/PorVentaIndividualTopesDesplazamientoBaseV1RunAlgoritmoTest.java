...
public class PorVentaIndividualTopesDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualTopesDesplazamientoBaseV1RunAlgoritmo porVentaIndividualTopesDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualTopesDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualTopesDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
