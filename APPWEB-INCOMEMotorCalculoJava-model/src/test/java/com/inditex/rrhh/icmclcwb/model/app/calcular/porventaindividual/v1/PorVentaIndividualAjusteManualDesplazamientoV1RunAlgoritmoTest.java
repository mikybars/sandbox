...
public class PorVentaIndividualAjusteManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualAjusteManualDesplazamientoV1RunAlgoritmo porVentaIndividualAjusteManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualAjusteManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualAjusteManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
