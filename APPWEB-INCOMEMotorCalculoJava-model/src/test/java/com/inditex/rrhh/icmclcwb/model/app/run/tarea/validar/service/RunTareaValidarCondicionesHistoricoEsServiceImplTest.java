...
public class RunTareaValidarCondicionesHistoricoEsServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesHistoricoEsService runTareaAmbitoValidarCondicionesHistoricoEsService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesHistoricoEsServiceImpl runTareaValidarCondicionesHistoricoEsService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesHistoricoEsService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesHistoricoEsService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesHistoricoEsService, timeout(1000).times(1))
        .execute(
