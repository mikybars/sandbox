...
public class TareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustomImpl
        tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
            tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom.ids(algoritmo, tarea);
...
//        when(persona1.getStdOrHrPeriod()).thenReturn("01");
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
...
//        when(persona2.getStdOrHrPeriod()).thenReturn("02");
        ...
        tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom.calcular(algoritmo, tarea, personas);
...
//        when(algoritmo.getId()).thenReturn(21);
        ...
        String result = tareaCalculoAlgoritmoPorVentaManualDesplazamientoV1RepositoryCustom
