...
public class TareaAgrupacionConfiguracionChallengeTipoVentaRepositoryCustomImplTest {
    ...
    public void setParametersTest() throws SQLException {
        ...
        tareaAgrupacionConfiguracionChallengeTipoVentaRepositoryCustomImpl.setParameters(pstmt, presupuesto);
        verify(pstmt, times(1)).setLong(1, tarea.getId());
        verify(pstmt, times(1)).setLong(2, presupuesto.getIcmIdAgrupacionOnline());
        verify(pstmt, times(1)).setLong(3, presupuesto.getTipoVentaConceptoChallenge().getId());
