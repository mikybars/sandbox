...
public class RunTareaValidarExternosBrasilServiceImplTest {
  ...
  @Mock
  private RunTareaAmbitoValidarExternosBrasilServiceImpl runTareaAmbitoValidarExternosBrasil;

  @InjectMocks
  private RunTareaValidarExternosBrasilServiceImpl runTareaValidarExternosBrasil;
  ...
  public void executeTest() {
    ...
    when(this.runTareaAmbitoValidarExternosBrasil.execute(any(RunTareaDto.class), any(TareaAmbitoDto.class),
        any(TareaFaseAccionDto.class))).thenReturn(validacion);

    this.runTareaValidarExternosBrasil.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarExternosBrasil, timeout(1000).times(1)).execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);
