...
public class RunTareaAmbitoValidarCondicionesDesplazamientoSinChallengeServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesDesplazamientoSinChallengeServiceImpl runTareaAmbitoValidarCondicionesDesplazamientoSinChallengeServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesDesplazamientoSinChallenge(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesDesplazamientoSinChallengeServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);

    verify(this.comisAsyncService, timeout(1000).times(1))
        .findCondicionesDesplazamientoSinChallenge(
