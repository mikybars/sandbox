...
public class DirectoVentaPresenciaManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaPresenciaManualDesplazamientoV1RunAlgoritmo directoVentaPresenciaManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaPresenciaManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaPresenciaManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
