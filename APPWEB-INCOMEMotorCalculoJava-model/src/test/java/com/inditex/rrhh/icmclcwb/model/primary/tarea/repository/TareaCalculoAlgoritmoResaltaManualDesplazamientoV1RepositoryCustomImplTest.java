...
public class TareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom,
                "sqlCalcular",
                SQL_CALCULAR, true);
        FieldUtils.writeField(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom,
    ...
    public void idsTest() {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom.ids(
                algoritmo,
                tarea);
    ...
    public void getMapValuesTest() {
        ...
        final Map<String, Object> result = this.tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom
            .getMapValues(algoritmo, tarea, persona1);

        // parametros de la consulta: idAlgoritmo, idTipoDatoIndicadorPresenciaDesplazamiento, activo,
        // idTarea, cclIdPerson, stdOrHrPeriod, tiposCalculo, tiposComision, esDesplazamiento,
    ...
    public void calcularTest() {
        ...
        this.tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom.calcular(algoritmo, tarea, personas);
    ...
    public void getSqlCalcularTest() {
        ...
        final String result = this.tareaCalculoAlgoritmoResaltaManualDesplazamientoV1RepositoryCustom
