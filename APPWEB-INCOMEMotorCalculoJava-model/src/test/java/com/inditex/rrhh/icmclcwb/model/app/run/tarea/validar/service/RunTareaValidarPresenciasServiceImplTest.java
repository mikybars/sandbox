...
public class RunTareaValidarPresenciasServiceImplTest {
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarPresenciasService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarPresenciasService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarPresenciasService, timeout(1000).times(1))
        .execute(
