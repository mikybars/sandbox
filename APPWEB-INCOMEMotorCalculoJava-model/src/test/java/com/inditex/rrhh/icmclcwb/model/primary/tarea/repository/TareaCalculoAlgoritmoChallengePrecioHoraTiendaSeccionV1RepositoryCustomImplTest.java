...
public class TareaCalculoAlgoritmoChallengePrecioHoraTiendaSeccionV1RepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaSeccionV1RepositoryCustomImpl,
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaSeccionV1RepositoryCustomImpl
        .ids(algoritmo, tarea);
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaSeccionV1RepositoryCustomImpl
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaSeccionV1RepositoryCustomImpl.calcular(algoritmo, tarea,
        personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaSeccionV1RepositoryCustomImpl
