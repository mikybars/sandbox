...
public class TareaCalculoAlgoritmoPrecioHoraDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPrecioHoraDesplazamientoBaseV1RepositoryCustomImpl, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPrecioHoraDesplazamientoBaseV1RepositoryCustomImpl, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAlgoritmoPrecioHoraDesplazamientoBaseV1RepositoryCustomImpl.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPrecioHoraDesplazamientoBaseV1RepositoryCustomImpl.getMapValues(algoritmo, tarea, persona1);
    ...
    public void getSqlCalcularTest() {
        ...
        String result = tareaCalculoAlgoritmoPrecioHoraDesplazamientoBaseV1RepositoryCustomImpl.getSqlCalcular(algoritmo);
