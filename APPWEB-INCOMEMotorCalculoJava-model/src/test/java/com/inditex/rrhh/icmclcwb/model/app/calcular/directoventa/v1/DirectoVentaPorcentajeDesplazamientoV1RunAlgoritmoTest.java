...
public class DirectoVentaPorcentajeDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @InjectMocks
  private DirectoVentaPorcentajeDesplazamientoV1RunAlgoritmo directoVentaPorcentajeDesplazamientoV1RunAlgoritmo;

  @Test
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);
    assertEquals(SQL_CALCULAR,
        this.directoVentaPorcentajeDesplazamientoV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDTO()));
  }
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoV1RepositoryCustom.calcular(
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: DirectoVentaPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoV1RepositoryCustom)
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: DirectoVentaPorcentajeDesplazamientoV1RunAlgoritmo :: KO :: Personas: {}",
