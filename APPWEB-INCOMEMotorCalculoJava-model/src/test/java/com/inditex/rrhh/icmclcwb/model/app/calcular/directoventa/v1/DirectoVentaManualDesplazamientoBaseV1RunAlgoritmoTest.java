...
public class DirectoVentaManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaManualDesplazamientoBaseV1RunAlgoritmo directoVentaManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
