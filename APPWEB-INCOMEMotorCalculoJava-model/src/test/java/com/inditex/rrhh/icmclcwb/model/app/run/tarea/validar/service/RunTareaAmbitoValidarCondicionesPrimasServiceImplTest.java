...
public class RunTareaAmbitoValidarCondicionesPrimasServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesPrimasServiceImpl runTareaAmbitoValidarCondicionesPrimasServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesPrimas(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesPrimasServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);
