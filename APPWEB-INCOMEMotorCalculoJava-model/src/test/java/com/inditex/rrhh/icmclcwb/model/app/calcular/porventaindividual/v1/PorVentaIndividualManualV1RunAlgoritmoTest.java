...
public class PorVentaIndividualManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualManualV1RunAlgoritmo porVentaIndividualManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualManualV1RunAlgoritmo.execute(runTarea, algoritmo);
