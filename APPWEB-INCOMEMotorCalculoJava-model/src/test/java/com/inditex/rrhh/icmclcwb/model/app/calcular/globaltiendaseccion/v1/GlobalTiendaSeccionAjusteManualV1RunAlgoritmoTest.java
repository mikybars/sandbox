...
public class GlobalTiendaSeccionAjusteManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaSeccionAjusteManualV1RunAlgoritmo globalTiendaSeccionAjusteManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaSeccionAjusteManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaSeccionAjusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);
