...
public class TareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
                tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl.getMapValues(algoritmo, tarea, persona1);
    ...
    public void calcularTest() {
        ...
        tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl.calcular(algoritmo, tarea, personas);
    ...
    public void getSqlCalcularTest() {
        ...
        String result = tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustomImpl
