...
class GlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
    ...
    @Mock
    private TareaCalculoAlgoritmoGlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom
        tareaCalculoAlgoritmoGlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom;
    ...
    void getSqlCalcularTest(@Random final AlgoritmoDTO algoritmo) {
        when(
            this.tareaCalculoAlgoritmoGlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom.getSqlCalcular(any(AlgoritmoDTO.class)))
        ...
        verify(this.tareaCalculoAlgoritmoGlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RepositoryCustom, times(1)).getSqlCalcular(algoritmo);
    ...
    void calcularTest(@Random final AlgoritmoDTO algoritmo, @Random final RunTareaDto runTarea,
        ...
        verify(this.log, times(1)).info(
            ...
            "GlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea);
        verify(this.log, times(1)).info(
            "Trabajo[{}]Tarea[{}] :: Fin :: {} :: Ids: {}",
            "GlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea, personas);
        verify(this.log, times(1)).info(
            "Trabajo[{}]Tarea[{}] :: Inicio :: {} :: Personas: {}",
            "GlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea, 3);
        verify(this.log, times(1)).info(
    ...
    void calcularExceptionTest(@Random final AlgoritmoDTO algoritmo, @Random final RunTareaDto runTarea,
        ...
        verify(this.log, times(1)).error(
            ...
            "GlobalTiendaSeccionVentaOnlinePorcentajeDesplazamientoV1RunAlgoritmo", idTrabajo, idTarea, 3, exception);
