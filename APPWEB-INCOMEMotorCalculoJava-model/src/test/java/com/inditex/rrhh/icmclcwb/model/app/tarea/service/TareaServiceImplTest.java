...
public class TareaServiceImplTest {
    ...
    public void findTest() {
        ...
        when(tareaAmbitoLocalizacionService.findByTarea(any(TareaDto.class))).thenReturn(new ArrayList<TareaAmbitoLocalizacionDto>());
        when(tareaAmbitoPersonaService.findByTarea(any(TareaDto.class))).thenReturn(new ArrayList<TareaAmbitoPersonaDto>());
    ...
    public void createTrabajoTest() {
        ...
        verify(tareaMapper, times(1)).mergeTrabajoAmbitoEmpresaDtoAndTrabajoDtoToTareaDto(trabajoDto.getEmpresa(), trabajoDto);
    }
    ...
    public void updateFechaInicioAndEstadoTest() {
        ...
        verify(tareaRepositoryCustom, times(1)).updateFechaInicioAndEstado(any(TareaDto.class), any(EstadoTareaDto.class));
    }
