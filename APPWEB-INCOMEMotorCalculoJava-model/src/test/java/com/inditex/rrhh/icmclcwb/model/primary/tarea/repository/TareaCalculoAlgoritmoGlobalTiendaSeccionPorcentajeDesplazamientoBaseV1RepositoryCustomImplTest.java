...
public class TareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    @Spy
    @InjectMocks
    TareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
        tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustomImpl;
    ...
    void idsTest (@Random(type = IdPersonaLocalDto.class, size = 2) List<IdPersonaLocalDto> idPersonaLocalDtoList) {
        ...
        final List<IdPersonaLocalDto> result =
            this.tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
    ...
    void getMapvaluesTest (@Random(type = IdTipoDatoDto.class, size = 2) List<IdTipoDatoDto> idTipoDatoDtoList) {
        ...
        doReturn(idTipoDatoDtoList).when(this.tipoDatoService).findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.VENTA_LOCALIZACION_SECCION.getId());

        final Map<String, Object> result = this.tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
    ...
    void getMapvaluesTest2 (@Random(type = IdTipoDatoDto.class, size = 2) List<IdTipoDatoDto> idTipoDatoDtoList) {
        ...
        doReturn(idTipoDatoDtoList).when(this.tipoDatoService).findTipoDatoByTipoGrupoDato
            (TipoGrupoDatoEnum.PRESENCIA_LOCALIZACION_SECCION_PERSONA_TIPOHORA.getId());
        doReturn(idTipoDatoDtoList).when(this.tipoDatoService).findTipoDatoByTipoGrupoDato
            (TipoGrupoDatoEnum.PRESENCIA_LOCALIZACION_INCLUIDODENOMINADOR.getId());
        doReturn(idTipoDatoDtoList).when(this.tipoDatoService).findTipoDatoByTipoGrupoDato
    ...
    void getSqlCalcularTest () {
        ...
        verify(this.tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustomImpl,
