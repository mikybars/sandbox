...
public class TareaCalculoAlgoritmoManualV1RepositoryCustomImplTest {
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
                tareaCalculoAlgoritmoManualV1RepositoryCustom.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoManualV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
