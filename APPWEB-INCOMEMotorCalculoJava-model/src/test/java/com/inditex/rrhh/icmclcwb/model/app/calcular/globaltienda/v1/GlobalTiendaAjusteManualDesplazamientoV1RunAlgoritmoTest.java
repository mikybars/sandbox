...
public class GlobalTiendaAjusteManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaAjusteManualDesplazamientoV1RunAlgoritmo globalTiendaAjusteManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaAjusteManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaAjusteManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
