...
public class DirectoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        ...
        assertEquals(SQL_CALCULAR,
                this.directoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto()));
    }
    ...
    public void calcularTest() {
        ...
        verify(this.tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeDiariaV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info(
                "Fin :: DirectoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
                3);
    }
