...
public class AjusteManualV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoAjusteManualV1RepositoryCustom
    ...
    public void calcularTest() {
        ...
        ajusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: AjusteManualV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoAjusteManualV1RepositoryCustom, times(1))
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoAjusteManualV1RepositoryCustom)
