...
public class GlobalTiendaPorcentajeV1RunAlgoritmoTest {
    ...
    @InjectMocks
    private GlobalTiendaPorcentajeV1RunAlgoritmo globalTiendaPorcentajeV1RunAlgoritmo;

    @Test
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoGlobalTiendaPorcentajeV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        String result = globalTiendaPorcentajeV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto());
    ...
    public void calcularTest() {
        ...
        globalTiendaPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: GlobalTiendaPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoGlobalTiendaPorcentajeV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(log, times(1)).info("Fin :: GlobalTiendaPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoGlobalTiendaPorcentajeV1RepositoryCustom)
        ...
        verify(log, times(1))
            .error("GlobalTiendaPorcentajeV1RunAlgoritmo :: KO :: Personas: {}", 2, exception);
