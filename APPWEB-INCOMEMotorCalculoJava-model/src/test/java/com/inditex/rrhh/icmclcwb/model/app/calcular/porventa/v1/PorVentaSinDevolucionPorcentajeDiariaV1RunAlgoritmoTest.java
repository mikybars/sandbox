...
public class PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmoTest {
    ...
    @Mock
    private TareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaV1RepositoryCustom
        tareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaV1RepositoryCustom;
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        String result = tareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaV1RepositoryCustom.getSqlCalcular(new AlgoritmoDto());
    ...
    public void executeTest() {
        ...
        PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(log, times(1)).info("Fin :: PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void executeExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaV1RepositoryCustom)
