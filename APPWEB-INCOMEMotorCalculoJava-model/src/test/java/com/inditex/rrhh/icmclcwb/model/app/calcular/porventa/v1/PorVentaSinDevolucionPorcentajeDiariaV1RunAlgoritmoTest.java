...
public class PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void executeTest() {
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void executeExceptionTest() {
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: PorVentaSinDevolucionPorcentajeDiariaV1RunAlgoritmo :: KO :: Personas: {}",
