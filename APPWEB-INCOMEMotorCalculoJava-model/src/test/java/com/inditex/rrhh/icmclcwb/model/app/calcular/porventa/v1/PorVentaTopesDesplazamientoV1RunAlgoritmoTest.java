...
public class PorVentaTopesDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaTopesDesplazamientoV1RunAlgoritmo porVentaTopesDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaTopesDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaTopesDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
