...
public class TareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
                tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl.getMapValues(algoritmo, tarea, persona1);

        // Parámetros de la consulta: activo, idAlgoritmo, idTarea, cclIdPerson, stdOrHrPeriod, comisionable, calcula
        ...
        assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_FALSE, result.get(SqlPrimaryConstants.SQL_PARAM_ES_DESPLAZAMIENTO));
        //esDesplazamientoBase
        assertTrue(result.containsKey(SqlPrimaryConstants.SQL_PARAM_ES_DESPLAZAMIENTO_BASE));
        assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_TRUE, result.get(SqlPrimaryConstants.SQL_PARAM_ES_DESPLAZAMIENTO_BASE));
        ...
        assertEquals(Arrays.asList(TipoDatoEnum.PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_INCLUIDODENOMINADOR.getId()), result.get(SqlPrimaryConstants.SQL_PARAM_TIPO_DATO_LOCALIZACION_PERSONA_PRESENCIA));
        // indicadorPresenciaDesplazamientoBase
        assertTrue(result.containsKey(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
        assertEquals(TipoDatoEnum.INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION.getId(), result.get(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
    }
    ...
    public void calcularTest() {
        ...
        tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl.calcular(algoritmo, tarea, personas);
        ...
        for (int i = 0; i<values.length; i++) {
            ...
            assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_TRUE, value.getValue(SqlPrimaryConstants.SQL_PARAM_ACTIVO));
            // excluidoCalculo
            ...
            assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_TRUE, value.getValue(SqlPrimaryConstants.SQL_PARAM_COMISIONABLE));
            // calcula
            assertTrue(value.hasValue(SqlPrimaryConstants.SQL_PARAM_CALCULA));
            assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_TRUE, value.getValue(SqlPrimaryConstants.SQL_PARAM_CALCULA));
            // inactivo
            assertTrue(value.hasValue(SqlPrimaryConstants.SQL_PARAM_INACTIVO));
            assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_FALSE, value.getValue(SqlPrimaryConstants.SQL_PARAM_INACTIVO));
            //tipocomision
            ...
            assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_FALSE, value.getValue(SqlPrimaryConstants.SQL_PARAM_ES_DESPLAZAMIENTO));
            //esDesplazamientoBase
            assertTrue(value.hasValue(SqlPrimaryConstants.SQL_PARAM_ES_DESPLAZAMIENTO_BASE));
            assertEquals(SqlPrimaryConstants.SQL_VALUE_BOOLEAN_TRUE, value.getValue(SqlPrimaryConstants.SQL_PARAM_ES_DESPLAZAMIENTO_BASE));
            ...
            assertEquals(Arrays.asList(TipoDatoEnum.PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_INCLUIDODENOMINADOR.getId()), value.getValue(SqlPrimaryConstants.SQL_PARAM_TIPO_DATO_LOCALIZACION_PERSONA_PRESENCIA));
            // indicadorPresenciaDesplazamientoBase
            assertTrue(value.hasValue(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
        }
        ...
        assertEquals(1,
            Arrays.stream(values)
                .filter(value ->
                    persona1.getCclIdPerson().equals(value.getValue(SqlPrimaryConstants.SQL_PARAM_CCL_ID_PERSON))
                        && persona1.getStdOrHrPeriod().equals(value.getValue(SqlPrimaryConstants.SQL_PARAM_STD_OR_HR_PERIOD)))
                .toArray()
                .length);
        assertEquals(1,
            Arrays.stream(values)
                .filter(value ->
                    persona2.getCclIdPerson().equals(value.getValue(SqlPrimaryConstants.SQL_PARAM_CCL_ID_PERSON))
                        && persona2.getStdOrHrPeriod().equals(value.getValue(SqlPrimaryConstants.SQL_PARAM_STD_OR_HR_PERIOD)))
    ...
    public void getSqlCalcularTest() {
        ...
        String result = tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoBaseV1RepositoryCustomImpl
