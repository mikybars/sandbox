...
import com.inditex.rrhh.icmclcwb.api.app.run.tarea.validar.service.RunTareaAmbitoValidarCondicionesPrimasService;
...
public class RunTareaValidarCondicionesPrimasServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesPrimasService runTareaAmbitoValidarCondicionesPrimasService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesPrimasServiceImpl runTareaValidarCondicionesPrimasService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesPrimasService.execute(
    ...
    this.runTareaValidarCondicionesPrimasService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesPrimasService, timeout(1000).times(1))
        .execute(
