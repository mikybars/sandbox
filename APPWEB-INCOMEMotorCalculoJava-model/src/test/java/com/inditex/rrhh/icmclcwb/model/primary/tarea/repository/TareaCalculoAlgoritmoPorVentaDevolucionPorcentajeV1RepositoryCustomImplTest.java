...
class TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustomImpl tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom,
        "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  void getMapValuesTest(@Random final AlgoritmoDTO algoritmo, @Random final AlgoritmoDTO algoritmo2, @Random final TareaDto tarea,
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom
    ...
    expected.put(SQL_PARAM_ID_TIPO_DATO_DEVOLUCION_LOCALIZACION_SECCION, TipoDatoEnum.DEVOLUCION_LOCALIZACION_SECCION.getId());
    ...
    final Map<String, Object> result2 = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom
  ...
  void calcularTest(@Random final AlgoritmoDTO algoritmo, @Random final TareaDto tarea,
    ...
    this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom.calcular(algoritmo, tarea, personas);
    ...
    // Parámetros de la consulta: idAlgoritmo, activo, idTipoDatoIndicadorPresencia,
    // idTipoDatoDevolucionLocalizacionPersona,
    // idTipoDatoRepartoVendedor0, idTipoDatoDevolucionLocalizacionSeccion,
    ...
    for (final IdPersonaLocalDto persona : personas) {
      ...
      map.put(SQL_PARAM_ID_TIPO_DATO_DEVOLUCION_LOCALIZACION_SECCION, TipoDatoEnum.DEVOLUCION_LOCALIZACION_SECCION.getId());
  ...
  void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeV1RepositoryCustom
