...
public class TareaCalculoAlgoritmoPorVentaIndividualPorcentajeDesplazamientoV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoPorVentaIndividualPorcentajeDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoPorVentaBaseV1RepositoryCustom;
  ...
  public void getMapValuesTest(@Random AlgoritmoDTO algoritmo2) {
    ...
    final Map<String, Object> result2 = this.tareaCalculoAlgoritmoPorVentaBaseV1RepositoryCustom
    ...
    // Para cobertura
    algoritmo2.setDesplazamientoBase(Boolean.TRUE);
    final Map<String, Object> result3 = this.tareaCalculoAlgoritmoPorVentaBaseV1RepositoryCustom
        .getMapValues(null, tarea, persona1);
