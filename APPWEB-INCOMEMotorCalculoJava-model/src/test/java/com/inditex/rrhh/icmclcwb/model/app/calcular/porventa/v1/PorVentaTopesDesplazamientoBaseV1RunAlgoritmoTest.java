...
public class PorVentaTopesDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaTopesDesplazamientoBaseV1RunAlgoritmo porVentaTopesDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaTopesDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaTopesDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
