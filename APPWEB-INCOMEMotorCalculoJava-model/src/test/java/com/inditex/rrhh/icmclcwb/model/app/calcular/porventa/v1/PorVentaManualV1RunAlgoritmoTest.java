...
public class PorVentaManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaManualV1RunAlgoritmo porVentaManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaManualV1RunAlgoritmo.execute(runTarea, algoritmo);
