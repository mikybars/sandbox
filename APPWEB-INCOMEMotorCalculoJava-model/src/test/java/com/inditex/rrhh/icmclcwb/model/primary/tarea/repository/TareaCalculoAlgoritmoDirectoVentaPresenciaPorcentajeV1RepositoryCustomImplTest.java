...
public class TareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustomImpl tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom, "sqlCalcular",
                SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom, "sqlCalcularBase",
                SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom
