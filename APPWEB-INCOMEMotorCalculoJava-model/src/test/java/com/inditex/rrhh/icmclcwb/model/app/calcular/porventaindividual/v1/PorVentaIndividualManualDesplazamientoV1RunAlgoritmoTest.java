...
public class PorVentaIndividualManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualManualDesplazamientoV1RunAlgoritmo porVentaIndividualManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
