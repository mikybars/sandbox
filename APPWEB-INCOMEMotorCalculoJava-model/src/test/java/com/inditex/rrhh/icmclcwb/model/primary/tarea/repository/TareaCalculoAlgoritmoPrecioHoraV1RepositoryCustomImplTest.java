...
public class TareaCalculoAlgoritmoPrecioHoraV1RepositoryCustomImplTest {
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAlgoritmoPrecioHoraV1RepositoryCustomImpl.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPrecioHoraV1RepositoryCustomImpl.getMapValues(algoritmo,
                tarea, persona1);
