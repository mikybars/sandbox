...
public class TareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(this.tareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustom, "sqlCalcular",
                SQL_CALCULAR, true);
        FieldUtils.writeField(this.tareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustom,
                "sqlCalcularBase",
                SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustom
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        final Map<String, Object> result = this.tareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustom
    ...
    public void calcularTest() {
        ...
        this.tareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustom.calcular(algoritmo, tarea, personas);
    ...
    public void getSqlCalcularTest() {
        ...
        final String result = this.tareaCalculoAlgoritmoAjusteManualDesplazamientoBaseV1RepositoryCustom
