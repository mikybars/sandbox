...
public class GlobalTiendaSeccionManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaSeccionManualDesplazamientoBaseV1RunAlgoritmo globalTiendaSeccionManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaSeccionManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaSeccionManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
