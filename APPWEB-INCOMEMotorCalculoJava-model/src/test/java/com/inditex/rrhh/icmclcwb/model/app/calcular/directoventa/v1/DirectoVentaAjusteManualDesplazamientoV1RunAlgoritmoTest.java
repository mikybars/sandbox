...
public class DirectoVentaAjusteManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaAjusteManualDesplazamientoV1RunAlgoritmo directoVentaAjusteManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaAjusteManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaAjusteManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
