...
public class GlobalTiendaAjusteManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaAjusteManualV1RunAlgoritmo globalTiendaAjusteManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaAjusteManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaAjusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);
