...
public class PorVentaIndividualAjusteManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualAjusteManualV1RunAlgoritmo porVentaIndividualAjusteManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualAjusteManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualAjusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);
