...
public class TareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustomImpl tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom,
                "sqlCalcular",
                SQL_CALCULAR, true);
        FieldUtils.writeField(this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom,
    ...
    public void idsTest() {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom
            .ids(algoritmo,
                    tarea);
    ...
    public void getMapValuesTest() {
        ...
        final Map<String, Object> result = this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom
            .getMapValues(algoritmo, tarea, persona1);

        // parametros de la consulta: idAlgoritmo, activo,
        // idTipoDatoIndicadorPresenciaDesplazamientoBaseDesplazamientoMismaLocalizacion, idTarea,
        // cclIdPerson, stdOrHrPeriod, tiposCalculo,
    ...
    public void calcularTest() {
        ...
        this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom.calcular(algoritmo, tarea,
                personas);

        // parametros de la consulta: idAlgoritmo, idTarea, cclIdPerson, stdOrHrPeriod, tiposCalculo,
        // tiposComision, idTipoComision, esDesplazamiento, esDesplazamientoBase
    ...
    public void getSqlCalcularTest() {
        ...
        final String result = this.tareaCalculoAlgoritmoResaltaManualDesplazamientoBaseV1RepositoryCustom
