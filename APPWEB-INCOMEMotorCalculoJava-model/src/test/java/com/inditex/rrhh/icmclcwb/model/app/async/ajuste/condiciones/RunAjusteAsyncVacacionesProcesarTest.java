...
class RunAjusteAsyncVacacionesProcesarTest {

  @Mock
  private RunAjusteVacacionesProcesar runAjusteVacacionesProcesar;

  @InjectMocks
  private RunAjusteAsyncVacacionesProcesar runAjusteAsyncVacacionesProcesar;
  ...
  void executeTest() {
    ...
    algoritmo.setId(19);
    final CompletableFuture<Void> cf = this.runAjusteAsyncVacacionesProcesar.execute(runTarea, algoritmo);
    verify(this.runAjusteVacacionesProcesar, times(1)).execute(runTarea, algoritmo);
    assertNotNull(cf);
  }
