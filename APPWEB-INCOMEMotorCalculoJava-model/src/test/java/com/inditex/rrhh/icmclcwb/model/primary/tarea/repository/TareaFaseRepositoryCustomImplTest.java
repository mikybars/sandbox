...
public class TareaFaseRepositoryCustomImplTest {
    ...
    private final static String SQL_UPDATE_FECHA_INICIO_FECHA_FIN_AND_ESTADO_BY_ID_TAREA_AND_ESTADO_ACTUAL = "SQL UPDATE FECHA INICIO FECHA FIN AND ESTADO BY ID TAREA AND ESTADO ACTUAL";
    ...
    private final static String SQL_UPDATE_FECHA_INICIO_FECHA_FIN_AND_ESTADO_BY_ID_TAREA_FASE = "SQL UPDATE FECHA INICIO FECHA FIN AND ESTADO BY ID TAREA FASE";
