...
public class TareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl,
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl
    ...
    public void calcularTest() {
        ...
        tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl.calcular(algoritmo, tarea,
                personas);
