...
public class TareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImplTest {
    ...
    public void idsTest() {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl
            .ids(algoritmo, tarea);
    ...
    public void calcularTest() {
        ...
        this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl.calcular(algoritmo, tarea,
                personas);
    ...
    public void getSqlCalcularTest() {
        ...
        final String result = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl
