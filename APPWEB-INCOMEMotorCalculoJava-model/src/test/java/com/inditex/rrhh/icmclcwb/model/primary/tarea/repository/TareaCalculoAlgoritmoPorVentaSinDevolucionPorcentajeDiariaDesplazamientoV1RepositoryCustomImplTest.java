...
public class TareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustomImplTest {
    ...
    public void idsTest() {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        final Map<String, Object> result = this.tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom
    ...
    public void getSqlCalcularTest() {
        ...
        final String result = this.tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom
