...
public class TareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustomImpl
        tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
            tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
        ...
        assertEquals(Collections.singletonList(TipoDatoEnum.PRESENCIA_LOCALIZACION_INCLUIDODENOMINADOR.getId()), result.get(SQL_PARAM_ID_TIPO_PRESENCIA_LOCALIZACION));
        //idAlgoritmo
        ...
        assertEquals(TipoDatoEnum.INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO.getId(), result.get(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO));
    ...
    public void calcularTest() {
        ...
        tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom.calcular(algoritmo, tarea, personas);
        ...
        for (MapSqlParameterSource value : values) {
            ...
            assertEquals(Collections.singletonList(TipoDatoEnum.PRESENCIA_LOCALIZACION_INCLUIDODENOMINADOR.getId()), value.getValue(SQL_PARAM_ID_TIPO_PRESENCIA_LOCALIZACION));            //idAlgoritmo
            ...
            assertEquals(TipoDatoEnum.INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO.getId(), value.getValue(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO));
    ...
    public void getSqlCalcularTest() {
        ...
        String result = tareaCalculoAlgoritmoPorVentaSinDevolucionSinDevolucionPorcentajeDiariaDesplazamientoV1RepositoryCustom
