...
public class DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.log, times(1))
            .info("Inicio :: DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        verify(this.tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info("Fin :: DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmo :: Personas: {}",
                3);
    }
