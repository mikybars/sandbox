...
public class DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        String result = directoVentaReduccionJornadaPorcentajeV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto());
    ...
    public void calcularTest() {
        ...
        directoVentaReduccionJornadaPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(log, times(1)).info("Fin :: DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeV1RepositoryCustom)
        ...
        verify(log, times(1))
            .error("DirectoVentaReduccionJornadaPorcentajeV1RunAlgoritmo :: KO :: Personas: {}", 2, exception);
