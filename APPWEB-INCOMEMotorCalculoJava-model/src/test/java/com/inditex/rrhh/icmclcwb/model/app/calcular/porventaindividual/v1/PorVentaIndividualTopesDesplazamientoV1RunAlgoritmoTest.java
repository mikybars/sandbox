...
public class PorVentaIndividualTopesDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualTopesDesplazamientoV1RunAlgoritmo porVentaIndividualTopesDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualTopesDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualTopesDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
