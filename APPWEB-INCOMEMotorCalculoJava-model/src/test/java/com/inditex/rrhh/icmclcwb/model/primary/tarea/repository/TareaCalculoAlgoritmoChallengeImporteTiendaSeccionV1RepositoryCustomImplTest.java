...
public class TareaCalculoAlgoritmoChallengeImporteTiendaSeccionV1RepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengeImporteTiendaSeccionV1RepositoryCustomImpl,
        "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengeImporteTiendaSeccionV1RepositoryCustomImpl,
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoChallengeImporteTiendaSeccionV1RepositoryCustomImpl
        .ids(algoritmo, tarea);
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoChallengeImporteTiendaSeccionV1RepositoryCustomImpl.calcular(algoritmo, tarea,
        personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoChallengeImporteTiendaSeccionV1RepositoryCustomImpl
