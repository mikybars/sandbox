...
public class PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeDesplazamientoV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        final String result = this.porVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo
    ...
    public void calcularTest() {
        ...
        when(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeDesplazamientoV1RepositoryCustom.calcular(
        ...
        this.porVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(this.log, times(1))
            .info("Trabajo[{}]Tarea[{}] :: Inicio :: PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
                    idTrabajo, idTarea, 3);
        verify(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeDesplazamientoV1RepositoryCustom,
                times(1))
                    .calcular(algoritmo, runTarea.getTarea(), personas);
        verify(this.log, times(1))
            .info("Trabajo[{}]Tarea[{}] :: Fin :: PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
                    idTrabajo, idTarea, 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        verify(this.log, times(1))
            .error("Trabajo[{}]Tarea[{}] :: PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo :: KO :: Personas: {}",
