...
public class PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeDesplazamientoV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        String result = porVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto());
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeDesplazamientoV1RepositoryCustom)
