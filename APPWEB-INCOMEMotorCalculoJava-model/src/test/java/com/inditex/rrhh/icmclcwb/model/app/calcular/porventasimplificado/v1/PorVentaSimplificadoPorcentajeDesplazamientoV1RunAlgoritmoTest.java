...
public class PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeDesplazamientoV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info(
                "Fin :: PorVentaSimplificadoPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
                3);
    }
