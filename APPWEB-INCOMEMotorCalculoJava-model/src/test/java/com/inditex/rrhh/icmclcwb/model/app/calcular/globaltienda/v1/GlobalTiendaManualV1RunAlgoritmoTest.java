...
public class GlobalTiendaManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaManualV1RunAlgoritmo globalTiendaManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaManualV1RunAlgoritmo.execute(runTarea, algoritmo);
