...
public class PorVentaSimplificadoTopesV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaSimplificadoTopesV1RunAlgoritmo porVentaSimplificadoTopesV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaSimplificadoTopesV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaSimplificadoTopesV1RunAlgoritmo.execute(runTarea, algoritmo);
