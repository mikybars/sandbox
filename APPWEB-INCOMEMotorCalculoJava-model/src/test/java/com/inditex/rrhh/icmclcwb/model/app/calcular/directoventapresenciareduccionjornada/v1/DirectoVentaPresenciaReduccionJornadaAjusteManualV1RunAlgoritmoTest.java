...
public class DirectoVentaPresenciaReduccionJornadaAjusteManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaPresenciaReduccionJornadaAjusteManualV1RunAlgoritmo directoVentaPresenciaReduccionJornadaAjusteManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaPresenciaReduccionJornadaAjusteManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaPresenciaReduccionJornadaAjusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);
