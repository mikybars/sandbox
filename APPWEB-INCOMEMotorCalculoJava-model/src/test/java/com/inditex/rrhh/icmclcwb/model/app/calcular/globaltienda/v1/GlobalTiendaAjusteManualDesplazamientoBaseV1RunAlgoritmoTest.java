...
public class GlobalTiendaAjusteManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaAjusteManualDesplazamientoBaseV1RunAlgoritmo globalTiendaAjusteManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaAjusteManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaAjusteManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
