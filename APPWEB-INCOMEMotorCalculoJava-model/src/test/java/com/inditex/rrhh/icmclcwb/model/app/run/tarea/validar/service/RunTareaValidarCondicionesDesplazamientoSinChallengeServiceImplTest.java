...
import com.inditex.rrhh.icmclcwb.api.app.run.tarea.validar.service.RunTareaAmbitoValidarCondicionesDesplazamientoSinChallengeService;
...
public class RunTareaValidarCondicionesDesplazamientoSinChallengeServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesDesplazamientoSinChallengeService runTareaAmbitoValidarCondicionesDesplazamientoSinChallengeService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesDesplazamientoSinChallengeServiceImpl runTareaValidarCondicionesDesplazamientoSinChallengeServiceImpl;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesDesplazamientoSinChallengeService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesDesplazamientoSinChallengeServiceImpl.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesDesplazamientoSinChallengeService, timeout(1000).times(1))
        .execute(
