...
public class DirectoVentaReduccionJornadaManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaReduccionJornadaManualV1RunAlgoritmo directoVentaReduccionJornadaManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaReduccionJornadaManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaReduccionJornadaManualV1RunAlgoritmo.execute(runTarea, algoritmo);
