...
public class TareaLocalizacionPresupuestoVentaMapperTest {
    ...
    void ventaCongeladaResultItemDtoToTareaLocalizacionPresupuestoVentaExceptionTest () {
        assertThrows(UnsupportedOperationException.class, () -> {
            this.tareaLocalizacionPresupuestoVentaMapper
                .ventaCongeladaResultItemDtoToTareaLocalizacionPresupuestoVenta
                    (this.ventaCongeladaResultItemDtoList, this.tarea);
        });
    }
        ...
        assertThrows(UnsupportedOperationException.class, () -> {
            this.tareaLocalizacionPresupuestoVentaMapper
                .ventaTotalizadoResponseItemDtoToTareaLocalizacionPresupuestoVenta
                    (this.ptrVentaTotalizadoResultItemDtoList, this.idLocalizacionLocalPresupuestoDto, this.tarea);
        });
    }
    ...
    void ventaOnlineIpodResponseItemDtoToTareaLocalizacionPresupuestoVentaExceptionTest () {
        assertThrows(UnsupportedOperationException.class, () -> {
            this.tareaLocalizacionPresupuestoVentaMapper
                .ventaOnlineIpodResponseItemDtoToTareaLocalizacionPresupuestoVenta
                    (this.PtrVentaOnlineIpodResultItemDtoList, this.idLocalizacionLocalPresupuestoDto, this.tarea);
        });
    }
        ...
        assertThrows(UnsupportedOperationException.class, () -> {
            this.tareaLocalizacionPresupuestoVentaMapper
                .ventaOnlinePickingResponseItemDtoToTareaLocalizacionPresupuestoVenta
                    (this.ptrVentaOnlinePickingResultItemDtoList, this.idLocalizacionLocalPresupuestoDto, this.tarea);
        });
    }
