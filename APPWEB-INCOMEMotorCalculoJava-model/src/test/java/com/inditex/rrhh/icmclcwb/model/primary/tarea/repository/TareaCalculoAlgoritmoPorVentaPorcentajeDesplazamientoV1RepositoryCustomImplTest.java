...
public class TareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustomImpl
        tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
            tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom.ids(algoritmo, tarea);
...
//        when(persona1.getStdOrHrPeriod()).thenReturn("01");
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
...
//        when(persona2.getStdOrHrPeriod()).thenReturn("02");
        ...
        tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom.calcular(algoritmo, tarea, personas);
...
//        when(algoritmo.getId()).thenReturn(21);
        ...
        String result = tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoV1RepositoryCustom
