...
public class DirectoVentaPresenciaPorcentajeDesplazamientoBaseV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void calcularTest() {
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: DirectoVentaPresenciaPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void calcularExceptionTest() {
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: DirectoVentaPresenciaPorcentajeDesplazamientoBaseV1RunAlgoritmo :: KO :: Personas: {}",
