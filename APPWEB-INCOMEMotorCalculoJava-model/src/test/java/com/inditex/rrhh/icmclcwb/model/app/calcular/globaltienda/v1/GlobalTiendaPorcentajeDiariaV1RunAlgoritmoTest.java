...
public class GlobalTiendaPorcentajeDiariaV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.log, times(1)).info("Inicio :: GlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}", 3);
        verify(this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info("Fin :: GlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}", 3);
    }
