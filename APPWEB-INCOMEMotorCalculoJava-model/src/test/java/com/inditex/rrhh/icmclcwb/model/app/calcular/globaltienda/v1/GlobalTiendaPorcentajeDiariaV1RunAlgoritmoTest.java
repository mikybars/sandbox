...
public class GlobalTiendaPorcentajeDiariaV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom
                .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);
            assertEquals(SQL_CALCULAR, globalTiendaPorcentajeDiariaV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto()));
    }
    ...
    public void calcularTest() {
        ...
        globalTiendaPorcentajeDiariaV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: GlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(log, times(1)).info("Fin :: GlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom)
        ...
        verify(log, times(1))
            .error("GlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: KO :: Personas: {}", 2, exception);
