...
public class PorVentaSimplificadoPorcentajeV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        String result = porVentaSimplificadoPorcentajeV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto());
    ...
    public void calcularTest() {
        ...
        porVentaSimplificadoPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: PorVentaSimplificadoPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(log, times(1)).info("Fin :: PorVentaSimplificadoPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom)
