...
import com.inditex.rrhh.icmclcwb.model.primary.tarea.repository.TareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom;
...
public class PorVentaSimplificadoPorcentajeV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @InjectMocks
  private PorVentaSimplificadoPorcentajeV1RunAlgoritmo porVentaSimplificadoPorcentajeV1RunAlgoritmo;

  @Test
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);

    final String result = this.porVentaSimplificadoPorcentajeV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDTO());
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom.calcular(
    ...
    this.porVentaSimplificadoPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);

    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: PorVentaSimplificadoPorcentajeV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    verify(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom,
        times(1))
            .calcular(algoritmo, runTarea.getTarea(), personas);
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: PorVentaSimplificadoPorcentajeV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoPorVentaSimplificadoPorcentajeV1RepositoryCustom)
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: PorVentaSimplificadoPorcentajeV1RunAlgoritmo :: KO :: Personas: {}",
