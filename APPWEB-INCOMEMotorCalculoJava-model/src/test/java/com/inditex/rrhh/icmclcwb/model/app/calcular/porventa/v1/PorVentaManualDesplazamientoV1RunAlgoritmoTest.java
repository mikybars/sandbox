...
public class PorVentaManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaManualDesplazamientoV1RunAlgoritmo porVentaManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
