...
class PrimaryTemporaryTablePoliticasRepositoryCustomTest {
  ...
  private static final String SQL_CREATE_TEMP_CALCULO_CON_AJUSTE_MAXIMO_GARANTIZADO =
      "SQL CREATE TEMP CALCULO CON AJUSTE MAXIMO GARANTIZADO";

  private static final String SQL_DELETE_TEMP_CALCULO_CON_AJUSTE_MAXIMO_GARANTIZADO =
      "SQL DELETE TEMP CALCULO CON AJUSTE MAXIMO GARANTIZADO";

  private static final String SQL_INSERT_TEMP_CALCULO_CON_AJUSTE_MAXIMO_GARANTIZADO =
      "SQL INSERT TEMP CALCULO CON AJUSTE MAXIMO GARANTIZADO";
  ...
  private static final String SQL_CREATE_TEMP_CALCULO_CON_AJUSTE_MINIMO_GARANTIZADO =
      "SQL CREATE TEMP CALCULO CON AJUSTE MINIMO GARANTIZADO";

  private static final String SQL_DELETE_TEMP_CALCULO_CON_AJUSTE_MINIMO_GARANTIZADO =
      "SQL DELETE TEMP CALCULO CON AJUSTE MINIMO GARANTIZADO";

  private static final String SQL_INSERT_TEMP_CALCULO_CON_AJUSTE_MINIMO_GARANTIZADO =
      "SQL INSERT TEMP CALCULO CON AJUSTE MINIMO GARANTIZADO";
