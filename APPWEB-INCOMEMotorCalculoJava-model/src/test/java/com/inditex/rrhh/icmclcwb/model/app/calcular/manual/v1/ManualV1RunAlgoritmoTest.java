...
public class ManualV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.log, times(1)).info("Inicio :: ManualV1RunAlgoritmo :: Personas: {}", 3);
        verify(this.tareaCalculoAlgoritmoManualV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(this.log, times(1)).info("Fin :: ManualV1RunAlgoritmo :: Personas: {}", 3);
    }
