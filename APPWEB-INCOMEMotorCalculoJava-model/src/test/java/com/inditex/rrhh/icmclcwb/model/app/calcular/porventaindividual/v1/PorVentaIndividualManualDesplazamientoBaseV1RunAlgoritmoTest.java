...
public class PorVentaIndividualManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualManualDesplazamientoBaseV1RunAlgoritmo porVentaIndividualManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
