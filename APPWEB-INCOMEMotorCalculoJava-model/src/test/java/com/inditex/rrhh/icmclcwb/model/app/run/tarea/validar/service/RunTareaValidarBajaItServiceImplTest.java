...
public class RunTareaValidarBajaItServiceImplTest {
  ...
  @InjectMocks
  private RunTareaValidarBajaItServiceImpl runTareaValidarBajaItService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarBajaItService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarBajaItService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarBajaItService, timeout(1000).times(1))
        .execute(
