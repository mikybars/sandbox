...
public class TareaCalculoPersonaServiceImplTest {
    ...
    public void updateWithEstadoAndidPersonaTest() {
        ...
        verify(tareaCalculoPersonaRepositoryCustom, times(1)).updateWithEstadoAndidPersona(any(List.class), any(RunTareaDto.class), any(EstadoTareaPersonaDto.class));
    }
    ...
    public void updateWithEstadoTest() {
        ...
        verify(tareaCalculoPersonaRepositoryCustom, times(1)).updateWithEstado(any(RunTareaDto.class), any(EstadoTareaPersonaDto.class), any(EstadoTareaPersonaDto.class));
    }
    ...
    public void mergePersonaCalculoByAmbitoLocalizacionTest() {
        ...
        verify(tareaCalculoPersonaRepositoryCustom, times(1)).mergePersonaCalculoByAmbitoLocalizacion(any(RunTareaDto.class));
    }
    ...
    public void mergePersonaCalculoByAmbitoPersonaTest() {
        ...
        verify(tareaCalculoPersonaRepositoryCustom, times(1)).mergePersonaCalculoByAmbitoPersona(any(RunTareaDto.class));
    }
    ...
    public void findByAlgoritmoTest() {
        ...
        List<TareaCalculoPersona> list = new ArrayList<TareaCalculoPersona>();
        when(tareaCalculoPersonaRepositoryCustom.findByAlgoritmo(any(TareaDto.class), any(AlgoritmoDto.class))).thenReturn(list);
        tareaCalculoPersonaServiceImpl.findByAlgoritmo(tarea, algoritmoDto);

        verify(tareaCalculoPersonaRepositoryCustom, times(1)).findByAlgoritmo(any(TareaDto.class), any(AlgoritmoDto.class));
    }
    ...
    public void findByTareaAndIdEstadoAndIdTipoPoliticaTest() {
        ...
        List<TareaCalculoPersona> list = new ArrayList<TareaCalculoPersona>();
        when(tareaCalculoPersonaRepositoryCustom.findByTareaAndIdEstadoAndIdTipoPolitica(any(TareaDto.class), any(String.class))).thenReturn(list);
        tareaCalculoPersonaServiceImpl.findByTareaAndIdEstadoAndIdTipoPolitica(tarea, tipoPolitica);

        verify(tareaCalculoPersonaRepositoryCustom, times(1)).findByTareaAndIdEstadoAndIdTipoPolitica(any(TareaDto.class), any(String.class));
    }
