...
public class GlobalTiendaManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    GlobalTiendaManualDesplazamientoBaseV1RunAlgoritmo globalTiendaManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = globalTiendaManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        globalTiendaManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
