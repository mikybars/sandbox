...
public class TareaCalculoAlgoritmoDirectoVentaPorcentajeV1RepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeV1RepositoryCustom, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeV1RepositoryCustom, "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoDirectoVentaPorcentajeV1RepositoryCustom
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoDirectoVentaPorcentajeV1RepositoryCustom.calcular(algoritmo, tarea, personas);
