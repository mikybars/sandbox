...
public class PorVentaManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaManualDesplazamientoBaseV1RunAlgoritmo porVentaManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
