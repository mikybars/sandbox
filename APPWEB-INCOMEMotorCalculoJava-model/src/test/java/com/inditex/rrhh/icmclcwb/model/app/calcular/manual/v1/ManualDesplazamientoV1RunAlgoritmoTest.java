...
public class ManualDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void calcularTest() {
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: ManualDesplazamientoV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: ManualDesplazamientoV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void calcularExceptionTest() {
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: ManualDesplazamientoV1RunAlgoritmo :: KO :: Personas: {}",
