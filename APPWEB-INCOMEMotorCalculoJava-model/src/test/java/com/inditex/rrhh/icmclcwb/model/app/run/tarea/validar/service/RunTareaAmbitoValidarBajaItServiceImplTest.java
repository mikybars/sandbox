...
public class RunTareaAmbitoValidarBajaItServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarBajaItServiceImpl runTareaAmbitoValidarBajaItServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findBajasIt(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarBajaItServiceImpl.execute(runTareaDto, tareaAmbitoDto, tareaFaseAccionDto);
