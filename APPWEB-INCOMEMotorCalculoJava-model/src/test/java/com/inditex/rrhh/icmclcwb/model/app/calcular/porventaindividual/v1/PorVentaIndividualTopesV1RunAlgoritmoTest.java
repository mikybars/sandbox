...
public class PorVentaIndividualTopesV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    PorVentaIndividualTopesV1RunAlgoritmo porVentaIndividualTopesV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = porVentaIndividualTopesV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        porVentaIndividualTopesV1RunAlgoritmo.execute(runTarea, algoritmo);
