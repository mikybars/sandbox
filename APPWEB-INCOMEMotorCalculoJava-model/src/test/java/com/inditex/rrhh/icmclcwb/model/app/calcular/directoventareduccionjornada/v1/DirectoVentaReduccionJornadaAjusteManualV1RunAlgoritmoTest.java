...
public class DirectoVentaReduccionJornadaAjusteManualV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaReduccionJornadaAjusteManualV1RunAlgoritmo directoVentaReduccionJornadaAjusteManualV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaReduccionJornadaAjusteManualV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaReduccionJornadaAjusteManualV1RunAlgoritmo.execute(runTarea, algoritmo);
