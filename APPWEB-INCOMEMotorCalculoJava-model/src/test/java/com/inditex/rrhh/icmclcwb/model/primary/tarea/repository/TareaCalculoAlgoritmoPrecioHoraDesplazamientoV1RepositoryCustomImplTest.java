...
public class TareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl,
        "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl
        .ids(algoritmo, tarea);
  ...
  public void getMapValuesTest(@Random AlgoritmoDTO algoritmo2) {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl
    ...
    final Map<String, Object> result2 = this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl.calcular(algoritmo, tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl
