...
public class TareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl, "sqlCalcular",
                SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl, "sqlCalcularBase",
                SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPrecioHoraDesplazamientoV1RepositoryCustomImpl
