...
public class TareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(
                tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl,
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
            .ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
    ...
    public void calcularTest() {
        ...
        tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl.calcular(algoritmo,
                tarea, personas);
