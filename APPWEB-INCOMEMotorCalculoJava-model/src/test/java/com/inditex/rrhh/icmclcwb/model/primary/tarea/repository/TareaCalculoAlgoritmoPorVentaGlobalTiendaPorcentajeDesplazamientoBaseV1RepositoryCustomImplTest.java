...
public class TareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
                tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl.ids(algoritmo, tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl.getMapValues(algoritmo, tarea, persona1);
        ...
        verify(tipoDatoService).findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.PRESENCIA_LOCALIZACION_SECCION_PERSONA_TIPOHORA.getId());
        ...
        // indicadorPresencia
        assertTrue(result.containsKey(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
        assertEquals(TipoDatoEnum.INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION.getId(), result.get(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
        // comisionable
    ...
    public void calcularTest() {
        ...
        tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl.calcular(algoritmo, tarea, personas);

        //parametros de la consulta: idSeccion, activo, tipoDatoLocalizacionVentaSeccion, excluido calculo,
        // tipoDatoPersonaPresencia, idAlgoritmo, idTarea, cclIdPerson, stdOrHrPeriod, comisionable, calcula
        verify(tipoDatoService, times(2)).findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.PRESENCIA_LOCALIZACION_SECCION_PERSONA_TIPOHORA.getId());
        ...
        for (int i = 0; i<values.length; i++) {
            ...
            assertEquals(Arrays.asList(1011), value.getValue(SqlPrimaryConstants.SQL_PARAM_TIPO_DATO_LOCALIZACION_PERSONA_PRESENCIA));
            // tipoDatoLocalizacionVentaSeccion
            assertTrue(value.hasValue(SqlPrimaryConstants.SQL_PARAM_TIPO_DATO_LOCALIZACION_VENTA_SECCION));
            assertEquals(Arrays.asList(1011), value.getValue(SqlPrimaryConstants.SQL_PARAM_TIPO_DATO_LOCALIZACION_VENTA_SECCION));
            // indicadorPresencia
            assertTrue(value.hasValue(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
            assertEquals(TipoDatoEnum.INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION.getId(), value.getValue(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION));
    ...
    public void getSqlCalcularTest() {
        ...
        String result = tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
