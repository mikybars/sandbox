...
public class TareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustomImpl
        tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
            tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom.ids(algoritmo, tarea);
...
//        when(persona1.getStdOrHrPeriod()).thenReturn("01");
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
...
//        when(persona2.getStdOrHrPeriod()).thenReturn("02");
        ...
        tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom.calcular(algoritmo, tarea, personas);
...
//        when(algoritmo.getId()).thenReturn(21);
        ...
        String result = tareaCalculoAlgoritmoPorVentaAjusteManualV1RepositoryCustom
