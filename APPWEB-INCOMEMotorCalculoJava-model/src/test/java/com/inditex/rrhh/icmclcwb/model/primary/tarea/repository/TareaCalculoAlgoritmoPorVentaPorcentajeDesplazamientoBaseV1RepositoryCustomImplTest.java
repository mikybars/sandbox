...
public class TareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
    ...
    @InjectMocks
    private TareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
        tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom;

    @Before
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
        FieldUtils.writeField(tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
            tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom.ids(algoritmo, tarea);
...
//        when(persona1.getStdOrHrPeriod()).thenReturn("01");
        ...
        Map<String, Object> result = tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom.getMapValues(algoritmo, tarea, persona1);
...
//        when(persona2.getStdOrHrPeriod()).thenReturn("02");
        ...
        tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom.calcular(algoritmo, tarea, personas);
...
//        when(algoritmo.getId()).thenReturn(21);
        ...
        String result = tareaCalculoAlgoritmoPorVentaPorcentajeDesplazamientoBaseV1RepositoryCustom
