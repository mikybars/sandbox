...
public class PorVentaSinDevolucionPorcentajeV1RunAlgoritmoTest {
    ...
    public void executeTest() {
        ...
        verify(this.log, times(1)).info("Inicio :: PorVentaSinDevolucionPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        ...
        verify(this.log, times(1)).info("Fin :: PorVentaSinDevolucionPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
    }
