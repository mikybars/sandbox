...
public class GlobalTiendaSeccionPorcentajeV1RunAlgoritmoTest {
    ...
    public void getSqlCalcularTest() {
        when(tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeV1RepositoryCustom
            .getSqlCalcular(any(AlgoritmoDto.class))).thenReturn(SQL_CALCULAR);

        String result = globalTiendaSeccionPorcentajeV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDto());
    ...
    public void calcularTest() {
        ...
        globalTiendaSeccionPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);

        verify(log, times(1)).info("Inicio :: GlobalTiendaSeccionPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        verify(tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeV1RepositoryCustom, times(1))
            .calcular(algoritmo, tarea, personas);
        verify(log, times(1)).info("Fin :: GlobalTiendaSeccionPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
    }
    ...
    public void calcularExceptionTest() {
        ...
        doThrow(exception).when(tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeV1RepositoryCustom)
