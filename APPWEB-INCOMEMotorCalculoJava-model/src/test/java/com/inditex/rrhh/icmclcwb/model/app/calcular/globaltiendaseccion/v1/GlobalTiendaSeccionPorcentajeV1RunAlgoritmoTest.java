...
public class GlobalTiendaSeccionPorcentajeV1RunAlgoritmoTest {
    ...
    public void calcularTest() {
        ...
        verify(this.log, times(1)).info("Inicio :: GlobalTiendaSeccionPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
        ...
        verify(this.log, times(1)).info("Fin :: GlobalTiendaSeccionPorcentajeV1RunAlgoritmo :: Personas: {}", 3);
    }
