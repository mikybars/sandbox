...
public class TareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoV1RepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(
        this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoV1RepositoryCustomImpl,
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoV1RepositoryCustomImpl
        .ids(algoritmo, tarea);
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoV1RepositoryCustomImpl
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoV1RepositoryCustomImpl.calcular(algoritmo,
        tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDesplazamientoV1RepositoryCustomImpl
