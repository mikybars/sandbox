...
public class DirectoVentaPresenciaManualDesplazamientoBaseV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaPresenciaManualDesplazamientoBaseV1RunAlgoritmo directoVentaPresenciaManualDesplazamientoBaseV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaPresenciaManualDesplazamientoBaseV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaPresenciaManualDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);
