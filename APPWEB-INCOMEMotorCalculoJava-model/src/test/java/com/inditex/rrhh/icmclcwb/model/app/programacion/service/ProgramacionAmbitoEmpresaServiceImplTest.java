...
public class ProgramacionAmbitoEmpresaServiceImplTest {
    ...
    @Test
    public void create() {
        when(programacionAmbitoEmpresaMapper.mergeProgramacionAmbitoEmpresaDtoAndProgramacionDtoToProgramacionAmbitoEmpresa(
                any(List.class), any(ProgramacionAmbitoDto.class))).thenReturn(new ArrayList<ProgramacionAmbitoEmpresa>());
        when(programacionAmbitoEmpresaRepository.saveAll(any(List.class))).thenReturn(new ArrayList<ProgramacionAmbitoEmpresa>());

        programacionAmbitoEmpresaServiceImpl.create(Arrays.asList(new ProgramacionAmbitoEmpresaDto()), new ProgramacionAmbitoDto());
    ...
    public void findByProgramacionAmbito() {
        ...
        when(programacionAmbitoEmpresaRepository.findByProgramacionAmbitoId(any(Long.class))).thenReturn(new ArrayList<ProgramacionAmbitoEmpresa>());
