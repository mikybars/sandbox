...
public class TareaCalculoAjusteCarenciaRepositoryCustomImplTest {
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids =
                tareaCalculoAjusteCarenciaRepositoryCustomImpl.ids(tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAjusteCarenciaRepositoryCustomImpl.getMapValues(algoritmoAjuste, tarea, persona1);
