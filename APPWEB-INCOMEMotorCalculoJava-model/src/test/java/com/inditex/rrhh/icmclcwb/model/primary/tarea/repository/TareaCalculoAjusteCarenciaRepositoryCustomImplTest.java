...
public class TareaCalculoAjusteCarenciaRepositoryCustomImplTest {
    ...
    public void setup() throws IllegalAccessException {
        FieldUtils.writeField(tareaCalculoAjusteCarenciaRepositoryCustomImpl, "sqlAjustar", SQL_AJUSTAR, true);
        FieldUtils.writeField(tareaCalculoAjusteCarenciaRepositoryCustomImpl, "sqlAjustarBase", SQL_AJUSTAR_BASE, true);
    }
    ...
    public void idsTest() {
        ...
        List<TareaCalculoPersonaDto> ids = tareaCalculoAjusteCarenciaRepositoryCustomImpl.ids(tarea);
    ...
    public void getMapValuesTest() {
        ...
        Map<String, Object> result = tareaCalculoAjusteCarenciaRepositoryCustomImpl.getMapValues(algoritmoAjuste, tarea,
                persona1);
        ...
        assertEquals(TipoPoliticaEnum.CARENCIA.getId(), result.get(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_POLITICA));
        // inactivo
