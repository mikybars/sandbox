...
public class DirectoVentaPresenciaAjusteManualDesplazamientoV1RunAlgoritmoTest {

    @Mock
    private Logger log;

    @InjectMocks
    DirectoVentaPresenciaAjusteManualDesplazamientoV1RunAlgoritmo directoVentaPresenciaAjusteManualDesplazamientoV1RunAlgoritmo;
    ...
    public void getSqlCalcularTest() {
        ...
        String result = directoVentaPresenciaAjusteManualDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
    ...
    public void executeTest() {
        ...
        directoVentaPresenciaAjusteManualDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
