...
public class TareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaDesplazamientoV1RepositoryCustomImplTest {
  ...
  public void getMapValuesNumeroElementosTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaDesplazamientoV1RepositoryCustom
  ...
  @Test
  public void getMapValuesCclIdPerson() {
  ...
  @Test
  public void getMapValuesStdOrHrPeriod() {
  ...
  @Test
  public void getMapValuesEsDesplazamientoBase() {
  ...
  @Test
  public void getMapValuesIdTipoDatoIndicadorPresenciaDesplazamientoBaseDesplazamientoMismaLocalizacion() {
  ...
  public void calcularNumeroElementosTest() {
    ...
    this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaDesplazamientoV1RepositoryCustom.calcular(algoritmo,
        tarea,
        personas);
  ...
  private IdPersonaLocalDto createIdPersonaLocalDtoMock(final String at1001, final String s) {
    final IdPersonaLocalDto persona1 = mock(IdPersonaLocalDto.class);
    when(persona1.getIdPersonaLocal()).thenReturn(at1001);
    when(persona1.getStdOrHrPeriod()).thenReturn(s);
    return persona1;
  }
