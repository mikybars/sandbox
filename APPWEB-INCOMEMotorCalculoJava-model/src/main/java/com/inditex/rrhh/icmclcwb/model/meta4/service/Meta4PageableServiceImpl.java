...
public class Meta4PageableServiceImpl<U extends PageableListDto> implements Meta4PageableService {
    ...
    @Override
    public <T extends PageableDto<?>, Z extends Object> List<Z> getResultItem(final T request, final Object service,
            final String methodName, final Integer maxPageSize) {
        ...
        try {
            ...
            do {
                ...
                final U response = (U) method.invoke(service, request);
                if (response != null) {
