...
public class PtrPresenciasMockRepositoryImpl implements PtrPresenciasMockRepository {
    ...
    @Override
    public List<PresenciaDetalleMock> findPresencias(PresenciasDetalleRequestDto request) {
        ...
        if (request.getOrigen() != null) {
            if (request.getOrigen().equals(11)) {
                query.append(
                ...
                param.addValue("origen", request.getOrigen());
            } else {
                query.append(
