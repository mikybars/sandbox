...
public abstract class TareaEmpleadoSeccionEstructuraDecorator extends TareaEmpleadoSeccionEstructuraMapper {

    @Autowired
    private TareaEmpleadoSeccionEstructuraMapper delegate;
    ...
    public List<TareaEmpleadoSeccionEstructuraDto> listaPorcentajesResultItemDtoToTareaEmpleadoSeccionEstructuraDto
        ...
        List<TareaEmpleadoSeccionEstructuraDto> result = new ArrayList<>();
    ...
    public List<TareaEmpleadoSeccionEstructuraDto> comisionEmpleadoResultItemDtoToTareaEmpleadoSeccionEstructuraDto(
        ...
        List<TareaEmpleadoSeccionEstructuraDto> result = new ArrayList<>();
        src.forEach(x -> {
            result.addAll(listaPorcentajesResultItemDtoToTareaEmpleadoSeccionEstructuraDto(x.getIcmListaPorcentajes(), x, tarea));
        });
        return result;
    }

    private TareaEmpleadoSeccionEstructuraDto createTareaEmpleadoSeccionEstructuraDto(
        ...
        TareaEmpleadoSeccionEstructuraDto result = delegate.comisionEmpleadoResultItemDtoToTareaEmpleadoSeccionEstructuraDto(comisionEmpleado, tarea);
