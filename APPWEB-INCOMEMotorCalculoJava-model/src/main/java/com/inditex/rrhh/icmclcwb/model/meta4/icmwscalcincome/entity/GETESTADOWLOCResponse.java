...
public class GETESTADOWLOCResponse implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GETESTADOWLOCResponse that = ((GETESTADOWLOCResponse) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "getestadowlocReturn", lhsGETESTADOWLOCReturn), LocatorUtils.property(thatLocator, "getestadowlocReturn", rhsGETESTADOWLOCReturn), lhsGETESTADOWLOCReturn, rhsGETESTADOWLOCReturn, (this.getestadowlocReturn!= null), (that.getestadowlocReturn!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            GetestadowlocOutput theGETESTADOWLOCReturn;
            theGETESTADOWLOCReturn = this.getGETESTADOWLOCReturn();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "getestadowlocReturn", theGETESTADOWLOCReturn), currentHashCode, theGETESTADOWLOCReturn, (this.getestadowlocReturn!= null));
        }
        ...
        if (draftCopy instanceof GETESTADOWLOCResponse) {
            final GETESTADOWLOCResponse copy = ((GETESTADOWLOCResponse) draftCopy);
            {
                ...
                if (getestadowlocReturnShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    GetestadowlocOutput copyGETESTADOWLOCReturn = ((GetestadowlocOutput) strategy.copy(LocatorUtils.property(locator, "getestadowlocReturn", sourceGETESTADOWLOCReturn), sourceGETESTADOWLOCReturn, (this.getestadowlocReturn!= null)));
