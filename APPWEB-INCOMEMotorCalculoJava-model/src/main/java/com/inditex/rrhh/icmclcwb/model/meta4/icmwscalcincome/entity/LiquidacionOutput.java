...
/**
 * <p>Clase Java para LiquidacionOutput complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="LiquidacionOutput"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "LiquidacionOutput", propOrder = {
    "_return",
    "logMessage",
    "icmResultadoguardado"
})
public class LiquidacionOutput implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LiquidacionOutput that = ((LiquidacionOutput) object);
        {
            double lhsReturn;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LiquidacionOutput) {
            final LiquidacionOutput copy = ((LiquidacionOutput) draftCopy);
            {
