...
public class TrabajoTiendaEmpleadoPresenciaSeccionRepositoryImpl
	...
	private static final String SAVE = "MERGE INTO DESARROLLO_RRHH.INCOME_TRABAJO_TIENDA_EMPLEADO_PRESENCIA_SECCION "
			...
			+ " INSERT (FECHA, ID_TIENDA, MINUTOS_1, MINUTOS_2, MINUTOS_3, ID_TRABAJO, ID_EMPLEADO, ID_TIPO_HORA) "
			+ " VALUES (S.FECHA, S.ID_TIENDA, S.MINUTOS_1, S.MINUTOS_2, S.MINUTOS_3, S.ID_TRABAJO, S.ID_EMPLEADO, S.ID_TIPO_HORA)";
