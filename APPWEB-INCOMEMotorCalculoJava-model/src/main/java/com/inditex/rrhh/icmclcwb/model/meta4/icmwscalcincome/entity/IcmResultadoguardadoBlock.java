...
/**
 * <p>
 * Clase Java para Icm_ResultadoguardadoBlock complex type.
 *
 * <p>
...
public class IcmResultadoguardadoBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
     ...
     * there is not a <CODE>set</CODE> method for the icmResultadoguardadoRecordSet property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link IcmResultadoguardadoRecord }
     *
     *
     */
            ...
            final IcmResultadoguardadoBlock copy = ((IcmResultadoguardadoBlock) draftCopy);
            {
                ...
                if (icmResultadoguardadoRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmResultadoguardadoRecordSet = (((this.icmResultadoguardadoRecordSet != null)
                            && (!this.icmResultadoguardadoRecordSet.isEmpty()))
                                    ? this.getIcmResultadoguardadoRecordSet() : null);
