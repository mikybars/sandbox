...
public class DirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo implements RunAlgoritmo {
    ...
    public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RepositoryCustom
        ...
        for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
            ...
            try {
                final CompletableFuture<Void> cfCalc = this.tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RepositoryCustom
                    .calcular(algoritmo,
