...
/**
 * <p>Clase Java para GettiendasincomeOutput complex type.
 *
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 *
 * <pre>
 * &lt;complexType name="GettiendasincomeOutput"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GettiendasincomeOutput", propOrder = {
    "_return",
    "logMessage",
    "icmParametrospaginacion",
    "icmListatiendas"
})
public class GettiendasincomeOutput implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GettiendasincomeOutput that = ((GettiendasincomeOutput) object);
        {
            double lhsReturn;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GettiendasincomeOutput) {
            final GettiendasincomeOutput copy = ((GettiendasincomeOutput) draftCopy);
            {
