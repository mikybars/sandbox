...
public class TareaAgrupacionPresenciaServiceImpl implements TareaAgrupacionPresenciaService {
    ...
    @Override
    public void procesarPresenciaAgrupacion(@Valid RunTareaDto runTarea) {
        tareaAgrupacionPresenciaRepositoryCustom.procesarPresenciaAgrupacion(runTarea.getTarea());
    }
}
