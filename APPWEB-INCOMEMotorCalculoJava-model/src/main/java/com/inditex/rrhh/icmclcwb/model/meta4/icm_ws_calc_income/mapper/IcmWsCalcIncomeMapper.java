...
public interface IcmWsCalcIncomeMapper {
    ...
    @Mapping(source = "fechainicio", target = "fechaInicio", dateFormat = Meta4Constants.META4_DATE_FULL, ignore = true)
    @Mapping(source = "fechafin", target = "fechaFin", dateFormat = Meta4Constants.META4_DATE_FULL, ignore = true)
