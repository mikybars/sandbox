        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(cadenas)) {
                ...
                for (final PeriodoDto periodo : periodos) {
                    ...
                    paramVentaOnlineEntregaDomicilio.setEmpresa(Arrays.asList(Integer.valueOf(tarea.getStdIdLegEnt())));
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(cadenas) && localizaciones.hasData()) {
                ...
                for (final PeriodoDto periodo : periodos) {
                    ...
                    paramVentaOnlineEntregaTienda.setEmpresa(Arrays.asList(Integer.valueOf(tarea.getStdIdLegEnt())));
                ...
                for (final PeriodoDto periodo : periodos) {
                    ...
                    final PtrVentaOnlinePickingRequestDto paramVentaOnlinePicking = this.tareaMapper
                        .mergeTareaDtoAndTareaAmbitoDtoPeriodoDtoToPtrVentaOnlinePickingRequestDto(tarea, tareaAmbito,
                                periodo);
                    paramVentaOnlinePicking.setEmpresa(Arrays.asList(Integer.valueOf(tarea.getStdIdLegEnt())));
        ...
        try {
            ...
            for (final IdLocalizacionLocalPresupuestoDto iter : this.tareaLocalizacionHistoricoService
                ...
                AsyncUtils.checkAsyncAvaliable(cfPersist, this.ventaEcommerceProperties
                    ...
                    .getMaxPersistenceSize());
                AsyncUtils.exceptionally(
                        this.tareaLocalizacionPresupuestoVentaAsyncService.savePtrVentaOnlineIpodResponse(data, iter,
                                tarea),
                        cf, cfPersist);
            }
            AsyncUtils.waitAllOfIsOk(cf, cf);
        ...
        try {
            ...
            for (final IdLocalizacionLocalPresupuestoDto iter : this.tareaLocalizacionHistoricoService
                ...
                AsyncUtils.checkAsyncAvaliable(cfPersist, this.ventaEcommerceProperties
                    ...
                    .getMaxPersistenceSize());
                AsyncUtils.exceptionally(
                        this.tareaLocalizacionPresupuestoVentaAsyncService.savePtrVentaOnlinePickingResponse(data, iter,
                                tarea),
                        cf, cfPersist);
            }
            AsyncUtils.waitAllOfIsOk(cf, cf);
    ...
    public void ventaRangoOnlineEntregaTiendaLocalizacionSeccionByRunTareaAndTareaAmbito(
        ...
        try {
            ...
            for (final IdLocalizacionLocalPresupuestoDto iter : this.tareaLocalizacionHistoricoService
                ...
                paramVentaOnlineEntregaTiendaRequest.setEmpresa(Arrays.asList(Integer.valueOf(tarea.getStdIdLegEnt())));
                ...
                AsyncUtils.checkAsyncAvaliable(cfPersist, this.ventaEcommerceProperties
                    ...
                    .getMaxPersistenceSize());
                AsyncUtils.exceptionally(
                        this.tareaLocalizacionPresupuestoVentaAsyncService.savePtrVentaOnlineEntregaTiendaResponse(data,
                                iter, tarea),
                        cf, cfPersist);
            }
            AsyncUtils.waitAllOfIsOk(cf, cf);
        ...
        try {
            ...
            for (final IdLocalizacionLocalPresupuestoDto iter : this.tareaLocalizacionHistoricoService
                ...
                AsyncUtils.checkAsyncAvaliable(cfPersist, this.ventaEcommerceProperties
                    ...
                    .getMaxPersistenceSize());
                AsyncUtils.exceptionally(
                        this.tareaLocalizacionPresupuestoVentaAsyncService.savePtrVentaOnlineEntregaDomicilioResponse(
                                data,
                                iter, tarea),
                        cf, cfPersist);
            }
