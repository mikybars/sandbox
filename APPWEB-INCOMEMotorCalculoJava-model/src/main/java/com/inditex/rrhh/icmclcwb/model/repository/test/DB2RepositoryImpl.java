...
public class DB2RepositoryImpl implements DB2Repository {
	...
	public List<VentaDto> getDatosXMLCompleto() {
		...
		final String sql = new StringBuffer().append("SELECT X.* ").append("FROM session.TEST1 T1, ")
				.append("XMLTABLE ('$d/ventaTotalizadoResponse/ventaTotalizado' passing T1.log as \"d\" ")
				.append("COLUMNS ").append("FECHA VARCHAR(50) PATH 'fecha',").append("PAIS BIGINT PATH 'pais',")
				.append("CADENA BIGINT PATH 'cadena',").append("TIENDA BIGINT PATH 'tienda',")
	...
	public List<VentaDto> getDatosJoinXMLCompleto() {
		...
		String sql = new StringBuffer().append("INSERT INTO session.TEST2 ")
		...
		sql = new StringBuffer().append("INSERT INTO session.TEST3 ")
				.append("(fecha, idPais, idCadena, idTienda, importeSinIVA, importeConIVA) ")
		...
		sql = new StringBuffer()
				...
				.append("FROM session.TEST2 t1 ").append("INNER JOIN session.TEST3 t2 ").append(" ON t1.fecha=t2.fecha")
	...
	public void insertarDatosXMLTrozos(List<VentaDto> ventas) {
		java.util.Date time1 = new java.util.Date();
		logger.info("Se inserta datos en temporal TEST2");
		final String sql = new StringBuffer().append("INSERT INTO session.TEST2 ")
				.append("(fecha, idPais, idCadena, idTienda, importeSinIVA, importeConIVA) ")
	...
	public List<VentaDto> getDatosJoinXMLTrozos() {
		...
		java.util.Date time1 = new java.util.Date();
		logger.info("Se inserta datos en temporal TEST3");
		String sql = new StringBuffer().append("INSERT INTO session.TEST3 ")
				.append("(fecha, idPais, idCadena, idTienda, importeSinIVA, importeConIVA) ")
				.append("SELECT fecha, idPais, idCadena, idTienda, importeSinIVA, importeConIVA")
				.append(" FROM session.TEST2").toString();
		jdbcTemplate.execute(sql);
