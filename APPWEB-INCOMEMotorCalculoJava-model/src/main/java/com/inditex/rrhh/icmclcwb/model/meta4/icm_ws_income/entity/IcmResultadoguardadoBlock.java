...
public class IcmResultadoguardadoBlock implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IcmResultadoguardadoBlock that = ((IcmResultadoguardadoBlock) object);
        {
            ...
            lhsIcmResultadoguardadoRecordSet = (((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty()))?this.getIcmResultadoguardadoRecordSet():null);
            List<IcmResultadoguardadoRecord> rhsIcmResultadoguardadoRecordSet;
            rhsIcmResultadoguardadoRecordSet = (((that.icmResultadoguardadoRecordSet!= null)&&(!that.icmResultadoguardadoRecordSet.isEmpty()))?that.getIcmResultadoguardadoRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmResultadoguardadoRecordSet", lhsIcmResultadoguardadoRecordSet), LocatorUtils.property(thatLocator, "icmResultadoguardadoRecordSet", rhsIcmResultadoguardadoRecordSet), lhsIcmResultadoguardadoRecordSet, rhsIcmResultadoguardadoRecordSet, ((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty())), ((that.icmResultadoguardadoRecordSet!= null)&&(!that.icmResultadoguardadoRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        {
            ...
            theIcmResultadoguardadoRecordSet = (((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty()))?this.getIcmResultadoguardadoRecordSet():null);
            strategy.appendField(locator, this, "icmResultadoguardadoRecordSet", buffer, theIcmResultadoguardadoRecordSet, ((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            List<IcmResultadoguardadoRecord> theIcmResultadoguardadoRecordSet;
            theIcmResultadoguardadoRecordSet = (((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty()))?this.getIcmResultadoguardadoRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmResultadoguardadoRecordSet", theIcmResultadoguardadoRecordSet), currentHashCode, theIcmResultadoguardadoRecordSet, ((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmResultadoguardadoBlock) {
            ...
            {
                Boolean icmResultadoguardadoRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty())));
                if (icmResultadoguardadoRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmResultadoguardadoRecordSet = (((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty()))?this.getIcmResultadoguardadoRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmResultadoguardadoRecord> copyIcmResultadoguardadoRecordSet = ((List<IcmResultadoguardadoRecord> ) strategy.copy(LocatorUtils.property(locator, "icmResultadoguardadoRecordSet", sourceIcmResultadoguardadoRecordSet), sourceIcmResultadoguardadoRecordSet, ((this.icmResultadoguardadoRecordSet!= null)&&(!this.icmResultadoguardadoRecordSet.isEmpty()))));
