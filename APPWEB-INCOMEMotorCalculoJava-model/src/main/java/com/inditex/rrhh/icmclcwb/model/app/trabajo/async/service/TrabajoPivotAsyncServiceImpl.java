...
import com.inditex.rrhh.icmclcwb.api.app.trabajo.async.service.TrabajoTiendaVentaSeccionAsyncService;
...
public class TrabajoPivotAsyncServiceImpl implements TrabajoPivotAsyncService {
    ...
    @Async
    @Override
    public CompletableFuture<Void> pivot(@Valid final TrabajoDto trabajoDto) {
