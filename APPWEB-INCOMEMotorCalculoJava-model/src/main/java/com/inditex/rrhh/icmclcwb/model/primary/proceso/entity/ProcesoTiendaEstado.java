...
@Entity
@Table(name = "PROCESO_TIENDA_ESTADO")
@Data
public class ProcesoTiendaEstado {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ID_PROCESO_TIENDA_ESTADO")
	...
	@NotNull
	@OneToOne
	@JoinColumn(name = "ID_TIPO_PROCESO_TIENDA", nullable = false)
	private /* BigInteger */ TipoProcesoTienda tipo;
