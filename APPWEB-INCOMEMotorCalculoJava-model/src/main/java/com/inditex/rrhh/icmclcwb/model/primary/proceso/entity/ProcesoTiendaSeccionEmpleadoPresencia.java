...
@Entity
@Table(name = "PROCESO_TIENDA_SECCION_EMPLEADO_PRESENCIA")
@Data
public class ProcesoTiendaSeccionEmpleadoPresencia {

	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name = "ID_PROCESO_TIENDA_SECCION_EMPLEADO_PRESENCIA")
