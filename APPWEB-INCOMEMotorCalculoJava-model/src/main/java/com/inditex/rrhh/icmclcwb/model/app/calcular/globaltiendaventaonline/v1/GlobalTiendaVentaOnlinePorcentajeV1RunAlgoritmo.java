...
public class GlobalTiendaVentaOnlinePorcentajeV1RunAlgoritmo implements RunAlgoritmo {
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea,
    ...
    this.log.info(
        "Trabajo[{}]Tarea[{}] :: Inicio :: GlobalTiendaVentaOnlinePorcentajeV1RunAlgoritmo :: Ids",
        runTarea.getTrabajo().getId(), runTarea.getTarea().getId());
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoGlobalTiendaVentaOnlinePorcentajeV1RepositoryCustom
        .ids(algoritmo, runTarea.getTarea());
    this.log.info(
        "Trabajo[{}]Tarea[{}] :: Fin :: GlobalTiendaVentaOnlinePorcentajeV1RunAlgoritmo :: Ids: {}",
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      this.log.info(
          "Trabajo[{}]Tarea[{}] :: Inicio :: GlobalTiendaVentaOnlinePorcentajeV1RunAlgoritmo :: Personas: {}",
          runTarea.getTrabajo().getId(), runTarea.getTarea().getId(), personas.size());
      try {
        final CompletableFuture<Void> cfCalc = this.tareaCalculoAlgoritmoGlobalTiendaVentaOnlinePorcentajeV1RepositoryCustom
            .calcular(algoritmo,
        ...
        this.log.error(
            "Trabajo[{}]Tarea[{}] :: GlobalTiendaVentaOnlinePorcentajeV1RunAlgoritmo :: KO :: Personas: {}",
            runTarea.getTrabajo().getId(), runTarea.getTarea().getId(), personas.size(), e);
        this.tareaCalculoPersonaService.updateWithEstadoAndidPersona(personas, runTarea,
            EstadoTareaCalculoPersonaEnum.KO.getDto());
      }
      this.log.info(
          "Trabajo[{}]Tarea[{}] :: Fin :: GlobalTiendaVentaOnlinePorcentajeV1RunAlgoritmo :: Personas: {}",
          runTarea.getTrabajo().getId(), runTarea.getTarea().getId(), personas.size());
    }
