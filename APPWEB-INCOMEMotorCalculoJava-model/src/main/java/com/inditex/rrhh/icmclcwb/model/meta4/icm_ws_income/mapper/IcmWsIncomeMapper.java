...
import com.inditex.rrhh.icmclcwb.model.meta4.icm_ws_income.entity.IcmTiendacomisionableRecord;
...
public interface IcmWsIncomeMapper {
	...
	@Mappings({ @Mapping(source = "idestructura", target = "idEstructura"),
		@Mapping(source = "tipocondicion", target = "tipoCondicion"),
	...
	@InheritInverseConfiguration
	IcmParametrostiendaBlock asIcmParametrostiendaBlock(TiendaComisionableFilterDto src);
	...
	@Mappings({@Mapping(source = "m4AutoGeneratedRecordID", target = "m4AutoGeneratedRecordID"),
		...
		@Mapping(source = "comisionable", target = "comisionable"),
		@Mapping(source = "idlugartrabajo", target = "idLugarTrabajo")
	})
	TiendaComisionableResultItemDto asTiendaComisionableResultItemDto(IcmTiendacomisionableRecord src);
	
	List<TiendaComisionableResultItemDto> asTiendaComisionableResultItemDtos(List<IcmTiendacomisionableRecord> src);
