...
public class GTCalculoRepositoryImpl  implements GTCalculoRepository{
	...
	private StringBuilder queryCalculoGT() {
		...
		query.append("INSERT INTO TRABAJO_CALCULO (").
		...
		append(" FROM TRABAJO_TIENDA_EMPLEADO_PRESENCIA_SECCION AS EMPLEADO_PRESENCIA ").
		
		append(" INNER JOIN TRABAJO_EMPLEADO_HISTORICO AS EMPLEADO_HISTORICO ").
		...
		append(" INNER JOIN TRABAJO_TIENDA_PRESENCIA_SECCION AS TIENDA_PRESENCIA  ").
		append(" ON TIENDA_PRESENCIA.ID_TIENDA = EMPLEADO_PRESENCIA.ID_TIENDA AND TIENDA_PRESENCIA.FECHA = EMPLEADO_PRESENCIA.FECHA ").
		
		append(" INNER JOIN TRABAJO_TIENDA_COMISION_HISTORICO AS  TIENDA_COMISION_HISTORICO ").
		...
		append(" INNER JOIN TRABAJO_TIENDA_VENTA_SECCION AS  TIENDA_VENTA ").
		append(" ON TIENDA_VENTA.ID_TIENDA = TIENDA_PRESENCIA.ID_TIENDA AND TIENDA_VENTA.FECHA = TIENDA_PRESENCIA.FECHA  ").
			
		append(" INNER JOIN TRABAJO_EMPLEADO_ESTRUCTURA AS ESTRUCTURA  ").
		...
		append("  INNER JOIN TRABAJO_TIPO_HORA AS TIPO_HORA  ").
