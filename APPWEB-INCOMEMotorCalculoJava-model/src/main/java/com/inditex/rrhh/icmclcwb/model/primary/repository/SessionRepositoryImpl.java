...
public class SessionRepositoryImpl implements SessionRepository {
    ...
    public void jdbcTemplate() {
        ...
        // Índices
        IntStream.range(0, CREATE_INDEX_TABLE_EMPLEADO_NAME.size()).forEach(idx -> jdbcTemplate.execute(
                crearIndiceTablaTemporal(TABLE_EMPLEADO_NAME, idx, CREATE_INDEX_TABLE_EMPLEADO_NAME.get(idx))));
        // Insert
