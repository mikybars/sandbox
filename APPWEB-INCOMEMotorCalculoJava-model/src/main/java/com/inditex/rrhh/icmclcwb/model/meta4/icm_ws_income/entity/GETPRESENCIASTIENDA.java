...
@XmlRootElement(name = "GETPRESENCIASTIENDA")
public class GETPRESENCIASTIENDA implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GETPRESENCIASTIENDA that = ((GETPRESENCIASTIENDA) object);
        {
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GETPRESENCIASTIENDA) {
            final GETPRESENCIASTIENDA copy = ((GETPRESENCIASTIENDA) draftCopy);
            {
