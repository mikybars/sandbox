...
public class LoginWithRole implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "aiSRole", lhsAiSRole), LocatorUtils.property(thatLocator, "aiSRole", rhsAiSRole), lhsAiSRole, rhsAiSRole, (this.aiSRole!= null), (that.aiSRole!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theAiSRole;
            theAiSRole = this.getAiSRole();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "aiSRole", theAiSRole), currentHashCode, theAiSRole, (this.aiSRole!= null));
        }
        ...
        if (draftCopy instanceof LoginWithRole) {
            ...
            }
            {
                ...
                if (aiSRoleShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    String copyAiSRole = ((String) strategy.copy(LocatorUtils.property(locator, "aiSRole", sourceAiSRole), sourceAiSRole, (this.aiSRole!= null)));
