...
public class LoginWithRole implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            String rhsIn3;
            rhsIn3 = that.getIn3();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "in3", lhsIn3), LocatorUtils.property(thatLocator, "in3", rhsIn3), lhsIn3, rhsIn3, (this.in3 != null), (that.in3 != null))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            String theIn3;
            theIn3 = this.getIn3();
            strategy.appendField(locator, this, "in3", buffer, theIn3, (this.in3 != null));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theIn3;
            theIn3 = this.getIn3();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "in3", theIn3), currentHashCode, theIn3, (this.in3 != null));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof LoginWithRole) {
            ...
            {
                Boolean in3ShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.in3 != null));
                if (in3ShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceIn3;
                    sourceIn3 = this.getIn3();
                    String copyIn3 = ((String) strategy.copy(LocatorUtils.property(locator, "in3", sourceIn3), sourceIn3, (this.in3 != null)));
                    copy.setIn3(copyIn3);
                } else {
                    if (in3ShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.in3 = null;
                    }
                }
            }
