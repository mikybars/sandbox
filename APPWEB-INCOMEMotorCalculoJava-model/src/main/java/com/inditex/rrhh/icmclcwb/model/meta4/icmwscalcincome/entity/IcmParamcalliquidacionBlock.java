...
/**
 * <p>Clase Java para Icm_ParamcalliquidacionBlock complex type.
 *
...
public class IcmParamcalliquidacionBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the icmParamcalliquidacionRecordSet
   * property.
   *
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link IcmParamcalliquidacionRecord }
   *
   *
   */
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    final IcmParamcalliquidacionBlock that = ((IcmParamcalliquidacionBlock) object);
    {
      ...
      lhsIcmParamcalliquidacionRecordSet =
          (((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty()))
              ? this.getIcmParamcalliquidacionRecordSet()
              : null);
      List<IcmParamcalliquidacionRecord> rhsIcmParamcalliquidacionRecordSet;
      rhsIcmParamcalliquidacionRecordSet =
          (((that.icmParamcalliquidacionRecordSet != null) && (!that.icmParamcalliquidacionRecordSet.isEmpty()))
              ? that.getIcmParamcalliquidacionRecordSet()
              : null);
      if (!strategy.equals(LocatorUtils.property(thisLocator, "icmParamcalliquidacionRecordSet", lhsIcmParamcalliquidacionRecordSet),
          LocatorUtils.property(thatLocator, "icmParamcalliquidacionRecordSet", rhsIcmParamcalliquidacionRecordSet),
          lhsIcmParamcalliquidacionRecordSet, rhsIcmParamcalliquidacionRecordSet,
          ((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty())),
          ((that.icmParamcalliquidacionRecordSet != null) && (!that.icmParamcalliquidacionRecordSet.isEmpty())))) {
        return false;
      }
  ...
  public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
    {
      ...
      theIcmParamcalliquidacionRecordSet =
          (((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty()))
              ? this.getIcmParamcalliquidacionRecordSet()
              : null);
      strategy.appendField(locator, this, "icmParamcalliquidacionRecordSet", buffer, theIcmParamcalliquidacionRecordSet,
          ((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty())));
    }
    return buffer;
  }
    ...
    int currentHashCode = 1;
    {
      ...
      theIcmParamcalliquidacionRecordSet =
          (((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty()))
              ...
              : null);
      currentHashCode =
          strategy.hashCode(LocatorUtils.property(locator, "icmParamcalliquidacionRecordSet", theIcmParamcalliquidacionRecordSet),
              currentHashCode, theIcmParamcalliquidacionRecordSet,
              ((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty())));
    }
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
    ...
    if (draftCopy instanceof IcmParamcalliquidacionBlock) {
      ...
      {
        Boolean icmParamcalliquidacionRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator,
            ((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty())));
        if (icmParamcalliquidacionRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          sourceIcmParamcalliquidacionRecordSet =
              (((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty()))
                  ? this.getIcmParamcalliquidacionRecordSet()
                  : null);
          @SuppressWarnings("unchecked")
          List<IcmParamcalliquidacionRecord> copyIcmParamcalliquidacionRecordSet = ((List<IcmParamcalliquidacionRecord>) strategy.copy(
              LocatorUtils.property(locator, "icmParamcalliquidacionRecordSet", sourceIcmParamcalliquidacionRecordSet),
              sourceIcmParamcalliquidacionRecordSet,
              ((this.icmParamcalliquidacionRecordSet != null) && (!this.icmParamcalliquidacionRecordSet.isEmpty()))));
