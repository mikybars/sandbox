...
@Repository
public class TrabajoTiendaHistoricoRepositoryCustomImpl extends JdbcBatchPrimaryRepositoryAbstract<TrabajoTiendaHistorico>
    ...
    @Override
    public List<TrabajoTiendaHistorico> save(final List<TrabajoTiendaHistorico> src) {
