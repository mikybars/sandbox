...
public class GETCLASESResponse implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Gets the value of the getclasesReturn property.
     *
     * @return
     *     possible object is
     *     {@link GetclasesOutput }
     *
     */
    ...
    /**
     * Sets the value of the getclasesReturn property.
     *
     * @param value
     *     allowed object is
     *     {@link GetclasesOutput }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GETCLASESResponse that = ((GETCLASESResponse) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "getclasesReturn", lhsGETCLASESReturn), LocatorUtils.property(thatLocator, "getclasesReturn", rhsGETCLASESReturn), lhsGETCLASESReturn, rhsGETCLASESReturn, (this.getclasesReturn!= null), (that.getclasesReturn!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            GetclasesOutput theGETCLASESReturn;
            theGETCLASESReturn = this.getGETCLASESReturn();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "getclasesReturn", theGETCLASESReturn), currentHashCode, theGETCLASESReturn, (this.getclasesReturn!= null));
        }
        ...
        if (draftCopy instanceof GETCLASESResponse) {
            final GETCLASESResponse copy = ((GETCLASESResponse) draftCopy);
            {
                ...
                if (getclasesReturnShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    GetclasesOutput copyGETCLASESReturn = ((GetclasesOutput) strategy.copy(LocatorUtils.property(locator, "getclasesReturn", sourceGETCLASESReturn), sourceGETCLASESReturn, (this.getclasesReturn!= null)));
