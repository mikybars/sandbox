...
public class RunTareaRecolectarServiceImpl implements RunTareaRecolectarService {
    ...
    public RunTareaDto run(@Valid final RunTareaDto runTarea) {
        ...
        try {
            ...
            if (EstadoTareaEnum.PENDIENTE_DATOS.getId().equals(tarea.getEstado().getId())) {
                tareaService.modifyEstadoTareaInicial(tarea, EstadoTareaEnum.EN_CURSO_DATOS.getDto());
                ...
                AsyncUtils.waitAllOfIsOk(cf, cf);
                /*-------------------------------------------------------------*/
                tareaService.modifyEstadoTarea(tarea, EstadoTareaEnum.PENDIENTE_CALCULO.getDto());
            }
