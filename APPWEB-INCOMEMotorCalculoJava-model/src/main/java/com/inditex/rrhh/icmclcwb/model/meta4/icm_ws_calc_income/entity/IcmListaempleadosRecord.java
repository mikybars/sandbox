...
public class IcmListaempleadosRecord implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        {
            String lhsIdcomponente;
            lhsIdcomponente = this.getIdcomponente();
            String rhsIdcomponente;
            rhsIdcomponente = that.getIdcomponente();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "idcomponente", lhsIdcomponente), LocatorUtils.property(thatLocator, "idcomponente", rhsIdcomponente), lhsIdcomponente, rhsIdcomponente, (this.idcomponente!= null), (that.idcomponente!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            String theIdcomponente;
            theIdcomponente = this.getIdcomponente();
            strategy.appendField(locator, this, "idcomponente", buffer, theIdcomponente, (this.idcomponente!= null));
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            String theIdcomponente;
            theIdcomponente = this.getIdcomponente();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "idcomponente", theIdcomponente), currentHashCode, theIdcomponente, (this.idcomponente!= null));
        }
        {
            String theIdtipocalculo;
            theIdtipocalculo = this.getIdtipocalculo();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmListaempleadosRecord) {
            ...
            {
                Boolean idcomponenteShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.idcomponente!= null));
                if (idcomponenteShouldBeCopiedAndSet == Boolean.TRUE) {
                    String sourceIdcomponente;
                    sourceIdcomponente = this.getIdcomponente();
                    String copyIdcomponente = ((String) strategy.copy(LocatorUtils.property(locator, "idcomponente", sourceIdcomponente), sourceIdcomponente, (this.idcomponente!= null)));
                    copy.setIdcomponente(copyIdcomponente);
                } else {
                    if (idcomponenteShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.idcomponente = null;
                    }
                }
            }
            {
