...
public class M4LoginOutput implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final M4LoginOutput that = ((M4LoginOutput) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "sessionID", lhsSessionID), LocatorUtils.property(thatLocator, "sessionID", rhsSessionID), lhsSessionID, rhsSessionID, (this.sessionID!= null), (that.sessionID!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            String theSessionID;
            theSessionID = this.getSessionID();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sessionID", theSessionID), currentHashCode, theSessionID, (this.sessionID!= null));
        }
        ...
        if (draftCopy instanceof M4LoginOutput) {
            final M4LoginOutput copy = ((M4LoginOutput) draftCopy);
            {
                ...
                if (sessionIDShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    String copySessionID = ((String) strategy.copy(LocatorUtils.property(locator, "sessionID", sourceSessionID), sourceSessionID, (this.sessionID!= null)));
