...
public interface PocTiendaRepository extends BaseRepository<PocTienda, String> {
	...
	List<PocTienda> findByIdPaisOrigenAndIdEmpresaAndIdTiendaMeta4In(@NotBlank String idPaisOrigen, @NotBlank String idEmpresa, @NotNull @NotEmpty List<String> tiendas);
