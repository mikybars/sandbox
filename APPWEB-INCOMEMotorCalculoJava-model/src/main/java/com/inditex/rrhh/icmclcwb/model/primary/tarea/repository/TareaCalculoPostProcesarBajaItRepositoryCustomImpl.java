...
@Repository
public class TareaCalculoPostProcesarBajaItRepositoryCustomImpl 
    extends AbstractTareaCalculoPostProcesarBaseRepositoryCustom
    implements TareaCalculoPostProcesarBajaItRepositoryCustom{
    ...
    protected Map<String, Object> getMapValues(TareaDto tarea, TareaCalculoPersonaDto persona) {
        ...
        map.put(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_POLITICA, TipoPoliticaEnum.BAJA_IT.getIdMeta4());
