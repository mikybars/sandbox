...
/**
 * <p>
 * Clase Java para Icm_ParamcalconfchdiasBlock complex type.
 *
 * <p>
...
public class IcmParamcalconfchdiasBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
     ...
     * there is not a <CODE>set</CODE> method for the icmParamcalconfchdiasRecordSet property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link IcmParamcalconfchdiasRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            lhsIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet != null)
                    && (!this.icmParamcalconfchdiasRecordSet.isEmpty())) ? this.getIcmParamcalconfchdiasRecordSet()
                            : null);
            List<IcmParamcalconfchdiasRecord> rhsIcmParamcalconfchdiasRecordSet;
            rhsIcmParamcalconfchdiasRecordSet = (((that.icmParamcalconfchdiasRecordSet != null)
                    && (!that.icmParamcalconfchdiasRecordSet.isEmpty())) ? that.getIcmParamcalconfchdiasRecordSet()
                            : null);
            if (!strategy.equals(
                    LocatorUtils.property(thisLocator, "icmParamcalconfchdiasRecordSet",
                            lhsIcmParamcalconfchdiasRecordSet),
                    LocatorUtils.property(thatLocator, "icmParamcalconfchdiasRecordSet",
                    ...
                    ((that.icmParamcalconfchdiasRecordSet != null)
                            && (!that.icmParamcalconfchdiasRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet != null)
                    && (!this.icmParamcalconfchdiasRecordSet.isEmpty())) ? this.getIcmParamcalconfchdiasRecordSet()
                            : null);
            strategy.appendField(locator, this, "icmParamcalconfchdiasRecordSet", buffer,
                    theIcmParamcalconfchdiasRecordSet, ((this.icmParamcalconfchdiasRecordSet != null)
                            && (!this.icmParamcalconfchdiasRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(
                    LocatorUtils.property(locator, "icmParamcalconfchdiasRecordSet", theIcmParamcalconfchdiasRecordSet),
                    currentHashCode, theIcmParamcalconfchdiasRecordSet, ((this.icmParamcalconfchdiasRecordSet != null)
                            && (!this.icmParamcalconfchdiasRecordSet.isEmpty())));
        }
        ...
        if (draftCopy instanceof IcmParamcalconfchdiasBlock) {
            ...
            }
            {
                Boolean icmParamcalconfchdiasRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator,
                        ((this.icmParamcalconfchdiasRecordSet != null)
                                && (!this.icmParamcalconfchdiasRecordSet.isEmpty())));
                if (icmParamcalconfchdiasRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet != null)
                            && (!this.icmParamcalconfchdiasRecordSet.isEmpty()))
                                    ? this.getIcmParamcalconfchdiasRecordSet() : null);
                    @SuppressWarnings("unchecked")
                    List<IcmParamcalconfchdiasRecord> copyIcmParamcalconfchdiasRecordSet = ((List<IcmParamcalconfchdiasRecord>) strategy
                        .copy(LocatorUtils.property(locator, "icmParamcalconfchdiasRecordSet",
                                sourceIcmParamcalconfchdiasRecordSet), sourceIcmParamcalconfchdiasRecordSet,
                                ((this.icmParamcalconfchdiasRecordSet != null)
                                        && (!this.icmParamcalconfchdiasRecordSet.isEmpty()))));
                    copy.icmParamcalconfchdiasRecordSet = null;
                    if (copyIcmParamcalconfchdiasRecordSet != null) {
                        List<IcmParamcalconfchdiasRecord> uniqueIcmParamcalconfchdiasRecordSetl = copy
                            .getIcmParamcalconfchdiasRecordSet();
