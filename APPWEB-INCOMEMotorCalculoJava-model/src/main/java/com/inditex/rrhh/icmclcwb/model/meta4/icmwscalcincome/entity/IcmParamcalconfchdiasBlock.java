...
public class IcmParamcalconfchdiasBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the icmParamcalconfchdiasRecordSet property.
     *
     * <p>
     ...
     * {@link IcmParamcalconfchdiasRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            lhsIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty()))?this.getIcmParamcalconfchdiasRecordSet():null);
            List<IcmParamcalconfchdiasRecord> rhsIcmParamcalconfchdiasRecordSet;
            rhsIcmParamcalconfchdiasRecordSet = (((that.icmParamcalconfchdiasRecordSet!= null)&&(!that.icmParamcalconfchdiasRecordSet.isEmpty()))?that.getIcmParamcalconfchdiasRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmParamcalconfchdiasRecordSet", lhsIcmParamcalconfchdiasRecordSet), LocatorUtils.property(thatLocator, "icmParamcalconfchdiasRecordSet", rhsIcmParamcalconfchdiasRecordSet), lhsIcmParamcalconfchdiasRecordSet, rhsIcmParamcalconfchdiasRecordSet, ((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty())), ((that.icmParamcalconfchdiasRecordSet!= null)&&(!that.icmParamcalconfchdiasRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty()))?this.getIcmParamcalconfchdiasRecordSet():null);
            strategy.appendField(locator, this, "icmParamcalconfchdiasRecordSet", buffer, theIcmParamcalconfchdiasRecordSet, ((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmParamcalconfchdiasRecord> theIcmParamcalconfchdiasRecordSet;
            theIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty()))?this.getIcmParamcalconfchdiasRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmParamcalconfchdiasRecordSet", theIcmParamcalconfchdiasRecordSet), currentHashCode, theIcmParamcalconfchdiasRecordSet, ((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmParamcalconfchdiasBlock) {
            ...
            {
                Boolean icmParamcalconfchdiasRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty())));
                if (icmParamcalconfchdiasRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmParamcalconfchdiasRecordSet = (((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty()))?this.getIcmParamcalconfchdiasRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmParamcalconfchdiasRecord> copyIcmParamcalconfchdiasRecordSet = ((List<IcmParamcalconfchdiasRecord> ) strategy.copy(LocatorUtils.property(locator, "icmParamcalconfchdiasRecordSet", sourceIcmParamcalconfchdiasRecordSet), sourceIcmParamcalconfchdiasRecordSet, ((this.icmParamcalconfchdiasRecordSet!= null)&&(!this.icmParamcalconfchdiasRecordSet.isEmpty()))));
