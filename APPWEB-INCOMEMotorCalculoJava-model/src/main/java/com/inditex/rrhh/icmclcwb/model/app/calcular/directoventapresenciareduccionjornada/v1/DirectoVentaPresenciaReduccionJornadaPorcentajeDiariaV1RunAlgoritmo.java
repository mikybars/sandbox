...
public class DirectoVentaPresenciaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo implements RunAlgoritmo {
        ...
        Flux.fromIterable(StreamUtils.partition(
            ...
            .map(personas -> {
                ...
                try {
                    ...
                    log.error(
                            "DirectoVentaPresenciaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo :: KO :: Personas: {}",
                            personas.size(), e);
                    tareaCalculoPersonaService.updateWithEstadoAndidPersona(personas, runTarea,
                            EstadoTareaCalculoPersonaEnum.KO.getDto());
                }
                log.info("Fin :: DirectoVentaPresenciaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
                        personas.size());
                return Flux.empty();
            })
            .sequential()
    ...
    public String getSqlCalcular(AlgoritmoDto algoritmo) {
        return tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeDiariaV1RepositoryCustom
