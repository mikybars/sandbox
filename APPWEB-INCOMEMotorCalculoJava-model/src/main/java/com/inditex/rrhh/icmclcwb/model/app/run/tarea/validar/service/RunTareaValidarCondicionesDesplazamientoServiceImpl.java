 ...
 *
 */
@Component("condicionesDesplazamientoV1")
@Validated
public class RunTareaValidarCondicionesDesplazamientoServiceImpl implements RunPrevalidar {
    ...
    public void execute(@NotNull @Valid final RunTareaDto runTarea,
        ...
        runTarea.getTarea()
            .getAmbito()
            .stream()
            .forEach(item -> this.runTareaAmbitoValidarCondicionesDesplazamientoService
