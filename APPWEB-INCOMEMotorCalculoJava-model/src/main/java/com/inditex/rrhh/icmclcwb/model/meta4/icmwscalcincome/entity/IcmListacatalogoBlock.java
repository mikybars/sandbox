...
/**
 * <p>
 * Clase Java para Icm_ListacatalogoBlock complex type.
 *
 * <p>
...
public class IcmListacatalogoBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
     ...
     * there is not a <CODE>set</CODE> method for the icmListacatalogoRecordSet property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link IcmListacatalogoRecord }
     *
     *
     */
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmListacatalogoBlock) {
            ...
            {
                Boolean icmListacatalogoRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator,
                        ((this.icmListacatalogoRecordSet != null) && (!this.icmListacatalogoRecordSet.isEmpty())));
