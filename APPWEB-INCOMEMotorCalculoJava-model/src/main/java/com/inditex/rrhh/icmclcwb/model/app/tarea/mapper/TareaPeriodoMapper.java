...
public abstract class TareaPeriodoMapper {
    ...
    @Mapping(source = "src.nuevo", target = "nuevo")
    @Mapping(source = "src.borrado", target = "borrado")
    @Mapping(source = "src.modificado", target = "modificado")
    @Mapping(source = "src.activo", target = "activo")
    @Mapping(source = "src.abierto", target = "abierto")
