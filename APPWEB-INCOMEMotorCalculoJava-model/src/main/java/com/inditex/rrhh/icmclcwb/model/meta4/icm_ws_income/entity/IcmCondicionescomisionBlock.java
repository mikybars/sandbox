...
/**
 * <p>Clase Java para Icm_CondicionescomisionBlock complex type.
 * 
...
public class IcmCondicionescomisionBlock implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IcmCondicionescomisionBlock that = ((IcmCondicionescomisionBlock) object);
        {
        ...
        {
            List<IcmCondicionescomisionRecord> lhsIcmCondicionescomisionRecordSet;
            lhsIcmCondicionescomisionRecordSet = (((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty()))?this.getIcmCondicionescomisionRecordSet():null);
            List<IcmCondicionescomisionRecord> rhsIcmCondicionescomisionRecordSet;
            rhsIcmCondicionescomisionRecordSet = (((that.icmCondicionescomisionRecordSet!= null)&&(!that.icmCondicionescomisionRecordSet.isEmpty()))?that.getIcmCondicionescomisionRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmCondicionescomisionRecordSet", lhsIcmCondicionescomisionRecordSet), LocatorUtils.property(thatLocator, "icmCondicionescomisionRecordSet", rhsIcmCondicionescomisionRecordSet), lhsIcmCondicionescomisionRecordSet, rhsIcmCondicionescomisionRecordSet, ((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty())), ((that.icmCondicionescomisionRecordSet!= null)&&(!that.icmCondicionescomisionRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<IcmCondicionescomisionRecord> theIcmCondicionescomisionRecordSet;
            theIcmCondicionescomisionRecordSet = (((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty()))?this.getIcmCondicionescomisionRecordSet():null);
            strategy.appendField(locator, this, "icmCondicionescomisionRecordSet", buffer, theIcmCondicionescomisionRecordSet, ((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmCondicionescomisionRecord> theIcmCondicionescomisionRecordSet;
            theIcmCondicionescomisionRecordSet = (((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty()))?this.getIcmCondicionescomisionRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmCondicionescomisionRecordSet", theIcmCondicionescomisionRecordSet), currentHashCode, theIcmCondicionescomisionRecordSet, ((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmCondicionescomisionBlock) {
            final IcmCondicionescomisionBlock copy = ((IcmCondicionescomisionBlock) draftCopy);
            {
            ...
            {
                Boolean icmCondicionescomisionRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty())));
                if (icmCondicionescomisionRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<IcmCondicionescomisionRecord> sourceIcmCondicionescomisionRecordSet;
                    sourceIcmCondicionescomisionRecordSet = (((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty()))?this.getIcmCondicionescomisionRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmCondicionescomisionRecord> copyIcmCondicionescomisionRecordSet = ((List<IcmCondicionescomisionRecord> ) strategy.copy(LocatorUtils.property(locator, "icmCondicionescomisionRecordSet", sourceIcmCondicionescomisionRecordSet), sourceIcmCondicionescomisionRecordSet, ((this.icmCondicionescomisionRecordSet!= null)&&(!this.icmCondicionescomisionRecordSet.isEmpty()))));
                    copy.icmCondicionescomisionRecordSet = null;
                    if (copyIcmCondicionescomisionRecordSet!= null) {
                        List<IcmCondicionescomisionRecord> uniqueIcmCondicionescomisionRecordSetl = copy.getIcmCondicionescomisionRecordSet();
                        uniqueIcmCondicionescomisionRecordSetl.addAll(copyIcmCondicionescomisionRecordSet);
                    }
                } else {
                    if (icmCondicionescomisionRecordSetShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.icmCondicionescomisionRecordSet = null;
                    }
                }
            }
