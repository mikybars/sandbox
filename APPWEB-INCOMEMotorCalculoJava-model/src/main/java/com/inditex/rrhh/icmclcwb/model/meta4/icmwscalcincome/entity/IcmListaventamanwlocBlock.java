...
public class IcmListaventamanwlocBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    final IcmListaventamanwlocBlock that = ((IcmListaventamanwlocBlock) object);
    {
      ...
      lhsIcmListaventamanwlocRecordSet = (((this.icmListaventamanwlocRecordSet != null) && (!this.icmListaventamanwlocRecordSet.isEmpty()))
          ? this.getIcmListaventamanwlocRecordSet()
          : null);
      List<IcmListaventamanwlocRecord> rhsIcmListaventamanwlocRecordSet;
      rhsIcmListaventamanwlocRecordSet = (((that.icmListaventamanwlocRecordSet != null) && (!that.icmListaventamanwlocRecordSet.isEmpty()))
          ? that.getIcmListaventamanwlocRecordSet()
          : null);
      if (!strategy.equals(LocatorUtils.property(thisLocator, "icmListaventamanwlocRecordSet", lhsIcmListaventamanwlocRecordSet),
          LocatorUtils.property(thatLocator, "icmListaventamanwlocRecordSet", rhsIcmListaventamanwlocRecordSet),
  ...
  public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
    {
      ...
      theIcmListaventamanwlocRecordSet = (((this.icmListaventamanwlocRecordSet != null) && (!this.icmListaventamanwlocRecordSet.isEmpty()))
          ? this.getIcmListaventamanwlocRecordSet()
          : null);
      strategy.appendField(locator, this, "icmListaventamanwlocRecordSet", buffer, theIcmListaventamanwlocRecordSet,
          ((this.icmListaventamanwlocRecordSet != null) && (!this.icmListaventamanwlocRecordSet.isEmpty())));
    }
    return buffer;
  }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
    int currentHashCode = 1;
    {
      ...
      theIcmListaventamanwlocRecordSet = (((this.icmListaventamanwlocRecordSet != null) && (!this.icmListaventamanwlocRecordSet.isEmpty()))
          ? this.getIcmListaventamanwlocRecordSet()
          : null);
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmListaventamanwlocRecordSet", theIcmListaventamanwlocRecordSet),
    ...
    if (draftCopy instanceof IcmListaventamanwlocBlock) {
      final IcmListaventamanwlocBlock copy = ((IcmListaventamanwlocBlock) draftCopy);
      {
        ...
        if (icmListaventamanwlocRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          sourceIcmListaventamanwlocRecordSet =
              (((this.icmListaventamanwlocRecordSet != null) && (!this.icmListaventamanwlocRecordSet.isEmpty()))
                  ? this.getIcmListaventamanwlocRecordSet()
                  : null);
          @SuppressWarnings("unchecked")
          List<IcmListaventamanwlocRecord> copyIcmListaventamanwlocRecordSet = ((List<IcmListaventamanwlocRecord>) strategy.copy(
              LocatorUtils.property(locator, "icmListaventamanwlocRecordSet", sourceIcmListaventamanwlocRecordSet),
              sourceIcmListaventamanwlocRecordSet,
              ((this.icmListaventamanwlocRecordSet != null) && (!this.icmListaventamanwlocRecordSet.isEmpty()))));
