...
public class TrabajoTiendaComisionHistoricoRepositoryCustomImpl extends
        JdbcBatchPrimaryRepositoryAbstract<TrabajoTiendaComisionHistorico> implements TrabajoTiendaComisionHistoricoRepositoryCustom {
    ...
    @Override
    public List<TrabajoTiendaComisionHistorico> save(final List<TrabajoTiendaComisionHistorico> src) {
