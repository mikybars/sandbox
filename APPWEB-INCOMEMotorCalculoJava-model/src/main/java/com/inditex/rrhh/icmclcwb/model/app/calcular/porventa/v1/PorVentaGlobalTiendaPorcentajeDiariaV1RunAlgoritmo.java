...
public class PorVentaGlobalTiendaPorcentajeDiariaV1RunAlgoritmo implements RunAlgoritmo {
    ...
    public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
        ...
        final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustom
        ...
        for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
            ...
            this.log.info(
                    "Trabajo[{}]Tarea[{}] :: Inicio :: PorVentaGlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
                    runTarea.getTrabajo().getId(), runTarea.getTarea().getId(), personas.size());
            try {
                final CompletableFuture<Void> cfCalc = this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustom
                    .calcular(
                            algoritmo,
                ...
                this.log.error(
                        "Trabajo[{}]Tarea[{}] :: PorVentaGlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: KO :: Personas: {}",
                        runTarea.getTrabajo().getId(), runTarea.getTarea().getId(), personas.size(), e);
                this.tareaCalculoPersonaService.updateWithEstadoAndidPersona(personas, runTarea,
                        EstadoTareaCalculoPersonaEnum.KO.getDto());
            }
            this.log.info(
                    "Trabajo[{}]Tarea[{}] :: Fin :: PorVentaGlobalTiendaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
                    runTarea.getTrabajo().getId(), runTarea.getTarea().getId(), personas.size());
        }
    ...
    public String getSqlCalcular(final AlgoritmoDTO algoritmo) {
        return this.tareaCalculoAlgoritmoPorVentaGlobalTiendaPorcentajeDiariaV1RepositoryCustom
