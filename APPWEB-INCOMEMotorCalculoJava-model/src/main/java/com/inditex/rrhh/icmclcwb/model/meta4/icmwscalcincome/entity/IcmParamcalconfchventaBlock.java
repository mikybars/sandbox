...
public class IcmParamcalconfchventaBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the icmParamcalconfchventaRecordSet property.
     *
     * <p>
     ...
     * {@link IcmParamcalconfchventaRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            lhsIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty()))?this.getIcmParamcalconfchventaRecordSet():null);
            List<IcmParamcalconfchventaRecord> rhsIcmParamcalconfchventaRecordSet;
            rhsIcmParamcalconfchventaRecordSet = (((that.icmParamcalconfchventaRecordSet!= null)&&(!that.icmParamcalconfchventaRecordSet.isEmpty()))?that.getIcmParamcalconfchventaRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmParamcalconfchventaRecordSet", lhsIcmParamcalconfchventaRecordSet), LocatorUtils.property(thatLocator, "icmParamcalconfchventaRecordSet", rhsIcmParamcalconfchventaRecordSet), lhsIcmParamcalconfchventaRecordSet, rhsIcmParamcalconfchventaRecordSet, ((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty())), ((that.icmParamcalconfchventaRecordSet!= null)&&(!that.icmParamcalconfchventaRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty()))?this.getIcmParamcalconfchventaRecordSet():null);
            strategy.appendField(locator, this, "icmParamcalconfchventaRecordSet", buffer, theIcmParamcalconfchventaRecordSet, ((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmParamcalconfchventaRecord> theIcmParamcalconfchventaRecordSet;
            theIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty()))?this.getIcmParamcalconfchventaRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmParamcalconfchventaRecordSet", theIcmParamcalconfchventaRecordSet), currentHashCode, theIcmParamcalconfchventaRecordSet, ((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmParamcalconfchventaBlock) {
            ...
            {
                Boolean icmParamcalconfchventaRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty())));
                if (icmParamcalconfchventaRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty()))?this.getIcmParamcalconfchventaRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmParamcalconfchventaRecord> copyIcmParamcalconfchventaRecordSet = ((List<IcmParamcalconfchventaRecord> ) strategy.copy(LocatorUtils.property(locator, "icmParamcalconfchventaRecordSet", sourceIcmParamcalconfchventaRecordSet), sourceIcmParamcalconfchventaRecordSet, ((this.icmParamcalconfchventaRecordSet!= null)&&(!this.icmParamcalconfchventaRecordSet.isEmpty()))));
