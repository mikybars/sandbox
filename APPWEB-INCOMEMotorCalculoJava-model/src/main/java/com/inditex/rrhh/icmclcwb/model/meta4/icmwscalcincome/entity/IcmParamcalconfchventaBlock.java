...
/**
 * <p>
 * Clase Java para Icm_ParamcalconfchventaBlock complex type.
 *
 * <p>
...
public class IcmParamcalconfchventaBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
     ...
     * there is not a <CODE>set</CODE> method for the icmParamcalconfchventaRecordSet property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link IcmParamcalconfchventaRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object,
        ...
        }
        {
            ...
            lhsIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet != null)
                    && (!this.icmParamcalconfchventaRecordSet.isEmpty())) ? this.getIcmParamcalconfchventaRecordSet()
                            : null);
            List<IcmParamcalconfchventaRecord> rhsIcmParamcalconfchventaRecordSet;
            rhsIcmParamcalconfchventaRecordSet = (((that.icmParamcalconfchventaRecordSet != null)
                    && (!that.icmParamcalconfchventaRecordSet.isEmpty())) ? that.getIcmParamcalconfchventaRecordSet()
                            : null);
            if (!strategy.equals(
                    LocatorUtils.property(thisLocator, "icmParamcalconfchventaRecordSet",
                            lhsIcmParamcalconfchventaRecordSet),
                    LocatorUtils.property(thatLocator, "icmParamcalconfchventaRecordSet",
                            rhsIcmParamcalconfchventaRecordSet),
                    lhsIcmParamcalconfchventaRecordSet, rhsIcmParamcalconfchventaRecordSet,
                    ((this.icmParamcalconfchventaRecordSet != null)
                            && (!this.icmParamcalconfchventaRecordSet.isEmpty())),
                    ((that.icmParamcalconfchventaRecordSet != null)
                            && (!that.icmParamcalconfchventaRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet != null)
                    && (!this.icmParamcalconfchventaRecordSet.isEmpty())) ? this.getIcmParamcalconfchventaRecordSet()
                            : null);
            strategy.appendField(locator, this, "icmParamcalconfchventaRecordSet", buffer,
                    theIcmParamcalconfchventaRecordSet, ((this.icmParamcalconfchventaRecordSet != null)
                            && (!this.icmParamcalconfchventaRecordSet.isEmpty())));
        }
        return buffer;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            ...
            currentHashCode = strategy.hashCode(
                    LocatorUtils.property(locator, "icmParamcalconfchventaRecordSet",
                            theIcmParamcalconfchventaRecordSet),
                    currentHashCode, theIcmParamcalconfchventaRecordSet, ((this.icmParamcalconfchventaRecordSet != null)
                            && (!this.icmParamcalconfchventaRecordSet.isEmpty())));
        }
        ...
        if (draftCopy instanceof IcmParamcalconfchventaBlock) {
            ...
            }
            {
                ...
                if (icmParamcalconfchventaRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmParamcalconfchventaRecordSet = (((this.icmParamcalconfchventaRecordSet != null)
                            && (!this.icmParamcalconfchventaRecordSet.isEmpty()))
                                    ? this.getIcmParamcalconfchventaRecordSet() : null);
                    @SuppressWarnings("unchecked")
                    List<IcmParamcalconfchventaRecord> copyIcmParamcalconfchventaRecordSet = ((List<IcmParamcalconfchventaRecord>) strategy
                        .copy(LocatorUtils.property(locator, "icmParamcalconfchventaRecordSet",
                    ...
                    if (copyIcmParamcalconfchventaRecordSet != null) {
                        List<IcmParamcalconfchventaRecord> uniqueIcmParamcalconfchventaRecordSetl = copy
                            .getIcmParamcalconfchventaRecordSet();
