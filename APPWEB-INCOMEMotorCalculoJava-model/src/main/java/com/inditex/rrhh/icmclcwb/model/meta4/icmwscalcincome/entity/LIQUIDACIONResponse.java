...
public class LIQUIDACIONResponse implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    /**
     * Obtiene el valor de la propiedad liquidacionReturn.
     *
     * @return
     *     possible object is
     *     {@link LiquidacionOutput }
     *
     */
    ...
    /**
     * Define el valor de la propiedad liquidacionReturn.
     *
     * @param value
     *     allowed object is
     *     {@link LiquidacionOutput }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final LIQUIDACIONResponse that = ((LIQUIDACIONResponse) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "liquidacionReturn", lhsLIQUIDACIONReturn), LocatorUtils.property(thatLocator, "liquidacionReturn", rhsLIQUIDACIONReturn), lhsLIQUIDACIONReturn, rhsLIQUIDACIONReturn, (this.liquidacionReturn!= null), (that.liquidacionReturn!= null))) {
                return false;
            }
        }
        return true;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            LiquidacionOutput theLIQUIDACIONReturn;
            theLIQUIDACIONReturn = this.getLIQUIDACIONReturn();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "liquidacionReturn", theLIQUIDACIONReturn), currentHashCode, theLIQUIDACIONReturn, (this.liquidacionReturn!= null));
        }
        ...
        if (draftCopy instanceof LIQUIDACIONResponse) {
            final LIQUIDACIONResponse copy = ((LIQUIDACIONResponse) draftCopy);
            {
                ...
                if (liquidacionReturnShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    LiquidacionOutput copyLIQUIDACIONReturn = ((LiquidacionOutput) strategy.copy(LocatorUtils.property(locator, "liquidacionReturn", sourceLIQUIDACIONReturn), sourceLIQUIDACIONReturn, (this.liquidacionReturn!= null)));
