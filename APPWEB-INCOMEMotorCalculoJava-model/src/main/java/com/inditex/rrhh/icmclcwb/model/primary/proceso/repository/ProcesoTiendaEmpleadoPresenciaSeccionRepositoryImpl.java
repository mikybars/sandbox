...
@Repository
public class ProcesoTiendaEmpleadoPresenciaSeccionRepositoryImpl
        implements ProcesoTiendaEmpleadoPresenciaSeccionRepository {
    ...
    @Autowired
    @Qualifier("pscfProcesoTiendaEmpleadoPresenciaSeccionRepositorySave")
