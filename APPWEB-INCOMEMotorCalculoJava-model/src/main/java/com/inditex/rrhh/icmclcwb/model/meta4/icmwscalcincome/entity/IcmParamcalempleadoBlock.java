...
public class IcmParamcalempleadoBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the icmParamcalempleadoRecordSet
   * property.
   *
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link IcmParamcalempleadoRecord }
   *
   *
   */
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    }
    {
      ...
      lhsIcmParamcalempleadoRecordSet = (((this.icmParamcalempleadoRecordSet != null) && (!this.icmParamcalempleadoRecordSet.isEmpty()))
          ? this.getIcmParamcalempleadoRecordSet()
          : null);
      List<IcmParamcalempleadoRecord> rhsIcmParamcalempleadoRecordSet;
      rhsIcmParamcalempleadoRecordSet = (((that.icmParamcalempleadoRecordSet != null) && (!that.icmParamcalempleadoRecordSet.isEmpty()))
          ? that.getIcmParamcalempleadoRecordSet()
          : null);
  ...
  public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
    ...
    }
    {
      ...
      theIcmParamcalempleadoRecordSet = (((this.icmParamcalempleadoRecordSet != null) && (!this.icmParamcalempleadoRecordSet.isEmpty()))
          ? this.getIcmParamcalempleadoRecordSet()
          : null);
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
    ...
    }
    {
      ...
      theIcmParamcalempleadoRecordSet = (((this.icmParamcalempleadoRecordSet != null) && (!this.icmParamcalempleadoRecordSet.isEmpty()))
          ? this.getIcmParamcalempleadoRecordSet()
          : null);
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmParamcalempleadoRecordSet", theIcmParamcalempleadoRecordSet),
    ...
    if (draftCopy instanceof IcmParamcalempleadoBlock) {
      ...
      }
      {
        ...
        if (icmParamcalempleadoRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          sourceIcmParamcalempleadoRecordSet =
              (((this.icmParamcalempleadoRecordSet != null) && (!this.icmParamcalempleadoRecordSet.isEmpty()))
                  ? this.getIcmParamcalempleadoRecordSet()
                  : null);
          @SuppressWarnings("unchecked")
          List<IcmParamcalempleadoRecord> copyIcmParamcalempleadoRecordSet = ((List<IcmParamcalempleadoRecord>) strategy.copy(
              LocatorUtils.property(locator, "icmParamcalempleadoRecordSet", sourceIcmParamcalempleadoRecordSet),
              sourceIcmParamcalempleadoRecordSet,
              ((this.icmParamcalempleadoRecordSet != null) && (!this.icmParamcalempleadoRecordSet.isEmpty()))));
