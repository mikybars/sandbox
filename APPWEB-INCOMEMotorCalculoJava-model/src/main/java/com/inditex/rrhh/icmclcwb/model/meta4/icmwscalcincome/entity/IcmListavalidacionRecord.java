...
/**
 * <p>Clase Java para Icm_ListavalidacionRecord complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="Icm_ListavalidacionRecord">
 *   &lt;complexContent>
 ...
 *         &lt;element name="validado" type="{http://www.w3.org/2001/XMLSchema}double"/>
...
@XmlType(name = "Icm_ListavalidacionRecord", propOrder = {
...
public class IcmListavalidacionRecord implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
     ...
     *     
     */
    public void setValidado(Double value) {
        this.validado = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IcmListavalidacionRecord that = ((IcmListavalidacionRecord) object);
        {
        ...
        {
            Double lhsValidado;
            lhsValidado = this.getValidado();
            Double rhsValidado;
            rhsValidado = that.getValidado();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "validado", lhsValidado), LocatorUtils.property(thatLocator, "validado", rhsValidado), lhsValidado, rhsValidado, (this.validado!= null), (that.validado!= null))) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            Double theValidado;
            theValidado = this.getValidado();
            strategy.appendField(locator, this, "validado", buffer, theValidado, (this.validado!= null));
        }
        {
            String theIdempresa;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            Double theValidado;
            theValidado = this.getValidado();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "validado", theValidado), currentHashCode, theValidado, (this.validado!= null));
        }
        {
            String theIdempresa;
            theIdempresa = this.getIdempresa();
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmListavalidacionRecord) {
            final IcmListavalidacionRecord copy = ((IcmListavalidacionRecord) draftCopy);
            {
            ...
            {
                Boolean validadoShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, (this.validado!= null));
                if (validadoShouldBeCopiedAndSet == Boolean.TRUE) {
                    Double sourceValidado;
                    sourceValidado = this.getValidado();
                    Double copyValidado = ((Double) strategy.copy(LocatorUtils.property(locator, "validado", sourceValidado), sourceValidado, (this.validado!= null)));
                    copy.setValidado(copyValidado);
                } else {
                    if (validadoShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.validado = null;
                    }
                }
            }
