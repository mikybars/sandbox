 ...
 *       &lt;sequence&gt;
 *         &lt;element name="GETEMPLEADOSReturn" type="{http://schemas.meta4.com/}GetempleadosOutput"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GETEMPLEADOSResponse implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
  ...
  /**
   * Gets the value of the getempleadosReturn property.
   *
   * @return possible object is {@link GetempleadosOutput }
   *
   */
  public GetempleadosOutput getGETEMPLEADOSReturn() {
    return getempleadosReturn;
  }

  /**
   * Sets the value of the getempleadosReturn property.
   *
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    final GETEMPLEADOSResponse that = ((GETEMPLEADOSResponse) object);
    {
      GetempleadosOutput lhsGETEMPLEADOSReturn;
      ...
      if (!strategy.equals(LocatorUtils.property(thisLocator, "getempleadosReturn", lhsGETEMPLEADOSReturn),
          LocatorUtils.property(thatLocator, "getempleadosReturn", rhsGETEMPLEADOSReturn), lhsGETEMPLEADOSReturn, rhsGETEMPLEADOSReturn,
          (this.getempleadosReturn != null), (that.getempleadosReturn != null))) {
        return false;
      }
    }
    return true;
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
    int currentHashCode = 1;
    {
      GetempleadosOutput theGETEMPLEADOSReturn;
      theGETEMPLEADOSReturn = this.getGETEMPLEADOSReturn();
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "getempleadosReturn", theGETEMPLEADOSReturn), currentHashCode,
    ...
    if (draftCopy instanceof GETEMPLEADOSResponse) {
      final GETEMPLEADOSResponse copy = ((GETEMPLEADOSResponse) draftCopy);
      {
        ...
        if (getempleadosReturnShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          GetempleadosOutput copyGETEMPLEADOSReturn =
              ((GetempleadosOutput) strategy.copy(LocatorUtils.property(locator, "getempleadosReturn", sourceGETEMPLEADOSReturn),
