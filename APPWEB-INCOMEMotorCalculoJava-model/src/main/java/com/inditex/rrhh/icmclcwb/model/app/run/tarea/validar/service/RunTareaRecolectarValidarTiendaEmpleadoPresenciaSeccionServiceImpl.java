...
import com.inditex.rrhh.icmclcwb.api.app.run.tarea.validar.service.RunTareaRecolectarValidarTiendaEmpleadoPresenciaSeccionService;
...
public class RunTareaRecolectarValidarTiendaEmpleadoPresenciaSeccionServiceImpl
    ...
    public RunTareaDto run(@NotNull @Valid RunTareaDto runTarea) {
        ...
        try {
            ...
            validation.setType(TareaTiendaEmpleadoPresenciaSeccion.class);
