...
/**
 * <p>Clase Java para Icm_CondicionestopesBlock complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="Icm_CondicionestopesBlock">
 *   &lt;complexContent>
 ...
 *         &lt;element name="Icm_CondicionestopesRecordSet" type="{http://schemas.meta4.com/}Icm_CondicionestopesRecord" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "Icm_CondicionestopesBlock", propOrder = {
    "orcomision",
    "idplantilla",
    "idestructura",
    "icmCondicionestopesRecordSet"
})
public class IcmCondicionestopesBlock implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    @XmlElement(name = "Icm_CondicionestopesRecordSet", nillable = true)
    protected List<IcmCondicionestopesRecord> icmCondicionestopesRecordSet;
    ...
    /**
     * Gets the value of the icmCondicionestopesRecordSet property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the icmCondicionestopesRecordSet property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIcmCondicionestopesRecordSet().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link IcmCondicionestopesRecord }
     * 
     * 
     */
    public List<IcmCondicionestopesRecord> getIcmCondicionestopesRecordSet() {
        if (icmCondicionestopesRecordSet == null) {
            icmCondicionestopesRecordSet = new ArrayList<IcmCondicionestopesRecord>();
        }
        return this.icmCondicionestopesRecordSet;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IcmCondicionestopesBlock that = ((IcmCondicionestopesBlock) object);
        {
        ...
        {
            List<IcmCondicionestopesRecord> lhsIcmCondicionestopesRecordSet;
            lhsIcmCondicionestopesRecordSet = (((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty()))?this.getIcmCondicionestopesRecordSet():null);
            List<IcmCondicionestopesRecord> rhsIcmCondicionestopesRecordSet;
            rhsIcmCondicionestopesRecordSet = (((that.icmCondicionestopesRecordSet!= null)&&(!that.icmCondicionestopesRecordSet.isEmpty()))?that.getIcmCondicionestopesRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmCondicionestopesRecordSet", lhsIcmCondicionestopesRecordSet), LocatorUtils.property(thatLocator, "icmCondicionestopesRecordSet", rhsIcmCondicionestopesRecordSet), lhsIcmCondicionestopesRecordSet, rhsIcmCondicionestopesRecordSet, ((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty())), ((that.icmCondicionestopesRecordSet!= null)&&(!that.icmCondicionestopesRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        {
            List<IcmCondicionestopesRecord> theIcmCondicionestopesRecordSet;
            theIcmCondicionestopesRecordSet = (((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty()))?this.getIcmCondicionestopesRecordSet():null);
            strategy.appendField(locator, this, "icmCondicionestopesRecordSet", buffer, theIcmCondicionestopesRecordSet, ((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmCondicionestopesRecord> theIcmCondicionestopesRecordSet;
            theIcmCondicionestopesRecordSet = (((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty()))?this.getIcmCondicionestopesRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmCondicionestopesRecordSet", theIcmCondicionestopesRecordSet), currentHashCode, theIcmCondicionestopesRecordSet, ((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmCondicionestopesBlock) {
            final IcmCondicionestopesBlock copy = ((IcmCondicionestopesBlock) draftCopy);
            {
            ...
            {
                Boolean icmCondicionestopesRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty())));
                if (icmCondicionestopesRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    List<IcmCondicionestopesRecord> sourceIcmCondicionestopesRecordSet;
                    sourceIcmCondicionestopesRecordSet = (((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty()))?this.getIcmCondicionestopesRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmCondicionestopesRecord> copyIcmCondicionestopesRecordSet = ((List<IcmCondicionestopesRecord> ) strategy.copy(LocatorUtils.property(locator, "icmCondicionestopesRecordSet", sourceIcmCondicionestopesRecordSet), sourceIcmCondicionestopesRecordSet, ((this.icmCondicionestopesRecordSet!= null)&&(!this.icmCondicionestopesRecordSet.isEmpty()))));
                    copy.icmCondicionestopesRecordSet = null;
                    if (copyIcmCondicionestopesRecordSet!= null) {
                        List<IcmCondicionestopesRecord> uniqueIcmCondicionestopesRecordSetl = copy.getIcmCondicionestopesRecordSet();
                        uniqueIcmCondicionestopesRecordSetl.addAll(copyIcmCondicionestopesRecordSet);
                    }
                } else {
                    if (icmCondicionestopesRecordSetShouldBeCopiedAndSet == Boolean.FALSE) {
                        copy.icmCondicionestopesRecordSet = null;
                    }
                }
            }
