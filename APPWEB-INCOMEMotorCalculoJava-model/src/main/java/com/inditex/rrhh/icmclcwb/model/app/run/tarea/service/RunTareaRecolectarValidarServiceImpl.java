...
public class RunTareaRecolectarValidarServiceImpl implements RunTareaRecolectarValidarService {
    ...
    @Autowired
    private RunTareaRecolectarValidarPersonaAsyncService runTareaRecolectarValidarPersonaAsyncService;
    
    @Autowired
    private RunTareaRecolectarValidarTiendaAsyncService runTareaRecolectarValidarTiendaAsyncService;
