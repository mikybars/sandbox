...
public interface TrabajoTiendaSeccionEmpleadoPresenciaRepositoryCustom {

    List<TrabajoTiendaSeccionEmpleadoPresencia> save(List<TrabajoTiendaSeccionEmpleadoPresencia> src);
