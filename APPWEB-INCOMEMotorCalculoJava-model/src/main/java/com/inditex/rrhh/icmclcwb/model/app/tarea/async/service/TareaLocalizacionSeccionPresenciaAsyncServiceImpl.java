...
@Service
public class TareaLocalizacionSeccionPresenciaAsyncServiceImpl implements TareaLocalizacionSeccionPresenciaAsyncService {

    @Autowired
    private TareaLocalizacionSeccionPresenciaService tareaLocalizacionSeccionPresenciaService;

    @Override
    public CompletableFuture<Void> save(List<PtrPresenciaTotalizadoResultItemDto> dto, TareaDto tarea) {
        tareaLocalizacionSeccionPresenciaService.save(dto, tarea);
