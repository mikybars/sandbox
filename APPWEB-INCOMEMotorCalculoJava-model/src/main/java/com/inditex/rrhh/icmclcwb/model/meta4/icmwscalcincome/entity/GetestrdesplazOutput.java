...
/**
 * <p>Clase Java para GetestrdesplazOutput complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GetestrdesplazOutput">
 *   &lt;complexContent>
...
@XmlType(name = "GetestrdesplazOutput", propOrder = {
    "_return",
    "logMessage",
    "icmListaestructuras"
})
public class GetestrdesplazOutput implements Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final GetestrdesplazOutput that = ((GetestrdesplazOutput) object);
        {
            double lhsReturn;
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof GetestrdesplazOutput) {
            final GetestrdesplazOutput copy = ((GetestrdesplazOutput) draftCopy);
            {
