...
public interface IcmWsCalcIncomeMapper {
    ...
    PresenciaManualResultItemDto asPresenciaManualResultItemDto(IcmListaempleadosRecord src);

    @InheritInverseConfiguration
    IcmListaempleadosRecord asIcmListatiendasRecord(PresenciaManualResultItemDto src);

    List<PresenciaManualResultItemDto> asPresenciaManualResultItemDtos(List<IcmListaempleadosRecord> src);
