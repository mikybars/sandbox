...
public interface IcmWsCalcIncomeMapper {
    ...
    List<ListaCondicionesBaseResultItemDto> asListaCondicionesBaseResultItemDto(List<IcmListacondicionesbaseRecord> src);
    ...
    List<ListaCondicionesDestinoResultItemDto> asListaCondicionesDestinoResultItemDto(List<IcmListacondicionesdestinoRecord> src);
    ...
    @Mapping(target = "idEmpleadoLocal", source = "idempleadolocal")
    @Mapping(target = "idOrigen", source = "idorigen")
    @Mapping(target = "icmListaCondicionesPolitica", source = "icmListacondicionespolitica.icmListacondicionespoliticaRecordSet")
    ...
    List<ListaCondicionesPoliticasResultItemDto> asListaCondicionesPoliticasResultItemDto(List<IcmListacondicionespoliticaRecord> src);
    ...
    @Mapping(target = "idTipoHora", source = "src.idtphora")
    @Mapping(target = "idOrigen", source = "idOrigen")
    @Mapping(target = "icmCkVentaImpuestos", source = "src.chkventaimpuestos")
    @Mapping(target = "idConfiguracion", source = "src.idconfig")
