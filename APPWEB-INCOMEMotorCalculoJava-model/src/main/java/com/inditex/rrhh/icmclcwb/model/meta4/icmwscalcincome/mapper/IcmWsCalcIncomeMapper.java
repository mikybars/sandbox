...
public interface IcmWsCalcIncomeMapper {
    ...
    IcmParamcalempleadoBlock asIcmParamcalempleadosBlock(SearchEmpleadosFilterDto src);
    ...
    @Mapping(target = "orempleado", ignore = true)
    @Mapping(target = "idempleadolocal", ignore = true)
    IcmParamcalempleadoRecord asIcmParamcalempleadosRecord(SearchEmpleadosFilterDto src);
