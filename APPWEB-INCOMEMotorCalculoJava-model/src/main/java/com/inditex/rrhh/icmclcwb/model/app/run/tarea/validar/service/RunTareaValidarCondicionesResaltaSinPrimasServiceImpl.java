...
@Component("condicionesResaltaSinPrimasV1")
@Validated
public class RunTareaValidarCondicionesResaltaSinPrimasServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NotNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesResaltaSinPrimasService
