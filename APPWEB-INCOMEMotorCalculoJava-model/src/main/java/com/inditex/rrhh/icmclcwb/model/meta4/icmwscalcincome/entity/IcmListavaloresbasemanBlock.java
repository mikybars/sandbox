...
public class IcmListavaloresbasemanBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the icmListavaloresbasemanRecordSet property.
     *
     * <p>
     ...
     * {@link IcmListavaloresbasemanRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        final IcmListavaloresbasemanBlock that = ((IcmListavaloresbasemanBlock) object);
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "idestructurabase", lhsIdestructurabase), LocatorUtils.property(thatLocator, "idestructurabase", rhsIdestructurabase), lhsIdestructurabase, rhsIdestructurabase, (this.idestructurabase!= null), (that.idestructurabase!= null))) {
                return false;
            }
        }
        {
            List<IcmListavaloresbasemanRecord> lhsIcmListavaloresbasemanRecordSet;
            lhsIcmListavaloresbasemanRecordSet = (((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty()))?this.getIcmListavaloresbasemanRecordSet():null);
            List<IcmListavaloresbasemanRecord> rhsIcmListavaloresbasemanRecordSet;
            rhsIcmListavaloresbasemanRecordSet = (((that.icmListavaloresbasemanRecordSet!= null)&&(!that.icmListavaloresbasemanRecordSet.isEmpty()))?that.getIcmListavaloresbasemanRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmListavaloresbasemanRecordSet", lhsIcmListavaloresbasemanRecordSet), LocatorUtils.property(thatLocator, "icmListavaloresbasemanRecordSet", rhsIcmListavaloresbasemanRecordSet), lhsIcmListavaloresbasemanRecordSet, rhsIcmListavaloresbasemanRecordSet, ((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty())), ((that.icmListavaloresbasemanRecordSet!= null)&&(!that.icmListavaloresbasemanRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmListavaloresbasemanRecordSet = (((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty()))?this.getIcmListavaloresbasemanRecordSet():null);
            strategy.appendField(locator, this, "icmListavaloresbasemanRecordSet", buffer, theIcmListavaloresbasemanRecordSet, ((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        int currentHashCode = 1;
        {
            String theIdestructurabase;
            theIdestructurabase = this.getIdestructurabase();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "idestructurabase", theIdestructurabase), currentHashCode, theIdestructurabase, (this.idestructurabase!= null));
        }
        {
            List<IcmListavaloresbasemanRecord> theIcmListavaloresbasemanRecordSet;
            theIcmListavaloresbasemanRecordSet = (((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty()))?this.getIcmListavaloresbasemanRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmListavaloresbasemanRecordSet", theIcmListavaloresbasemanRecordSet), currentHashCode, theIcmListavaloresbasemanRecordSet, ((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty())));
        }
        ...
        if (draftCopy instanceof IcmListavaloresbasemanBlock) {
            final IcmListavaloresbasemanBlock copy = ((IcmListavaloresbasemanBlock) draftCopy);
            {
                ...
                if (idestructurabaseShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    String copyIdestructurabase = ((String) strategy.copy(LocatorUtils.property(locator, "idestructurabase", sourceIdestructurabase), sourceIdestructurabase, (this.idestructurabase!= null)));
            ...
            {
                Boolean icmListavaloresbasemanRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty())));
                if (icmListavaloresbasemanRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmListavaloresbasemanRecordSet = (((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty()))?this.getIcmListavaloresbasemanRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmListavaloresbasemanRecord> copyIcmListavaloresbasemanRecordSet = ((List<IcmListavaloresbasemanRecord> ) strategy.copy(LocatorUtils.property(locator, "icmListavaloresbasemanRecordSet", sourceIcmListavaloresbasemanRecordSet), sourceIcmListavaloresbasemanRecordSet, ((this.icmListavaloresbasemanRecordSet!= null)&&(!this.icmListavaloresbasemanRecordSet.isEmpty()))));
