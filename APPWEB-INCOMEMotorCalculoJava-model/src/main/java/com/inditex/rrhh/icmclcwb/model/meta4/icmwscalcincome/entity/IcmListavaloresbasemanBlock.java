...
/**
 * <p>
 * Clase Java para Icm_ListavaloresbasemanBlock complex type.
 *
 * <p>
...
public class IcmListavaloresbasemanBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
     ...
     * there is not a <CODE>set</CODE> method for the icmListavaloresbasemanRecordSet property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link IcmListavaloresbasemanRecord }
     *
     *
     */
            ...
            }
            {
                ...
                if (icmListavaloresbasemanRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmListavaloresbasemanRecordSet = (((this.icmListavaloresbasemanRecordSet != null)
                            && (!this.icmListavaloresbasemanRecordSet.isEmpty()))
                                    ? this.getIcmListavaloresbasemanRecordSet() : null);
