...
@Component("condicionesHistoricoChallengeIncluidoPorcentajeV1")
@Validated
public class RunTareaValidarCondicionesHistoricoChallengeIncluidoPorcentajeServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NotNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesHistoricoChallengeIncluidoPorcentajeService
