...
public class RunAjusteAntiguedadProcesar implements RunAjuste {
    ...
    public void execute(RunTareaDto runTarea, AlgoritmoAjusteDto algoritmoAjuste) {
        Flux.fromIterable(StreamUtils.partition(
            ...
            .map(personas -> {
                ...
                try {
                    tareaCalculoAjusteAntiguedadRepositoryCustom.ajustar(algoritmoAjuste, runTarea.getTarea(),
                            personas);
                } catch (Exception e) {
    ...
    public String getSqlCalcular(AlgoritmoAjusteDto algoritmoAjuste) {
        return tareaCalculoAjusteAntiguedadRepositoryCustom.getSqlAjustar(algoritmoAjuste);
    }
