...
@Component("externosM4V1")
@Validated
public class RunTareaValidarExternosMeta4ServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarExternosMeta4Service.execute(runTarea, item, tareaFaseAccion))
