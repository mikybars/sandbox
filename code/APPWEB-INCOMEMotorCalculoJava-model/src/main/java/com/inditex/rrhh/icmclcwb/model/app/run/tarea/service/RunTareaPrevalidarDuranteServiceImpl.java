...
@Service
@Validated
public class RunTareaPrevalidarDuranteServiceImpl extends AbstractRunTareaPrevalidar implements RunTareaPrevalidarDuranteService {
  ...
  public void run(@NonNull @Valid final RunTareaDto runTareaDto,
      ...
      @NonNull @Valid final AccionDto accionDto) {
    ...
    final List<ValidacionDto> fallidas = validaciones.stream()
        ...
        .sorted(Comparator.comparingInt(ValidacionDto::getReaccionPeso)
            .reversed())
        .map(e -> {
          this.actualizaFechas(runTareaDto, faseDto, e);
          return e;
        })
