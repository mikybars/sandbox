...
public class DirectoVentaPorcentajeDesplazamientoBaseV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private final TareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom tareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom;
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      try {
        final CompletableFuture<Void> cfCalc = this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom
            .calcular(algoritmo,
  ...
  public String getSqlCalcular(final AlgoritmoDTO algoritmo) {
    return this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom
