...
public class ResaltaManualV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private final TareaCalculoAlgoritmoResaltaManualV1RepositoryCustom tareaCalculoAlgoritmoResaltaManualV1RepositoryCustom;
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea,
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      try {
        final CompletableFuture<Void> cfCalc = this.tareaCalculoAlgoritmoResaltaManualV1RepositoryCustom
            .calcular(
                algoritmo,
