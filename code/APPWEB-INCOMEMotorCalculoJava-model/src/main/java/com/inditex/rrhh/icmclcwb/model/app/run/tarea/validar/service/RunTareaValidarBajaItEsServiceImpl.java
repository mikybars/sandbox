...
@Component("validarBajaItEsV1")
@Validated
public class RunTareaValidarBajaItEsServiceImpl implements RunPrevalidar {

  @Autowired
  private TareaFaseAccionService tareaFaseAccionService;

  @Autowired
  private RunTareaAmbitoValidarBajaItEsService runTareaAmbitoValidarBajaItEsService;
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NotNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarBajaItEsService
