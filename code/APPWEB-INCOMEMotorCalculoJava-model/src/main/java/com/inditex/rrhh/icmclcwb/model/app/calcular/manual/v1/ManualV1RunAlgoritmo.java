...
public class ManualV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private final TareaCalculoAlgoritmoManualV1RepositoryCustom tareaCalculoAlgoritmoManualV1RepositoryCustom;
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      try {
        final CompletableFuture<Void> cfCalc = this.tareaCalculoAlgoritmoManualV1RepositoryCustom
            .calcular(algoritmo,
  ...
  public String getSqlCalcular(final AlgoritmoDTO algoritmo) {
    return this.tareaCalculoAlgoritmoManualV1RepositoryCustom.getSqlCalcular(algoritmo);
  }
