...
@Component("externosBosniaV1")
@Validated
public class RunTareaValidarExternosBosniaServiceImpl implements RunPrevalidar {

  @Autowired
  private TareaFaseAccionService tareaFaseAccionService;

  @Autowired
  private RunTareaAmbitoValidarExternosBosniaService runTareaAmbitoValidarExternosBosniaService;
  ...
  public CompletableFuture<List<ValidacionDto>> execute(
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarExternosBosniaService.execute(runTarea, item, tareaFaseAccion))
