...
@Component("condicionesDesplazamientoEsV1")
@Validated
public class RunTareaValidarCondicionesDesplazamientoEsServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NotNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesDesplazamientoEsService
