...
@Component("condicionesHistoricoSinChallengeV1")
@Validated
public class RunTareaValidarCondicionesHistoricoSinChallengeServiceImpl implements RunPrevalidar {

  @Autowired
  private TareaFaseAccionService tareaFaseAccionService;

  @Autowired
  private RunTareaAmbitoValidarCondicionesHistoricoSinChallengeService runTareaAmbitoValidarCondicionesHistoricoSinChallengeService;
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NotNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesHistoricoSinChallengeService
