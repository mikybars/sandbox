...
public class IcmParamcalcadenaBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    final IcmParamcalcadenaBlock that = ((IcmParamcalcadenaBlock) object);
    {
      ...
      lhsIcmParamcalcadenaRecordSet = (((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty()))
          ? this.getIcmParamcalcadenaRecordSet()
          : null);
      List<IcmParamcalcadenaRecord> rhsIcmParamcalcadenaRecordSet;
      rhsIcmParamcalcadenaRecordSet = (((that.icmParamcalcadenaRecordSet != null) && (!that.icmParamcalcadenaRecordSet.isEmpty()))
          ? that.getIcmParamcalcadenaRecordSet()
          : null);
      if (!strategy.equals(LocatorUtils.property(thisLocator, "icmParamcalcadenaRecordSet", lhsIcmParamcalcadenaRecordSet),
          LocatorUtils.property(thatLocator, "icmParamcalcadenaRecordSet", rhsIcmParamcalcadenaRecordSet), lhsIcmParamcalcadenaRecordSet,
          rhsIcmParamcalcadenaRecordSet, ((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty())),
  ...
  public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
    {
      ...
      theIcmParamcalcadenaRecordSet = (((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty()))
          ? this.getIcmParamcalcadenaRecordSet()
          : null);
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
    int currentHashCode = 1;
    {
      ...
      theIcmParamcalcadenaRecordSet = (((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty()))
          ...
          : null);
      currentHashCode =
          strategy.hashCode(LocatorUtils.property(locator, "icmParamcalcadenaRecordSet", theIcmParamcalcadenaRecordSet), currentHashCode,
              theIcmParamcalcadenaRecordSet, ((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty())));
    }
    ...
    if (draftCopy instanceof IcmParamcalcadenaBlock) {
      final IcmParamcalcadenaBlock copy = ((IcmParamcalcadenaBlock) draftCopy);
      {
        ...
        if (icmParamcalcadenaRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          sourceIcmParamcalcadenaRecordSet = (((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty()))
              ? this.getIcmParamcalcadenaRecordSet()
              : null);
          @SuppressWarnings("unchecked")
          List<IcmParamcalcadenaRecord> copyIcmParamcalcadenaRecordSet = ((List<IcmParamcalcadenaRecord>) strategy.copy(
              LocatorUtils.property(locator, "icmParamcalcadenaRecordSet", sourceIcmParamcalcadenaRecordSet),
              sourceIcmParamcalcadenaRecordSet,
              ((this.icmParamcalcadenaRecordSet != null) && (!this.icmParamcalcadenaRecordSet.isEmpty()))));
