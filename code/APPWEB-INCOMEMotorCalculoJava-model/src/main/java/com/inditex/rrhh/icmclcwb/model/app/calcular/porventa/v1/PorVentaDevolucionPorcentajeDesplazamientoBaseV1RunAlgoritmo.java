...
public class PorVentaDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(PorVentaDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo.class);

  private final RunAlgoritmoPropertiesDto runAlgoritmoProperties;

  private final TareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom tareaCalculoAlgoritmoPorVentaDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom;
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
    PorVentaDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo.LOG.info(
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      try {
        ...
        PorVentaDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo.LOG.error(
