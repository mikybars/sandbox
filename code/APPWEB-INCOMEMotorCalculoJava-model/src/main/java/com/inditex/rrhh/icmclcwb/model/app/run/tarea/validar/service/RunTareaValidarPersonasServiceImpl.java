...
@Component("personasV1")
@Validated
public class RunTareaValidarPersonasServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(
    ...
    final List<ValidacionDto> validaciones = tarea.getAmbito().stream()
        ...
        .map(item -> this.runTareaAmbitoValidarPersonasService.execute(runTarea, item, tareaFaseAccion))
