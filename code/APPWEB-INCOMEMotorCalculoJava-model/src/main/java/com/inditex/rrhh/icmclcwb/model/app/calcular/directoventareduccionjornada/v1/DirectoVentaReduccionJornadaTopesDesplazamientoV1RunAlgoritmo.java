...
public class DirectoVentaReduccionJornadaTopesDesplazamientoV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(DirectoVentaReduccionJornadaTopesDesplazamientoV1RunAlgoritmo.class);
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
    DirectoVentaReduccionJornadaTopesDesplazamientoV1RunAlgoritmo.LOG.warn(ErrorConstants.RUN_ALWORITMO_NOT_IMPLEMENTED_WARNING, algoritmo);
