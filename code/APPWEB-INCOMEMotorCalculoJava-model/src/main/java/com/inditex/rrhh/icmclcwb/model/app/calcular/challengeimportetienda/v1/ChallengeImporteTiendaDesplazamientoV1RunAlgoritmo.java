...
public class ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo.class);

  private final RunAlgoritmoPropertiesDto runAlgoritmoProperties;

  private final TareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustom tareaCalculoAlgoritmoChallengeImporteTiendaDesplazamientoV1RepositoryCustom;
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
    ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo.LOG.info(
        "Trabajo[{}]Tarea[{}] :: Inicio :: ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo :: Ids",
    ...
    ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo.LOG.info(
        "Trabajo[{}]Tarea[{}] :: Fin :: ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo :: Ids: {}",
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      try {
        ...
        ChallengeImporteTiendaDesplazamientoV1RunAlgoritmo.LOG.error(
