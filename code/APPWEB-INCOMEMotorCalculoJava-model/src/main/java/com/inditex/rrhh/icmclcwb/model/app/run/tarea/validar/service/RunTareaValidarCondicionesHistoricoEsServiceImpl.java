...
@Component("condicionesHistoricoEsV1")
@Validated
public class RunTareaValidarCondicionesHistoricoEsServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NonNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesHistoricoEsService
