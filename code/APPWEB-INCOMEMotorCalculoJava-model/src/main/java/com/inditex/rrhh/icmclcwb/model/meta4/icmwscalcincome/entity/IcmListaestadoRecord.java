...
/**
 * <p>Java class for Icm_ListaestadoRecord complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="Icm_ListaestadoRecord"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "Icm_ListaestadoRecord", propOrder = {
...
public class IcmListaestadoRecord implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    final IcmListaestadoRecord that = ((IcmListaestadoRecord) object);
    {
    ...
    }
    {
      ...
      if (!strategy.equals(LocatorUtils.property(thisLocator, "numdias", lhsNumdias),
          LocatorUtils.property(thatLocator, "numdias", rhsNumdias), lhsNumdias, rhsNumdias, (this.numdias != null),
          (that.numdias != null))) {
        return false;
      }
    }
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
    ...
    }
    {
      ...
      theNumdias = this.getNumdias();
      currentHashCode =
          strategy.hashCode(LocatorUtils.property(locator, "numdias", theNumdias), currentHashCode, theNumdias, (this.numdias != null));
    }
    {
      String theFechafin;
      theFechafin = this.getFechafin();
  ...
  public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
    ...
    if (draftCopy instanceof IcmListaestadoRecord) {
      final IcmListaestadoRecord copy = ((IcmListaestadoRecord) draftCopy);
      {
      ...
      }
      {
        ...
        if (numdiasShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          String copyNumdias =
              ((String) strategy.copy(LocatorUtils.property(locator, "numdias", sourceNumdias), sourceNumdias, (this.numdias != null)));
