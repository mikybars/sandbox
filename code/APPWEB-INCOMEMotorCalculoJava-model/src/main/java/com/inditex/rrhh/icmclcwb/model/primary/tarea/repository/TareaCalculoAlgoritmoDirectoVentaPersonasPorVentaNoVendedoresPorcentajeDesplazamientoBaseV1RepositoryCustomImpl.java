...
@Repository
public class TareaCalculoAlgoritmoDirectoVentaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustomImpl
    extends AbstractTareaCalculoAlgoritmoDirectoVentaRepositoryCustom
    implements TareaCalculoAlgoritmoDirectoVentaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom {

  @Value("#{calculoPrimaryQuery['TareaCalculoAlgoritmoBaseRepository.calcular.insert']} "
      + "#{calculoPrimaryQuery['TareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoBaseV1Repository.calcular']} "
  ...
  @Value("#{calculoPrimaryQuery['TareaCalculoAlgoritmoDirectoVentaVentaOnlinePorcentajeDesplazamientoBaseV1Repository.calcular']} "
      + "#{calculoPrimaryQuery['TareaCalculoAlgoritmoBaseRepository.calcular.where']} "
      + "#{calculoPrimaryQuery['PersonasPorVentaNoVendedores.calcular.where']}")
  @Getter
  ...
  protected Map<String, Object> getMapValues(final AlgoritmoDTO algoritmo,
    ...
    map.put(SqlPrimaryConstants.SQL_PARAM_ID_TIPO_CALCULO, TipoCalculoEnum.DIRECTO_SOBRE_VENTA.getId());
    return map;
  }
}
