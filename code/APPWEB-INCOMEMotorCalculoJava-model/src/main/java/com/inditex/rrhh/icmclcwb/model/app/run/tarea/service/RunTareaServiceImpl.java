...
public class RunTareaServiceImpl implements RunTareaService {
  ...
  public void run(@NotNull @Valid final RunTareaDto runTarea) {
    try {
      ...
      final List<TareaMigrarComisionDto> deleteMigracion =
          this.tareaMigrarService.deleteCalculoComisionByTareaActual(runTarea, runTarea.getTarea().getAmbito().get(0));
