...
@Component("condicionesDesplazamientoChallengeIncluidoPorcentajeV1")
@Validated
public class RunTareaValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NotNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeService
