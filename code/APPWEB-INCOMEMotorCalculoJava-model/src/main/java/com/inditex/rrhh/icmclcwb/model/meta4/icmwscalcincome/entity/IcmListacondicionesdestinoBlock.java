...
/**
 * <p>Java class for Icm_ListacondicionesdestinoBlock complex type.
 *
...
public class IcmListacondicionesdestinoBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the icmListacondicionesdestinoRecordSet
   * property.
   *
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link IcmListacondicionesdestinoRecord }
   *
   *
   */
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    }
    {
      ...
      lhsIcmListacondicionesdestinoRecordSet =
          (((this.icmListacondicionesdestinoRecordSet != null) && (!this.icmListacondicionesdestinoRecordSet.isEmpty()))
              ? this.getIcmListacondicionesdestinoRecordSet()
              : null);
      List<IcmListacondicionesdestinoRecord> rhsIcmListacondicionesdestinoRecordSet;
      rhsIcmListacondicionesdestinoRecordSet =
          (((that.icmListacondicionesdestinoRecordSet != null) && (!that.icmListacondicionesdestinoRecordSet.isEmpty()))
              ? that.getIcmListacondicionesdestinoRecordSet()
              : null);
      if (!strategy.equals(
          LocatorUtils.property(thisLocator, "icmListacondicionesdestinoRecordSet", lhsIcmListacondicionesdestinoRecordSet),
          LocatorUtils.property(thatLocator, "icmListacondicionesdestinoRecordSet", rhsIcmListacondicionesdestinoRecordSet),
    ...
    }
    {
      ...
      theIcmListacondicionesdestinoRecordSet =
          (((this.icmListacondicionesdestinoRecordSet != null) && (!this.icmListacondicionesdestinoRecordSet.isEmpty()))
              ? this.getIcmListacondicionesdestinoRecordSet()
              : null);
      strategy.appendField(locator, this, "icmListacondicionesdestinoRecordSet", buffer, theIcmListacondicionesdestinoRecordSet,
          ((this.icmListacondicionesdestinoRecordSet != null) && (!this.icmListacondicionesdestinoRecordSet.isEmpty())));
    }
    return buffer;
  }
    ...
    }
    {
      ...
      theIcmListacondicionesdestinoRecordSet =
          (((this.icmListacondicionesdestinoRecordSet != null) && (!this.icmListacondicionesdestinoRecordSet.isEmpty()))
              ...
              : null);
      currentHashCode =
          strategy.hashCode(LocatorUtils.property(locator, "icmListacondicionesdestinoRecordSet", theIcmListacondicionesdestinoRecordSet),
    ...
    if (draftCopy instanceof IcmListacondicionesdestinoBlock) {
      ...
      }
      {
        ...
        if (icmListacondicionesdestinoRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          sourceIcmListacondicionesdestinoRecordSet =
              (((this.icmListacondicionesdestinoRecordSet != null) && (!this.icmListacondicionesdestinoRecordSet.isEmpty()))
                  ? this.getIcmListacondicionesdestinoRecordSet()
                  : null);
          @SuppressWarnings("unchecked")
          List<IcmListacondicionesdestinoRecord> copyIcmListacondicionesdestinoRecordSet =
              ((List<IcmListacondicionesdestinoRecord>) strategy.copy(
                  LocatorUtils.property(locator, "icmListacondicionesdestinoRecordSet", sourceIcmListacondicionesdestinoRecordSet),
                  sourceIcmListacondicionesdestinoRecordSet,
                  ((this.icmListacondicionesdestinoRecordSet != null) && (!this.icmListacondicionesdestinoRecordSet.isEmpty()))));
          copy.icmListacondicionesdestinoRecordSet = null;
          if (copyIcmListacondicionesdestinoRecordSet != null) {
            List<IcmListacondicionesdestinoRecord> uniqueIcmListacondicionesdestinoRecordSetl =
                copy.getIcmListacondicionesdestinoRecordSet();
