...
public class GETTIENDASONLINEResponse implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
  ...
  /**
   * Gets the value of the gettiendasonlineReturn property.
   *
  ...
  /**
   * Sets the value of the gettiendasonlineReturn property.
   *
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    final GETTIENDASONLINEResponse that = ((GETTIENDASONLINEResponse) object);
    {
      ...
      if (!strategy.equals(LocatorUtils.property(thisLocator, "gettiendasonlineReturn", lhsGETTIENDASONLINEReturn),
          LocatorUtils.property(thatLocator, "gettiendasonlineReturn", rhsGETTIENDASONLINEReturn), lhsGETTIENDASONLINEReturn,
          rhsGETTIENDASONLINEReturn, (this.gettiendasonlineReturn != null), (that.gettiendasonlineReturn != null))) {
        return false;
      }
    }
    return true;
  ...
  public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
    int currentHashCode = 1;
    {
      GettiendasonlineOutput theGETTIENDASONLINEReturn;
      theGETTIENDASONLINEReturn = this.getGETTIENDASONLINEReturn();
      currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "gettiendasonlineReturn", theGETTIENDASONLINEReturn),
      ...
      final GETTIENDASONLINEResponse copy = ((GETTIENDASONLINEResponse) draftCopy);
      {
        ...
        if (gettiendasonlineReturnShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          GettiendasonlineOutput copyGETTIENDASONLINEReturn = ((GettiendasonlineOutput) strategy.copy(
              LocatorUtils.property(locator, "gettiendasonlineReturn", sourceGETTIENDASONLINEReturn), sourceGETTIENDASONLINEReturn,
              (this.gettiendasonlineReturn != null)));
