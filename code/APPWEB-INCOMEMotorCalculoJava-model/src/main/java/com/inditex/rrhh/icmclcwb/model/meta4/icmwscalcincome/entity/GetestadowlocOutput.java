...
/**
 * <p>Java class for GetestadowlocOutput complex type.
 *
...
public class GetestadowlocOutput implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmListaestado", lhsIcmListaestado), LocatorUtils.property(thatLocator, "icmListaestado", rhsIcmListaestado), lhsIcmListaestado, rhsIcmListaestado, (this.icmListaestado!= null), (that.icmListaestado!= null))) {
                return false;
            }
        }
        {
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            IcmListaestadoBlock theIcmListaestado;
            theIcmListaestado = this.getIcmListaestado();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmListaestado", theIcmListaestado), currentHashCode, theIcmListaestado, (this.icmListaestado!= null));
        }
        {
            IcmParametrospaginacionBlock theIcmParametrospaginacion;
            theIcmParametrospaginacion = this.getIcmParametrospaginacion();
        ...
        if (draftCopy instanceof GetestadowlocOutput) {
            ...
            }
            {
                ...
                if (icmListaestadoShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    IcmListaestadoBlock copyIcmListaestado = ((IcmListaestadoBlock) strategy.copy(LocatorUtils.property(locator, "icmListaestado", sourceIcmListaestado), sourceIcmListaestado, (this.icmListaestado!= null)));
