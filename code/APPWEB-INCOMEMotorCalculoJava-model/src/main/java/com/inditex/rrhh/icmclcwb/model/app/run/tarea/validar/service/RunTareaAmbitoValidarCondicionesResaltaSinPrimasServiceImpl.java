...
@Service
@Validated
public class RunTareaAmbitoValidarCondicionesResaltaSinPrimasServiceImpl
    implements RunTareaAmbitoValidarCondicionesResaltaSinPrimasService {
  ...
  public ValidacionDto execute(@Valid final RunTareaDto runTareaDto,
    ...
    try {
      final CompletableFuture<List<IdPersonaLocalCondicionesDto>> cfCondicionesResalta = this.comisAsyncService
          .findCondicionesResaltaSinPrimas(runTareaDto, tareaAmbito);
