...
public class DirectoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo implements RunAlgoritmo {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(DirectoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo.class);

  private final RunAlgoritmoPropertiesDto runAlgoritmoProperties;

  private final TareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeDiariaV1RepositoryCustom tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeDiariaV1RepositoryCustom;
  ...
  public CompletableFuture<Void> execute(final RunTareaDto runTarea, final AlgoritmoDTO algoritmo) {
    DirectoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo.LOG.info(
    ...
    for (final List<IdPersonaLocalDto> personas : StreamUtils.partition(
      ...
      try {
        ...
        DirectoVentaReduccionJornadaPorcentajeDiariaV1RunAlgoritmo.LOG.error(
