 ...
 *         &lt;element name="ai_sRole" type="{http://www.w3.org/2001/XMLSchema}string"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class LoginWithRole implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
  ...
  public boolean equals(final ObjectLocator thisLocator, final ObjectLocator thatLocator, final Object object,
    ...
    }
    {
      ...
      return strategy.equals(LocatorUtils.property(thisLocator, "aiSRole", lhsAiSRole),
          LocatorUtils.property(thatLocator, "aiSRole", rhsAiSRole), lhsAiSRole, rhsAiSRole, (this.aiSRole != null),
          (that.aiSRole != null));
    }
  }
  ...
  public int hashCode(final ObjectLocator locator, final HashCodeStrategy2 strategy) {
    ...
    }
    {
      ...
      theAiSRole = this.getAiSRole();
      currentHashCode =
          strategy.hashCode(LocatorUtils.property(locator, "aiSRole", theAiSRole), currentHashCode, theAiSRole, (this.aiSRole != null));
    }
  ...
  public Object copyTo(final ObjectLocator locator, final Object target, final CopyStrategy2 strategy) {
    ...
    if (draftCopy instanceof LoginWithRole copy) {
      {
      ...
      }
      {
        ...
        if (aiSRoleShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          final String copyAiSRole =
              ((String) strategy.copy(LocatorUtils.property(locator, "aiSRole", sourceAiSRole), sourceAiSRole, (this.aiSRole != null)));
          copy.setAiSRole(copyAiSRole);
        } else {
          if (aiSRoleShouldBeCopiedAndSet == Boolean.FALSE) {
            copy.aiSRole = null;
          }
        }
      }
