...
@Component("personasEsV1")
@Validated
public class RunTareaValidarPersonasEsServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(
    ...
    final List<ValidacionDto> validaciones = tarea.getAmbito().stream()
        ...
        .map(item -> this.runTareaAmbitoValidarPersonasEsService.execute(runTarea, item, tareaFaseAccion))
