...
public class IcmParamcalcatalogoBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the icmParamcalcatalogoRecordSet property.
     *
     * <p>
     ...
     * {@link IcmParamcalcatalogoRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            lhsIcmParamcalcatalogoRecordSet = (((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty()))?this.getIcmParamcalcatalogoRecordSet():null);
            List<IcmParamcalcatalogoRecord> rhsIcmParamcalcatalogoRecordSet;
            rhsIcmParamcalcatalogoRecordSet = (((that.icmParamcalcatalogoRecordSet!= null)&&(!that.icmParamcalcatalogoRecordSet.isEmpty()))?that.getIcmParamcalcatalogoRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmParamcalcatalogoRecordSet", lhsIcmParamcalcatalogoRecordSet), LocatorUtils.property(thatLocator, "icmParamcalcatalogoRecordSet", rhsIcmParamcalcatalogoRecordSet), lhsIcmParamcalcatalogoRecordSet, rhsIcmParamcalcatalogoRecordSet, ((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty())), ((that.icmParamcalcatalogoRecordSet!= null)&&(!that.icmParamcalcatalogoRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmParamcalcatalogoRecordSet = (((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty()))?this.getIcmParamcalcatalogoRecordSet():null);
            strategy.appendField(locator, this, "icmParamcalcatalogoRecordSet", buffer, theIcmParamcalcatalogoRecordSet, ((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmParamcalcatalogoRecord> theIcmParamcalcatalogoRecordSet;
            theIcmParamcalcatalogoRecordSet = (((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty()))?this.getIcmParamcalcatalogoRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmParamcalcatalogoRecordSet", theIcmParamcalcatalogoRecordSet), currentHashCode, theIcmParamcalcatalogoRecordSet, ((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmParamcalcatalogoBlock) {
            ...
            {
                Boolean icmParamcalcatalogoRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty())));
                if (icmParamcalcatalogoRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmParamcalcatalogoRecordSet = (((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty()))?this.getIcmParamcalcatalogoRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmParamcalcatalogoRecord> copyIcmParamcalcatalogoRecordSet = ((List<IcmParamcalcatalogoRecord> ) strategy.copy(LocatorUtils.property(locator, "icmParamcalcatalogoRecordSet", sourceIcmParamcalcatalogoRecordSet), sourceIcmParamcalcatalogoRecordSet, ((this.icmParamcalcatalogoRecordSet!= null)&&(!this.icmParamcalcatalogoRecordSet.isEmpty()))));
