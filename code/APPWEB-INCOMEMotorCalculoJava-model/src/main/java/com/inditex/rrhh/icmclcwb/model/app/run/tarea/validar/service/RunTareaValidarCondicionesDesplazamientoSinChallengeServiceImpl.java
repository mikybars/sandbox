...
@Component("condicionesDesplazamientoSinChallengeV1")
@Validated
public class RunTareaValidarCondicionesDesplazamientoSinChallengeServiceImpl implements RunPrevalidar {
  ...
  public CompletableFuture<List<ValidacionDto>> execute(@NonNull @Valid final RunTareaDto runTarea,
    ...
    final List<ValidacionDto> validaciones = runTarea.getTarea()
        ...
        .map(item -> this.runTareaAmbitoValidarCondicionesDesplazamientoSinChallengeService
