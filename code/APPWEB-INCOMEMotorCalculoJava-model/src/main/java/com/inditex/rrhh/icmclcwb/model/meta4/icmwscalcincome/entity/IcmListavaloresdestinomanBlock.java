...
/**
 * <p>Java class for Icm_ListavaloresdestinomanBlock complex type.
 *
...
public class IcmListavaloresdestinomanBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2
{
     ...
     * This is why there is not a <CODE>set</CODE> method for the icmListavaloresdestinomanRecordSet property.
     *
     * <p>
     ...
     * {@link IcmListavaloresdestinomanRecord }
     *
     *
     */
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
        ...
        }
        {
            ...
            lhsIcmListavaloresdestinomanRecordSet = (((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty()))?this.getIcmListavaloresdestinomanRecordSet():null);
            List<IcmListavaloresdestinomanRecord> rhsIcmListavaloresdestinomanRecordSet;
            rhsIcmListavaloresdestinomanRecordSet = (((that.icmListavaloresdestinomanRecordSet!= null)&&(!that.icmListavaloresdestinomanRecordSet.isEmpty()))?that.getIcmListavaloresdestinomanRecordSet():null);
            if (!strategy.equals(LocatorUtils.property(thisLocator, "icmListavaloresdestinomanRecordSet", lhsIcmListavaloresdestinomanRecordSet), LocatorUtils.property(thatLocator, "icmListavaloresdestinomanRecordSet", rhsIcmListavaloresdestinomanRecordSet), lhsIcmListavaloresdestinomanRecordSet, rhsIcmListavaloresdestinomanRecordSet, ((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty())), ((that.icmListavaloresdestinomanRecordSet!= null)&&(!that.icmListavaloresdestinomanRecordSet.isEmpty())))) {
                return false;
            }
        }
        return true;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy2 strategy) {
        ...
        }
        {
            ...
            theIcmListavaloresdestinomanRecordSet = (((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty()))?this.getIcmListavaloresdestinomanRecordSet():null);
            strategy.appendField(locator, this, "icmListavaloresdestinomanRecordSet", buffer, theIcmListavaloresdestinomanRecordSet, ((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty())));
        }
        return buffer;
    }
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy2 strategy) {
        ...
        }
        {
            List<IcmListavaloresdestinomanRecord> theIcmListavaloresdestinomanRecordSet;
            theIcmListavaloresdestinomanRecordSet = (((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty()))?this.getIcmListavaloresdestinomanRecordSet():null);
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "icmListavaloresdestinomanRecordSet", theIcmListavaloresdestinomanRecordSet), currentHashCode, theIcmListavaloresdestinomanRecordSet, ((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty())));
        }
    ...
    public Object copyTo(ObjectLocator locator, Object target, CopyStrategy2 strategy) {
        ...
        if (draftCopy instanceof IcmListavaloresdestinomanBlock) {
            ...
            {
                Boolean icmListavaloresdestinomanRecordSetShouldBeCopiedAndSet = strategy.shouldBeCopiedAndSet(locator, ((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty())));
                if (icmListavaloresdestinomanRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
                    ...
                    sourceIcmListavaloresdestinomanRecordSet = (((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty()))?this.getIcmListavaloresdestinomanRecordSet():null);
                    @SuppressWarnings("unchecked")
                    List<IcmListavaloresdestinomanRecord> copyIcmListavaloresdestinomanRecordSet = ((List<IcmListavaloresdestinomanRecord> ) strategy.copy(LocatorUtils.property(locator, "icmListavaloresdestinomanRecordSet", sourceIcmListavaloresdestinomanRecordSet), sourceIcmListavaloresdestinomanRecordSet, ((this.icmListavaloresdestinomanRecordSet!= null)&&(!this.icmListavaloresdestinomanRecordSet.isEmpty()))));
