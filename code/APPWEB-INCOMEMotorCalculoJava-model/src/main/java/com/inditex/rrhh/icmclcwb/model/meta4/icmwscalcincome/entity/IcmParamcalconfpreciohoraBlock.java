...
/**
 * <p>Java class for Icm_ParamcalconfpreciohoraBlock complex type.
 *
...
public class IcmParamcalconfpreciohoraBlock implements Serializable, Cloneable, CopyTo2, Equals2, HashCode2, ToString2 {
   ...
   * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the icmParamcalconfpreciohoraRecordSet
   * property.
   *
   ...
   *
   *
   * <p> Objects of the following type(s) are allowed in the list {@link IcmParamcalconfpreciohoraRecord }
   *
   *
   */
  ...
  public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy2 strategy) {
    ...
    }
    {
      ...
      lhsIcmParamcalconfpreciohoraRecordSet =
          (((this.icmParamcalconfpreciohoraRecordSet != null) && (!this.icmParamcalconfpreciohoraRecordSet.isEmpty()))
              ? this.getIcmParamcalconfpreciohoraRecordSet()
              : null);
      List<IcmParamcalconfpreciohoraRecord> rhsIcmParamcalconfpreciohoraRecordSet;
      rhsIcmParamcalconfpreciohoraRecordSet =
          (((that.icmParamcalconfpreciohoraRecordSet != null) && (!that.icmParamcalconfpreciohoraRecordSet.isEmpty()))
              ? that.getIcmParamcalconfpreciohoraRecordSet()
              : null);
      if (!strategy.equals(LocatorUtils.property(thisLocator, "icmParamcalconfpreciohoraRecordSet", lhsIcmParamcalconfpreciohoraRecordSet),
          LocatorUtils.property(thatLocator, "icmParamcalconfpreciohoraRecordSet", rhsIcmParamcalconfpreciohoraRecordSet),
    ...
    }
    {
      ...
      theIcmParamcalconfpreciohoraRecordSet =
          (((this.icmParamcalconfpreciohoraRecordSet != null) && (!this.icmParamcalconfpreciohoraRecordSet.isEmpty()))
              ? this.getIcmParamcalconfpreciohoraRecordSet()
              : null);
      strategy.appendField(locator, this, "icmParamcalconfpreciohoraRecordSet", buffer, theIcmParamcalconfpreciohoraRecordSet,
          ((this.icmParamcalconfpreciohoraRecordSet != null) && (!this.icmParamcalconfpreciohoraRecordSet.isEmpty())));
    }
    return buffer;
  }
    ...
    }
    {
      ...
      theIcmParamcalconfpreciohoraRecordSet =
          (((this.icmParamcalconfpreciohoraRecordSet != null) && (!this.icmParamcalconfpreciohoraRecordSet.isEmpty()))
              ...
              : null);
      currentHashCode =
          strategy.hashCode(LocatorUtils.property(locator, "icmParamcalconfpreciohoraRecordSet", theIcmParamcalconfpreciohoraRecordSet),
    ...
    if (draftCopy instanceof IcmParamcalconfpreciohoraBlock) {
      ...
      }
      {
        ...
        if (icmParamcalconfpreciohoraRecordSetShouldBeCopiedAndSet == Boolean.TRUE) {
          ...
          sourceIcmParamcalconfpreciohoraRecordSet =
              (((this.icmParamcalconfpreciohoraRecordSet != null) && (!this.icmParamcalconfpreciohoraRecordSet.isEmpty()))
                  ? this.getIcmParamcalconfpreciohoraRecordSet()
                  : null);
          ...
          List<IcmParamcalconfpreciohoraRecord> copyIcmParamcalconfpreciohoraRecordSet = ((List<IcmParamcalconfpreciohoraRecord>) strategy
              .copy(LocatorUtils.property(locator, "icmParamcalconfpreciohoraRecordSet", sourceIcmParamcalconfpreciohoraRecordSet),
                  sourceIcmParamcalconfpreciohoraRecordSet,
                  ((this.icmParamcalconfpreciohoraRecordSet != null) && (!this.icmParamcalconfpreciohoraRecordSet.isEmpty()))));
