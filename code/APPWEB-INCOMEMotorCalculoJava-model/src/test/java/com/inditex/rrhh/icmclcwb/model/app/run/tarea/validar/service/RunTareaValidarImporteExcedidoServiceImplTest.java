...
class RunTareaValidarImporteExcedidoServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarImporteExcedidoService runTareaAmbitoImporteExcedidoService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarImporteExcedidoServiceImpl runTareaValidarImporteExcedidoService;
  ...
  void executeEmptyValidacionesTest() {
    ...
    doReturn(null).when(this.runTareaAmbitoImporteExcedidoService)
        .execute(runTareaDto, tareaAmbitoDto, tareaFaseAccionDto);

    this.runTareaValidarImporteExcedidoService.execute(runTareaDto, tareaFaseAccionDto);
  ...
  void executeTest() {
    ...
    doReturn(validacion).when(this.runTareaAmbitoImporteExcedidoService)
