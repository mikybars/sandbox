...
public class RunTareaValidarCondicionesDesplazamientoServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesDesplazamientoService runTareaAmbitoValidarCondicionesDesplazamientoService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesDesplazamientoServiceImpl runTareaValidarCondicionesDesplazamientoService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesDesplazamientoService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesDesplazamientoService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesDesplazamientoService, timeout(1000).times(1))
        .execute(
