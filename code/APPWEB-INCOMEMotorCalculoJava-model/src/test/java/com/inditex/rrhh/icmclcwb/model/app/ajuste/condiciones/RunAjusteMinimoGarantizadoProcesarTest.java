...
class RunAjusteMinimoGarantizadoProcesarTest {
  ...
  void getSqlCalcularTest() {
    ...
    this.runAjusteMinimoGarantizadoProcesar.getSqlCalcular(algoritmoAjuste);
    verify(this.tareaCalculoAjusteMinimoGarantizadoRepositoryCustom, times(1)).getSqlAjustar(algoritmoAjuste);
  }
  ...
  void executeIdsPersonaTest() {
    ...
    verify(this.tareaCalculoAjusteMinimoGarantizadoRepositoryCustom, times(1)).ids(runTarea.getTarea());
  }
