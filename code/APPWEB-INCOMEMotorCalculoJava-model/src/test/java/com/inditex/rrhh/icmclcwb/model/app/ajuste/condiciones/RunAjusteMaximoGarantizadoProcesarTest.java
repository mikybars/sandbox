...
class RunAjusteMaximoGarantizadoProcesarTest {
  ...
  public void setup() {
    ...
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(RunAjusteMaximoGarantizadoProcesar.class);
  ...
  void executeLogIdsTareaTrabajoInicioTest() {
    ...
    assertEquals("Fin :: RunAjusteMaximoGarantizadoProcesar :: Personas: {}", this.listAppender.list.get(3).getMessage());
  }
  ...
  void executeExceptionTest() {
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("RunAjusteMaximoGarantizadoProcesar :: KO :: Personas: {}", this.listAppender.list.get(3).getMessage());
