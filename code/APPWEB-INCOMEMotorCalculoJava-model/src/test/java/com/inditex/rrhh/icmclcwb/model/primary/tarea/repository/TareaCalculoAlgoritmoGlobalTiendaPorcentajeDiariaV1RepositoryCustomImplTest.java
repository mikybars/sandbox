...
public class TareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustomImpl tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom,
        "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom.calcular(algoritmo, tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoGlobalTiendaPorcentajeDiariaV1RepositoryCustom
