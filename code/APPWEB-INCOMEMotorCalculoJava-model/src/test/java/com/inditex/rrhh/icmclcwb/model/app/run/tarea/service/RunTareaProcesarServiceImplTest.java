...
class RunTareaProcesarServiceImplTest {
  ...
  void runTest(final TareaFaseDto tareaFaseDto) {
    ...
    doReturn(completableFuture).when(this.runTareaProcesarPresenciaAsyncService)
        .indicadorPresenciaDesplazamientoBaseDesplazamientoMismaLocalizacionChallengePorcentaje(this.runTarea);
    ...
    simulacion.setEsPresenciaEmpleadoUltimoCalculo(Boolean.FALSE);
    simulacion.setEsPresenciaTiendaUltimoCalculo(Boolean.FALSE);
    simulacion.setEsVentaUltimoCalculo(Boolean.FALSE);
  ...
  @ParameterizedTest
  @InstancioSource
  void runTest2(final TareaFaseDto tareaFaseDto) {
    ...
    simulacion.setEsPresenciaEmpleadoUltimoCalculo(Boolean.FALSE);
    simulacion.setEsPresenciaTiendaUltimoCalculo(Boolean.TRUE);
    simulacion.setEsVentaUltimoCalculo(Boolean.TRUE);
