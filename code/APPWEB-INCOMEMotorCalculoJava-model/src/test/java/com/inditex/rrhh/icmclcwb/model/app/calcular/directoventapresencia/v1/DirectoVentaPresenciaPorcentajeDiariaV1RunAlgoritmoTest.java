...
public class DirectoVentaPresenciaPorcentajeDiariaV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @Mock
  private TareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaV1RepositoryCustom tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaV1RepositoryCustom;

  @InjectMocks
  private DirectoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo directoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo;
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);
    assertEquals(SQL_CALCULAR,
        this.directoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDTO()));
  }
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaV1RepositoryCustom.calcular(
    ...
    this.directoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo.execute(runTarea, algoritmo);

    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: DirectoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    verify(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaV1RepositoryCustom,
        times(1))
            .calcular(algoritmo, runTarea.getTarea(), personas);
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaV1RepositoryCustom)
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: DirectoVentaPresenciaPorcentajeDiariaV1RunAlgoritmo :: KO :: Personas: {}",
