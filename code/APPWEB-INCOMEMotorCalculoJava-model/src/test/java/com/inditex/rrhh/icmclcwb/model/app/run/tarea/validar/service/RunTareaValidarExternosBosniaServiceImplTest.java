...
public class RunTareaValidarExternosBosniaServiceImplTest {
  ...
  @Mock
  private RunTareaAmbitoValidarExternosBosniaServiceImpl runTareaAmbitoValidarExternosBosnia;

  @InjectMocks
  private RunTareaValidarExternosBosniaServiceImpl runTareaValidarExternosBosnia;
  ...
  public void executeTest() {
    ...
    when(this.runTareaAmbitoValidarExternosBosnia.execute(any(RunTareaDto.class), any(TareaAmbitoDto.class),
        any(TareaFaseAccionDto.class))).thenReturn(validacion);

    this.runTareaValidarExternosBosnia.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarExternosBosnia, timeout(1000).times(1)).execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);
