...
public class RunTareaValidarCarenciaServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCarenciaService runTareaAmbitoValidarCarenciaService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCarenciaServiceImpl runTareaValidarCarenciaService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCarenciaService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCarenciaService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCarenciaService, timeout(1000).times(1))
        .execute(
