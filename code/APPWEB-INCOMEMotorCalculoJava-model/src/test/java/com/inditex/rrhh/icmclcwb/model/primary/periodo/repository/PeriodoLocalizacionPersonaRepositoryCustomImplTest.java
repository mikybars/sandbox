...
public class PeriodoLocalizacionPersonaRepositoryCustomImplTest {

  @Mock
  private NamedParameterJdbcTemplate namedParameterJdbcTemplate;

  @InjectMocks
  private PeriodoLocalizacionPersonaRepositoryCustomImpl periodoLocalizacionPersonaRepositoryCustom;
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.periodoLocalizacionPersonaRepositoryCustom, "sqlMergePeriodoLocalizacionPersona", "",
        true);
    FieldUtils.writeField(this.periodoLocalizacionPersonaRepositoryCustom, "sqlLimpiezaPeriodoLocalizacionPersona",
        "",
        true);
  }
  ...
  public void mergePeriodoLocalizacionPersonaTest() {
    ...
    this.periodoLocalizacionPersonaRepositoryCustom.mergePeriodoLocalizacionPersona(runTarea);
  ...
  public void limpiezaPeriodoLocalizacionPersonaTest() {
    ...
    this.periodoLocalizacionPersonaRepositoryCustom.limpiezaPeriodoLocalizacionPersona(runTarea, tareaAmbitoDto);
