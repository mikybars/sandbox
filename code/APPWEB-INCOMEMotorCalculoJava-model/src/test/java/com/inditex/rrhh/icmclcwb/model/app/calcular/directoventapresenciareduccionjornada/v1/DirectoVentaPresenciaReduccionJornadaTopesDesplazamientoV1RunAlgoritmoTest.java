...
public class DirectoVentaPresenciaReduccionJornadaTopesDesplazamientoV1RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPresenciaReduccionJornadaTopesDesplazamientoV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.directoVentaPresenciaReduccionJornadaTopesDesplazamientoV1RunAlgoritmo
  ...
  public void executeTest() {
    ...
    this.directoVentaPresenciaReduccionJornadaTopesDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
