...
public class PeriodoLocalizacionRepositoryCustomImplTest {

  @Mock
  private NamedParameterJdbcTemplate namedParameterJdbcTemplate;

  @InjectMocks
  private PeriodoLocalizacionRepositoryCustomImpl periodoLocalizacionRepositoryCustom;
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.periodoLocalizacionRepositoryCustom, "sqlMergePeriodoLocalizacion", "", true);
    FieldUtils.writeField(this.periodoLocalizacionRepositoryCustom, "sqlLimpiezaPeriodoLocalizacion", "", true);
  }
  ...
  public void mergePeriodoLocalizacionPersonaTest() {
    ...
    this.periodoLocalizacionRepositoryCustom.mergePeriodoLocalizacion(runTarea);
  ...
  public void limpiezaPeriodoLocalizacionTest() {
    ...
    this.periodoLocalizacionRepositoryCustom.limpiezaPeriodoLocalizacion(runTarea, tareaAmbitoDto);
