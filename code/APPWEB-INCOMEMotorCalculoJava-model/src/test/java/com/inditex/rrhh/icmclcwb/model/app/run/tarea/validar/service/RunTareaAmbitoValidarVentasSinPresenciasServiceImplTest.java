...
class RunTareaAmbitoValidarVentasSinPresenciasServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarVentasSinPresenciasServiceImpl runTareaAmbitoValidarVentasSinPresenciasServiceImpl;
  ...
  void executeWithResultsTest() {
    ...
    final List<IdLocalizacionLocalDto> tiendasVentasSinPresenciasList = List.of(idLocalizacionLocalDto);
    final ValidacionDto validacionDto = new ValidacionDto();

    when(this.tareaCalculoVentasSinPresenciasService.findTiendaVentasSinPresencias(1L))
        .thenReturn(tiendasVentasSinPresenciasList);
    ...
    this.runTareaAmbitoValidarVentasSinPresenciasServiceImpl.execute(runTareaDto, tareaAmbitoDto, tareaFaseAccionDto);

    verify(this.tareaCalculoVentasSinPresenciasService).findTiendaVentasSinPresencias(1L);
