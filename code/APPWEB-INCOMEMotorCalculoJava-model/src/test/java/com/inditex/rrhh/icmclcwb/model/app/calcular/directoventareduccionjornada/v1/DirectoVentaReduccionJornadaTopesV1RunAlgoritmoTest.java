...
public class DirectoVentaReduccionJornadaTopesV1RunAlgoritmoTest {

  @Mock
  private Logger log;

  @InjectMocks
  DirectoVentaReduccionJornadaTopesV1RunAlgoritmo directoVentaReduccionJornadaTopesV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(DirectoVentaReduccionJornadaTopesV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.directoVentaReduccionJornadaTopesV1RunAlgoritmo.getSqlCalcular(algoritmo);
  ...
  public void executeTest() {
    ...
    this.directoVentaReduccionJornadaTopesV1RunAlgoritmo.execute(runTarea, algoritmo);
