...
public class RunTareaAmbitoValidarCondicionesHistoricoServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesHistoricoServiceImpl runTareaAmbitoValidarCondicionesHistoricoServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesHistorico(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesHistoricoServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);

    verify(this.comisAsyncService, timeout(1000).times(1))
        .findCondicionesHistorico(
