...
public class TareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustomImpl tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom, "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom.ids(
        algoritmo,
        tarea);
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom.calcular(algoritmo, tarea, personas);
    ...
    for (int i = 0; i < values.length; i++) {
      ...
      // incluido challenge porcentaje
      assertTrue(value.hasValue(SQL_PARAM_INCLUIDO_CHALLENGE_PORCENTAJE));
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoChallengePorcentajeV1RepositoryCustom
