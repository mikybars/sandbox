...
public class RunTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaServiceImplTest {

  @Mock
  private ValidacionMapper validacionMapper;

  @Mock
  private TareaCalculoPresenciasMismaFechaDistintaTiendaService tareaCalculoPresenciasMismaFechaDistintaTienda;

  @Mock
  private TareaFaseAccionDatoServiceImpl tareaFaseAccionFallidasService;

  @InjectMocks
  private RunTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaServiceImpl runTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaServiceImpl;
  ...
  void executeWithResultsTest() {
    ...
    final List<IdPersonaLocalDto> personaPresenciasMismaFechaDistintaTienda = List.of(idPersonaLocalDto);
    final ValidacionDto validacionDto = new ValidacionDto();

    when(this.tareaCalculoPresenciasMismaFechaDistintaTienda.findPersonaPresenciasMismaFechaDistintaTienda(1L))
        .thenReturn(personaPresenciasMismaFechaDistintaTienda);
    ...
    this.runTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaServiceImpl.execute(runTareaDto, tareaAmbitoDto, tareaFaseAccionDto);

    verify(this.tareaCalculoPresenciasMismaFechaDistintaTienda).findPersonaPresenciasMismaFechaDistintaTienda(1L);
