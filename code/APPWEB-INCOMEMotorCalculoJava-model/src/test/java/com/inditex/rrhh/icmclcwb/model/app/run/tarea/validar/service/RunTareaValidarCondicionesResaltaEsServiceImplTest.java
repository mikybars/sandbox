...
public class RunTareaValidarCondicionesResaltaEsServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesResaltaEsService runTareaAmbitoValidarCondicionesResaltaEsService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesResaltaEsServiceImpl runTareaValidarCondicionesResaltaEsService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesResaltaEsService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesResaltaEsService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesResaltaEsService, timeout(1000).times(1))
        .execute(
