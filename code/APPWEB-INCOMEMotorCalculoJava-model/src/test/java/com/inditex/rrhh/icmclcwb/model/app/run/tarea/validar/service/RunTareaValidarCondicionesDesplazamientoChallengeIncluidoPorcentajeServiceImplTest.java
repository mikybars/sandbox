...
public class RunTareaValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeService runTareaAmbitoValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeServiceImpl runTareaValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeServiceImpl;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeService.execute(
        ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeServiceImpl.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesDesplazamientoChallengeIncluidoPorcentajeService, timeout(1000).times(1))
        .execute(
