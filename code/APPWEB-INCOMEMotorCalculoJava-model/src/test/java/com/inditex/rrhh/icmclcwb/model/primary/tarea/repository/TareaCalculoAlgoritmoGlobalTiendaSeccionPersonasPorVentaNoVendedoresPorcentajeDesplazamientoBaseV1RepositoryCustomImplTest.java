...
class TareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
  ...
  @Spy
  @InjectMocks
  TareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustomImpl tareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom;
  ...
  void idsTest(@Random(type = IdPersonaLocalDto.class, size = 2) final List<IdPersonaLocalDto> idPersonaLocalDtoList) {
    ...
    final List<IdPersonaLocalDto> result =
        this.tareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom
  ...
  void getSqlCalcularTest() {
    ...
    verify(this.tareaCalculoAlgoritmoGlobalTiendaSeccionPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom,
