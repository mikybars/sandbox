...
import com.inditex.rrhh.icmclcwb.api.app.run.tarea.validar.service.RunTareaAmbitoValidarCondicionesResaltaSinPrimasService;
...
public class RunTareaValidarCondicionesResaltaSinPrimasServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesResaltaSinPrimasService runTareaAmbitoValidarCondicionesResaltaSinPrimasService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesResaltaSinPrimasServiceImpl runTareaValidarCondicionesResaltaSinPrimaService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesResaltaSinPrimasService.execute(
    ...
    this.runTareaValidarCondicionesResaltaSinPrimaService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesResaltaSinPrimasService, timeout(1000).times(1))
        .execute(
