...
public class GlobalTiendaTopesDesplazamientoV1RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(GlobalTiendaTopesDesplazamientoV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.globalTiendaTopesDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
  ...
  public void executeTest() {
    ...
    this.globalTiendaTopesDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
