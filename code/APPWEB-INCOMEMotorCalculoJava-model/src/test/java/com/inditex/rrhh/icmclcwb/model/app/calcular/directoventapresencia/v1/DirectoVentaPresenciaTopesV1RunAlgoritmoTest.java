...
public class DirectoVentaPresenciaTopesV1RunAlgoritmoTest {

  @Mock
  private Logger log;

  @InjectMocks
  DirectoVentaPresenciaTopesV1RunAlgoritmo directoVentaPresenciaTopesV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPresenciaTopesV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.directoVentaPresenciaTopesV1RunAlgoritmo.getSqlCalcular(algoritmo);
  ...
  public void executeTest() {
    ...
    this.directoVentaPresenciaTopesV1RunAlgoritmo.execute(runTarea, algoritmo);
