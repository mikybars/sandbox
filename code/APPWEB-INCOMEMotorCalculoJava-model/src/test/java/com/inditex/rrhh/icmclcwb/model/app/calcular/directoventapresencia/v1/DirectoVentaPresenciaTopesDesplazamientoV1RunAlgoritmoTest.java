...
public class DirectoVentaPresenciaTopesDesplazamientoV1RunAlgoritmoTest {

  @Mock
  private Logger log;

  @InjectMocks
  DirectoVentaPresenciaTopesDesplazamientoV1RunAlgoritmo directoVentaPresenciaTopesDesplazamientoV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPresenciaTopesDesplazamientoV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.directoVentaPresenciaTopesDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
  ...
  public void executeTest() {
    ...
    this.directoVentaPresenciaTopesDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
