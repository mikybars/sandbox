...
class TareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustomImpl tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustom, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustom, "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  void getMapValuesTest(@Random final IdTipoDatoDto tipoDatoVenta1, @Random final IdTipoDatoDto tipoDatoVenta2,
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustom
    ...
    // tipoDatoLocalizacionPersonaPresencia, idTipoCalculo
  ...
  void calcularTest(@Random final IdTipoDatoDto tipoDatoVenta1, @Random final IdTipoDatoDto tipoDatoVenta2,
    ...
    this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustom.calcular(algoritmo, tarea, personas);
  ...
  void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeV1RepositoryCustom
