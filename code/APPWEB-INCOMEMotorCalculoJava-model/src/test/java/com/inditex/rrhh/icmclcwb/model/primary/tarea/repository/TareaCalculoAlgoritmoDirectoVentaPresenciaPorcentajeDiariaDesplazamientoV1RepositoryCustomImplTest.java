...
public class TareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaDesplazamientoV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaDesplazamientoV1RepositoryCustom;
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaDesplazamientoV1RepositoryCustom
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaDesplazamientoV1RepositoryCustom.calcular(
        algoritmo,
        tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeDiariaDesplazamientoV1RepositoryCustom
