...
public class DirectoVentaTopesDesplazamientoV1RunAlgoritmoTest {

  @Mock
  private Logger log;

  @InjectMocks
  DirectoVentaTopesDesplazamientoV1RunAlgoritmo directoVentaTopesDesplazamientoV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaTopesDesplazamientoV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.directoVentaTopesDesplazamientoV1RunAlgoritmo.getSqlCalcular(algoritmo);
  ...
  public void executeTest() {
    ...
    this.directoVentaTopesDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
