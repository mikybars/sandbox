...
public class GlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(GlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);

    final String result = this.globalTiendaSeccionPorcentajeDesplazamientoBaseV1RunAlgoritmo
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustom.calcular(
    ...
    this.globalTiendaSeccionPorcentajeDesplazamientoBaseV1RunAlgoritmo.execute(runTarea, algoritmo);

    verify(this.tareaCalculoAlgoritmoGlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RepositoryCustom,
        times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: GlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: GlobalTiendaSeccionPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}",
