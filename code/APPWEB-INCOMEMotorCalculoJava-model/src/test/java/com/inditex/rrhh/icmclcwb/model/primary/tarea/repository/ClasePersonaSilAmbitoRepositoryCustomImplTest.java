...
class ClasePersonaSilAmbitoRepositoryCustomImplTest {

  private final static String SQL_FIND_CLASE_ESTADO = "SQL FIND CLASE ESTADO";

  @Mock
  private NamedParameterJdbcTemplate namedParameterJdbcTemplate;

  @InjectMocks
  private ClasePersonaSilAmbitoRepositoryCustomImpl clasePersonaSilAmbitoRepositoryCustom;
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.clasePersonaSilAmbitoRepositoryCustom, "sqlFindClaseEstadoByCclIdOrigenAndStdIdLegEnt",
        SQL_FIND_CLASE_ESTADO, true);
  }

  @Test
  void findClaseEstadoByOrigenEmpresaTest() {

    final String cclIdOrigen = "60";
    final String stdIdLegEnt = "179";

    this.clasePersonaSilAmbitoRepositoryCustom.findClaseEstadoByCclIdOrigenAndStdIdLegEnt(cclIdOrigen, stdIdLegEnt);
    ...
    assertEquals(SQL_FIND_CLASE_ESTADO, this.sqlCaptor.getValue());
