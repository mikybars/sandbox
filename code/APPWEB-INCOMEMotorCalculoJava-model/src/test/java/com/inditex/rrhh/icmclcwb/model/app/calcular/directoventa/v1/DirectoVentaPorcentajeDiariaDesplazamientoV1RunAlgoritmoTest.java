...
public class DirectoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @InjectMocks
  private DirectoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo directoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDiariaDesplazamientoV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);

    final String result = this.directoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDiariaDesplazamientoV1RepositoryCustom.calcular(
    ...
    this.directoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);

    verify(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDiariaDesplazamientoV1RepositoryCustom, times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoDirectoVentaPorcentajeDiariaDesplazamientoV1RepositoryCustom)
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPorcentajeDiariaDesplazamientoV1RunAlgoritmo :: Personas: {}",
