...
class TareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustomImpl tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom,
        "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom,
        "sqlCalcularBase",
  ...
  void getMapValuesTest(@Random(type = IdTipoDatoDto.class, size = 2) final List<IdTipoDatoDto> tiposDatoVenta,
    ...
    final Map<String, Object> result =
        this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom
  ...
  void calcularTest(@Random(type = IdTipoDatoDto.class, size = 2) final List<IdTipoDatoDto> tiposDatoVenta,
      @Random(type = IdTipoDatoDto.class, size = 4) final List<IdTipoDatoDto> tiposDatoPresencia, @Random final AlgoritmoDTO algoritmo,
      @Random final TareaDto tarea,
      @Random(type = IdPersonaLocalDto.class, size = 7) final List<IdPersonaLocalDto> personas) {
    ...
    verify(this.tipoDatoService, times(7))
        .findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.PRESENCIA_LOCALIZACION_SECCION_PERSONA_TIPOHORA.getId());
    verify(this.tipoDatoService, times(7)).findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.VENTA_LOCALIZACION_SECCION.getId());
  ...
  void getSqlCalcularTest() {
    ...
    when(tareaDto.getFechaInicioPeriodo()).thenReturn(LocalDate.of(2019, 11, 1));

    final String result = this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoV1RepositoryCustom
