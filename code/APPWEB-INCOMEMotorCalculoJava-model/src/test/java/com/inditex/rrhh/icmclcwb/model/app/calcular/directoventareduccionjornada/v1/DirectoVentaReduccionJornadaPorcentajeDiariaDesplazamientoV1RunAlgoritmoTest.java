...
public class DirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo.class);
  ...
  public void calcularTest() {
    ...
    verify(this.tareaCalculoAlgoritmoDirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RepositoryCustom,
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo :: Personas: {}",
