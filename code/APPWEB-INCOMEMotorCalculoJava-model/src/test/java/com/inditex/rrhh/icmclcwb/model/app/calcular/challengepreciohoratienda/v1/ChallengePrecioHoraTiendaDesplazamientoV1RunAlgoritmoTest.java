...
public class ChallengePrecioHoraTiendaDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @Mock
  private TareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoV1RepositoryCustom tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoV1RepositoryCustom;

  @Mock
  private TareaCalculoPersonaService tareaCalculoPersonaService;

  @InjectMocks
  private ChallengePrecioHoraTiendaDesplazamientoV1RunAlgoritmo challengePrecioHoraTiendaDesplazamientoV1RunAlgoritmo;
  ...
  void executeTest() {
    ...
    when(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoV1RepositoryCustom.calcular(any(AlgoritmoDTO.class),
        any(TareaDto.class),
        anyList())).thenReturn(future);

    final AlgoritmoDTO algoritmo = new AlgoritmoDTO();

    this.challengePrecioHoraTiendaDesplazamientoV1RunAlgoritmo.execute(this.createRunTareaDto(2L, 3L), algoritmo);
    verify(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoV1RepositoryCustom, times(1)).calcular(
  ...
  public void calcularExceptionTest() {
    ...
    final IdPersonaLocalDto p2 = new IdPersonaLocalDto();
    personas.add(p2);
    when(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoV1RepositoryCustom
        .ids(any(AlgoritmoDTO.class), any(TareaDto.class))).thenReturn(personas);

    when(this.runAlgoritmoProperties.getCalculo()).thenReturn(this.createRunAlgoritmoCalculoPropertiesDto(2));
    final RuntimeException exception = new RuntimeException("EEEE");
    doThrow(exception).when(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaDesplazamientoV1RepositoryCustom)
    ...
    final AlgoritmoDTO algoritmo = new AlgoritmoDTO();
    this.challengePrecioHoraTiendaDesplazamientoV1RunAlgoritmo.execute(runTarea, algoritmo);
