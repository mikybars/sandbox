...
class PrimaryTemporaryTableRepositoryCustomTest {
  ...
  private static final String ID_TAREA_PARAM = "idTarea";

  private static final String INACTIVO_PARAM = "inactivo";

  private static final String IMPORTE_PARAM = "importe";

  private static final Integer SQL_ZERO_VALUE = 0;

  private static final String FECHA_HASTA_PARAM = "fechaHasta";
  ...
  private static final String SQL_CREATE_TEMP_COMIS_BAJA_IT = "SQL CREATE TEMP COMIS BAJA IT";

  private static final String SQL_INSERT_TEMP_COMIS_BAJA_IT = "SQL INSERT TEMP COMIS BAJA IT";

  private static final String SQL_VALIDATE_TEMP_COMIS_BAJA_IT = "SQL VALDIATE TEMP COMIS BAJA IT";

  private static final String SQL_DELETE_TEMP_COMIS_BAJA_IT = "SQL DELETE TEMP COMIS BAJA IT";

  // carencia

  private static final String SQL_CREATE_TEMP_COMIS_CARENCIA = "SQL CREATE TEMP COMIS CARENCIA";

  private static final String SQL_INSERT_TEMP_COMIS_CARENCIA = "SQL INSERT TEMP COMIS CARENCIA";

  private static final String SQL_VALIDATE_TEMP_COMIS_CARENCIA = "SQL VALDIATE TEMP COMIS CARENCIA";

  private static final String SQL_DELETE_TEMP_COMIS_CARENCIA = "SQL DELETE TEMP COMIS CARENCIA";

  // desplazamientos

  private static final String SQL_CREATE_TEMP_COMIS_DESPLAZAMIENTOS = "SQL CREATE TEMP COMIS DESPLAZAMIENTOS";

  private static final String SQL_INSERT_TEMP_COMIS_DESPLAZAMIENTOS = "SQL INSERT TEMP COMIS DESPLAZAMIENTOS";

  private static final String SQL_VALIDATE_TEMP_COMIS_DESPLAZAMIENTOS = "SQL VALDIATE TEMP COMIS DESPLAZAMIENTOS";

  private static final String SQL_DELETE_TEMP_COMIS_DESPLAZAMIENTOS = "SQL DELETE TEMP COMIS DESPLAZAMIENTOS";

  private static final String SQL_DESACTIVA_TEMP_COMIS_DESPLAZAMIENTOS = "SQL DESACTIVA TEMP COMIS DESPLAZAMIENTOS";

  private static final String SQL_REACTIVA_TEMP_COMIS_DESPLAZAMIENTOS = "SQL REACTIVA TEMP COMIS DESPLAZAMIENTOS";

  // historico

  private static final String SQL_CREATE_TEMP_COMIS_HISTORICO = "SQL CREATE TEMP COMIS HISTORICO";

  private static final String SQL_INSERT_TEMP_COMIS_HISTORICO = "SQL INSERT TEMP COMIS HISTORICO";

  private static final String SQL_VALIDATE_TEMP_COMIS_HISTORICO = "SQL VALDIATE TEMP COMIS HISTORICO";

  private static final String SQL_DELETE_TEMP_COMIS_HISTORICO = "SQL DELETE TEMP COMIS HISTORICO";

  private static final String SQL_MERGE_RANGE_TEMP_COMIS_HITORICO = "SQL MERGE RANGE TEMP COMIS HITORICO";

  private static final String SQL_MERGE_DATE_RANGES_SECCION_NOT_EQUALS_TEMP_COMIS_HITORICO =
      "SQL MERGE DATE RANGES SECCION NOT EQUALS TEMP COMIS HITORICO";

  // resalta

  private static final String SQL_CREATE_TEMP_COMIS_RESALTA = "SQL CREATE TEMP COMIS RESALTA";

  private static final String SQL_INSERT_TEMP_COMIS_RESALTA = "SQL INSERT TEMP COMIS RESALTA";

  private static final String SQL_VALIDATE_TEMP_COMIS_RESALTA = "SQL VALDIATE TEMP COMIS RESALTA";

  private static final String SQL_DELETE_TEMP_COMIS_RESALTA = "SQL DELETE TEMP COMIS RESALTA";

  // primas

  private static final String SQL_CREATE_TEMP_COMIS_PRIMAS = "SQL CREATE TEMP COMIS PRIMAS";

  private static final String SQL_INSERT_TEMP_COMIS_PRIMAS = "SQL INSERT TEMP COMIS PRIMAS";

  private static final String SQL_VALIDATE_TEMP_COMIS_PRIMAS = "SQL VALDIATE TEMP COMIS PRIMAS";

  private static final String SQL_DELETE_TEMP_COMIS_PRIMAS = "SQL DELETE TEMP COMIS PRIMAS";

  private static final String SQL_MERGE_DATE_RANGES_SECCION_NOT_EQUALS_TEMP_COMIS_PRIMAS =
      "SQL MERGE DATE RANGES SECCION NOT EQUALS TEMP COMIS PRIMAS";

  private static final String SQL_MERGE_DATE_RANGES_TEMP_COMIS_PRIMAS = "SQL MERGE DATE RANGES TEMP COMIS PRIMAS";

  // totalizacion tarea calculo

  private static final String SQL_CREATE_TEMP_CALCULO_POR_COMISION = "SQL CREATE TEMP CALCULO POR COMISION";

  private static final String SQL_MERGE_CALCULO_TEMP_CALCULO_POR_COMISION = "SQL MERGE TEMP CALCULO POR COMISION";

  private static final String SQL_MERGE_CALCULO_TEMP_CALCULO_SIN_COMISION = "SQL MERGE TEMP CALCULO SIN COMISION";

  private static final String SQL_DELETE_TEMP_CALCULO_POR_COMISION = "SQL DELETE TEMP CALCULO POR COMISION";

  // totalizacion tarea calculo ajuste

  private static final String SQL_CREATE_TEMP_CALCULO_AJUSTE_TOTALIZADO = "SQL CREATE TEMP CALCULO AJUSTE TOTALIZADO";

  private static final String SQL_MERGE_CALCULO_TEMP_CALCULO_AJUSTE_TOTALIZADO = "SQL MERGE TEMP CALCULO AJUSTE TOTALIZADO";

  private static final String SQL_DELETE_TEMP_CALCULO_AJUSTE_TOTALIZADO = "SQL DELETE TEMP CALCULO AJUSTE TOTALIZADO";

  // mejor opcion

  private static final String SQL_CREATE_TEMP_MEJOR_OPCION = "SQL CREATE TEMP MEJOR OPCION";

  private static final String SQL_INSERT_TEMP_MEJOR_OPCION = "SQL MERGE TEMP MEJOR OPCION";

  private static final String SQL_INDEX_TEMP_MEJOR_OPCION = "SQL INDEX TEMP MEJOR OPCION";

  private static final String SQL_DELETE_TEMP_MEJOR_OPCION = "SQL DELETE TEMP MEJOR OPCION";

  // mejor opcion sin fechas

  private static final String SQL_CREATE_TEMP_MEJOR_OPCION_SIN_FECHAS = "SQL CREATE TEMP MEJOR OPCION SIN FECHAS";

  private static final String SQL_INSERT_TEMP_MEJOR_OPCION_SIN_FECHAS = "SQL MERGE TEMP MEJOR OPCION SIN FECHAS";

  private static final String SQL_INDEX_TEMP_MEJOR_OPCION_SIN_FECHAS = "SQL INDEX TEMP MEJOR OPCION SIN FECHAS";

  private static final String SQL_DELETE_TEMP_MEJOR_OPCION_SIN_FECHAS = "SQL DELETE TEMP MEJOR OPCION SIN FECHAS";

  // mejor opcion sin fechas todo periodo

  private static final String SQL_CREATE_TEMP_MEJOR_OPCION_SIN_FECHAS_TODO_PERIODO = "SQL CREATE TEMP MEJOR OPCION SIN FECHAS TODO PERIODO";

  private static final String SQL_INSERT_TEMP_MEJOR_OPCION_SIN_FECHAS_TODO_PERIODO = "SQL MERGE TEMP MEJOR OPCION SIN FECHAS TODO PERIODO";

  private static final String SQL_INDEX_TEMP_MEJOR_OPCION_SIN_FECHAS_TODO_PERIODO = "SQL INDEX TEMP MEJOR OPCION SIN FECHAS TODO PERIODO";

  private static final String SQL_DELETE_TEMP_MEJOR_OPCION_SIN_FECHAS_TODO_PERIODO = "SQL DELETE TEMP MEJOR OPCION SIN FECHAS TODO PERIODO";

  // estructuras base challenge

  private static final String SQL_CREATE_TEMP_ESTRUCTURAS_BASE_CHALLENGE = "SQL CREATE TEMP ESTRUCTURAS BASE CHALLENGE";

  private static final String SQL_INSERT_TEMP_ESTRUCTURAS_BASE_CHALLENGE = "SQL MERGE TEMP ESTRUCTURAS BASE CHALLENGE";

  private static final String SQL_INDEX_TEMP_ESTRUCTURAS_BASE_CHALLENGE = "SQL INDEX TEMP ESTRUCTURAS BASE CHALLENGE";

  private static final String SQL_DELETE_TEMP_ESTRUCTURAS_BASE_CHALLENGE = "SQL DELETE TEMP ESTRUCTURAS BASE CHALLENGE";

  // estructuras desplazamiento no challenge

  private static final String SQL_CREATE_TEMP_ESTRUCTURAS_DESPLAZAMIENTO_NOCHALLENGE =
      "SQL CREATE TEMP ESTRUCTURAS DESPLAZAMIENTO NO CHALLENGE";

  private static final String SQL_INSERT_TEMP_ESTRUCTURAS_DESPLAZAMIENTO_NOCHALLENGE =
      "SQL MERGE TEMP ESTRUCTURAS DESPLAZAMIENTO NO CHALLENGE";

  private static final String SQL_INDEX_TEMP_ESTRUCTURAS_DESPLAZAMIENTO_NOCHALLENGE =
      "SQL INDEX TEMP ESTRUCTURAS DESPLAZAMIENTO NO CHALLENGE";

  private static final String SQL_DELETE_TEMP_ESTRUCTURAS_DESPLAZAMIENTO_NOCHALLENGE =
      "SQL DELETE TEMP ESTRUCTURAS DESPLAZAMIENTO NO CHALLENGE";

  private static final String SQL_CREATE_TEMP_BANDAS_ORIGEN_SIN_BANDA_DESPLAZAMIENTO =
      "SQL CREATE TEMP BANDAS ORIGEN SIN BANDA DESPLAZAMIENTO";

  private static final String SQL_INSERT_TEMP_BANDAS_ORIGEN_SIN_BANDA_DESPLAZAMIENTO =
      "SQL INSERT TEMP BANDAS ORIGEN SIN BANDA DESPLAZAMIENTO";

  private static final String SQL_DELETE_TEMP_BANDAS_ORIGEN_SIN_BANDA_DESPLAZAMIENTO =
      "SQL DELETE TEMP BANDAS ORIGEN SIN BANDA DESPLAZAMIENTO";

  // comision manual
  private static final String SQL_CREATE_TEMP_COMIS_COMISION_MANUAL = "SQL CREATE TEMP COMIS COMISION MANUAL";

  private static final String SQL_INDEX_TEMP_COMIS_COMISION_MANUAL = "SQL INDEX TEMP COMIS COMISION MANUAL";

  private static final String SQL_INSERT_TEMP_COMIS_COMISION_MANUAL = "SQL INSERT TEMP COMIS COMISION MANUAL";

  private static final String SQL_DELETE_TEMP_COMIS_COMISION_MANUAL = "SQL DELETE TEMP COMIS COMISION MANUAL";

  private static final String SQL_VALIDATE_TEMP_COMIS_COMISION_MANUAL = "SQL VALIDATE TEMP COMIS COMISION MANUAL";

  // personas
  private static final String SQL_CREATE_TEMP_COMIS_PERSONAS_LOCALIZACIONES = "SQL CREATE TEMP COMIS PERSONAS";

  private static final String SQL_INDEX_TEMP_COMIS_PERSONAS_LOCALIZACIONES = "SQL INDEX TEMP COMIS PERSONAS";

  private static final String SQL_DELETE_TEMP_COMIS_PERSONAS_LOCALIZACIONES = "SQL DELETE TEMP COMIS PERSONAS";

  private static final String SQL_INSERT_TEMP_COMIS_PERSONAS_LOCALIZACIONES = "SQL INSERT TEMP COMIS PERSONAS";

  private static final String SQL_VALIDATE_TEMP_COMIS_PERSONAS = "SQL VALIDATE TEMP COMIS PERSONAS";

  // estructura presupuesto
  private static final String SQL_INSERT_TAREA_LOCALIZACION_PRESUPUESTO_TAREA_PERSONA_ESTRUCTURA =
      "SQL INSERT TAREA LOCALIZACION PRESUPUESTO TAREA PERSONA ESTRUCTURA";

  // challenge porcentaje
  private static final String SQL_VALIDATE_TEMP_COMIS_CHALLENGE_PORCENTAJE = "SQL VALDIATE TEMP COMIS CHALLENGE PORCENTAJE";

  private static final String SQL_VALIDATE_TEMP_COMIS_DESPLAZAMIENTO_CHALLENGE_PORCENTAJE =
      "SQL VALDIATE TEMP COMIS DESPLAZAMIENTO CHALLENGE PORCENTAJE";

  private static final String SQL_VALIDATE_INSERT_TEMP_ESTRUCTURA = "SQL_VALIDATE_INSERT_TEMP_ESTRUCTURA";
