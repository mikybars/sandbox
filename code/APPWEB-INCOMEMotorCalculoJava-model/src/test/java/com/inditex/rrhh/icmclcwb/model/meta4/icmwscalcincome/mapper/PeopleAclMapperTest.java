...
class PeopleAclMapperTest {
  ...
  class ToEmpresaResultItemDto {
    ...
    void whenSourcePopulatedExpectFieldsMappedAndAuditFieldsIgnored() {
      ...
      assertThat(result.getIdOrigen()).isEqualTo("ORIG-1");
      assertThat(result.getIdEmpresa()).isEqualTo("EMP-1");
      assertThat(result.getNombreEmpresa()).isEmpty();
      assertThat(result.getM4AutoGeneratedRecordID()).isNull();
      assertThat(result.isM4AutoGeneratedToDelete()).isFalse();
    }
  ...
  class ToAusenciasResultItemDto {
    ...
    void whenSourcePopulatedExpectFieldsMappedAndAuditFieldsIgnored() {
      ...
      assertThat(result.getFechaInicio()).isEqualTo(LocalDateTime.of(2026, 1, 1, 1, 0, 0));
      assertThat(result.getFechaFin()).isEqualTo(LocalDateTime.of(2027, 1, 1, 0, 59, 59));
      assertThat(result.getM4AutoGeneratedRecordID()).isNull();
      assertThat(result.isM4AutoGeneratedToDelete()).isFalse();
    }
  ...
  class ToGenericTiendaResultItemDto {
    ...
    void whenSourcePopulatedExpectMappedFieldsAndIgnoredFields() {
      ...
      assertThat(result.getIdPais()).isEmpty();
      assertThat(result.getIdProvincia()).isEmpty();
      assertThat(result.getCalcula()).isFalse();
      assertThat(result.getIdCadena()).isEmpty();
      assertThat(result.getIdOrigen()).isEmpty();
      assertThat(result.getIdEmpresa()).isEmpty();
  ...
  class ToPresenciaManualResponseDto {
    ...
    void whenResponseWithSectionsExpectFlattenedItems() {
      ...
      assertThat(first.getFecha()).isEqualTo(LocalDateTime.of(2026, 1, 1, 1, 0, 0));
    ...
    void whenResponseWithEmptySectionsExpectOneItemWithNullSeccionAndMinutos() {
      ...
      assertThat(result).isNotNull();
      assertThat(result.getData()).hasSize(1);
      assertThat(result.getData().get(0).getIdSeccion()).isEmpty();
      assertThat(result.getData().get(0).getMinutos()).isEmpty();
    }
  ...
  class ToEmpleadoDesplazadoItemDto {
    ...
    void whenSourcePopulatedExpectMappedFieldsAndIgnoredFieldsNull() {
      ...
      assertThat(result.getIdCadena()).isEmpty();
      assertThat(result.getIdPais()).isEmpty();
      assertThat(result.getOrEmpleado()).isEmpty();
      assertThat(result.getIdSeccion()).isEmpty();
      assertThat(result.getIdTipoHora()).isNull();
      assertThat(result.getCoefJornada()).isEmpty();
      assertThat(result.getImporte()).isEmpty();
      assertThat(result.getMinutos()).isEmpty();
      assertThat(result.getIdPuesto()).isEmpty();
    }
  ...
  class ToPeriodosResultItemDto {
    ...
    void whenPopulatedExpectFieldsMapped() {
      ...
      assertThat(result.getFechaFin()).isEqualTo(LocalDate.of(2026, 4, 1));
    ...
    void whenIgnoredFieldsExpectNull() {
      ...
      assertThat(result.getBorrado()).isEqualTo("0");
      assertThat(result.getModificado()).isEqualTo("0");
      assertThat(result.getNuevo()).isEqualTo("0");
      assertThat(result.getNombrePeriodo()).isEmpty();
      assertThat(result.getM4AutoGeneratedRecordID()).isNull();
    }
  }
  ...
  class ToPeriodosResultItemDtoList {
    ...
    void whenPopulatedExpectListMapped() {
      ...
      assertThat(result.get(0).getIdOrigen()).isEmpty();
    }
  ...
  class ToPeriodosResponseDto {
    ...
    void whenResponseWithDataExpectItemsMappedPageIgnored() {
      ...
      assertThat(mapped.getIdOrigen()).isEmpty();
      assertThat(mapped.getFechaInicio()).isEqualTo(LocalDate.of(2026, 1, 1));
      assertThat(mapped.getFechaFin()).isEqualTo(LocalDate.of(2027, 1, 1));
