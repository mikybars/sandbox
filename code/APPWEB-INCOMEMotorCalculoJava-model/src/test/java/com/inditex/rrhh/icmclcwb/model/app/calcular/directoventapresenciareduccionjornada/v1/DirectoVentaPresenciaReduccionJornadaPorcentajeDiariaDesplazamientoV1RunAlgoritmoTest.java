...
public class DirectoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmoTest implements
    RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);
    assertEquals(SQL_CALCULAR,
        this.directoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo
  ...
  public void calcularTest() {
    ...
    this.directoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo.execute(runTarea,
        algoritmo);

    verify(this.tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RepositoryCustom,
        times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaReduccionJornadaPorcentajeDiariaDesplazamientoV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
