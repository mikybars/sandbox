...
class RunTareaValidarVentasMonacoServiceImplTest {
  ...
  @Mock
  private RunTareaAmbitoValidarVentasMonacoService runTareaAmbitoValidarVentasMonacoService;

  @InjectMocks
  private RunTareaValidarVentasMonacoServiceImpl runTareaValidarVentasMonacoService;
  ...
  void executeTest() {
    ...
    tareaFaseAccionDto.setIdAccion(98);
    ...
    doReturn(validacion).when(this.runTareaAmbitoValidarVentasMonacoService)
    ...
    this.runTareaValidarVentasMonacoService.execute(runTareaDto, tareaFaseAccionDto);
  ...
  void executeEmptyValidacionesTest() {
    ...
    doReturn(null).when(this.runTareaAmbitoValidarVentasMonacoService)
