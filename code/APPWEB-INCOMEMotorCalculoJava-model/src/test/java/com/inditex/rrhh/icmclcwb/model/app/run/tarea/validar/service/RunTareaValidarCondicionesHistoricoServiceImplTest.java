...
public class RunTareaValidarCondicionesHistoricoServiceImplTest {
  ...
  @InjectMocks
  private RunTareaValidarCondicionesHistoricoServiceImpl runTareaValidarCondicionesHistoricoService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesHistoricoService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesHistoricoService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesHistoricoService, timeout(1000).times(1))
        .execute(
