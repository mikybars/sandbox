...
public class PorVentaIndividualPorcentajeDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(PorVentaIndividualPorcentajeDesplazamientoV1RunAlgoritmo.class);
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoPorVentaIndividualPorcentajeDesplazamientoV1RepositoryCustom.calcular(
    ...
    verify(this.tareaCalculoAlgoritmoPorVentaIndividualPorcentajeDesplazamientoV1RepositoryCustom,
        times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: PorVentaIndividualPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: PorVentaIndividualPorcentajeDesplazamientoV1RunAlgoritmo :: KO :: Personas: {}",
