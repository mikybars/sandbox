...
class RunTareaValidarVentasSinPresenciasServiceImplTest {
  ...
  @InjectMocks
  private RunTareaValidarVentasSinPresenciasServiceImpl runTareaValidarVentasSinPresenciasService;
  ...
  void execute() {
    ...
    when(this.runTareaAmbitoValidarVentasSinPresenciasService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarVentasSinPresenciasService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarVentasSinPresenciasService, timeout(1000).times(1))
        .execute(
