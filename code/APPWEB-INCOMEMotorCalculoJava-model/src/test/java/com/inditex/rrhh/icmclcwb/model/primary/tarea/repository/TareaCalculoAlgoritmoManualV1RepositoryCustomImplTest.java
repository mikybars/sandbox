...
public class TareaCalculoAlgoritmoManualV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoManualV1RepositoryCustomImpl tareaCalculoAlgoritmoManualV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoManualV1RepositoryCustom, "sqlCalcular", SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoManualV1RepositoryCustom, "sqlCalcularBase", SQL_BASE, true);
  }
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoManualV1RepositoryCustom.ids(algoritmo, tarea);
  ...
  public void getMapValuesTest() {
    ...
    final AlgoritmoDTO algoritmo = mock(AlgoritmoDTO.class);
    when(algoritmo.getId()).thenReturn(10001);
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoManualV1RepositoryCustom.getMapValues(algoritmo,
        tarea,
        persona1);
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoManualV1RepositoryCustom.calcular(algoritmo, tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoManualV1RepositoryCustom
