...
public class TareaCalculoAlgoritmoChallengePrecioHoraTiendaV1RepositoryCustomImplTest {
  ...
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaV1RepositoryCustomImpl, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaV1RepositoryCustomImpl,
        "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaV1RepositoryCustomImpl
        .ids(algoritmo, tarea);
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaV1RepositoryCustomImpl.calcular(algoritmo, tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoChallengePrecioHoraTiendaV1RepositoryCustomImpl
