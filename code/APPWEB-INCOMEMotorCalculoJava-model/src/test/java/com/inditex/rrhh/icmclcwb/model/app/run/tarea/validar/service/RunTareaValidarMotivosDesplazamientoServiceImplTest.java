...
public class RunTareaValidarMotivosDesplazamientoServiceImplTest {
  ...
  @InjectMocks
  private RunTareaValidarMotivosDesplazamientoServiceImpl runTareaValidarMotivosDesplazamientoService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarMotivosDesplazamientoService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarMotivosDesplazamientoService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarMotivosDesplazamientoService, timeout(1000).times(1))
        .execute(
