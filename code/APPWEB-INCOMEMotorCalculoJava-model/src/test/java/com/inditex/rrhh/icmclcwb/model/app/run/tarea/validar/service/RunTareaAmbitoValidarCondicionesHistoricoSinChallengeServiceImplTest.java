...
public class RunTareaAmbitoValidarCondicionesHistoricoSinChallengeServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesHistoricoSinChallengeServiceImpl runTareaAmbitoValidarCondicionesHistoricoSinChallengeServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesHistoricoSinChallenge(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesHistoricoSinChallengeServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);

    verify(this.comisAsyncService, timeout(1000).times(1))
        .findCondicionesHistoricoSinChallenge(
