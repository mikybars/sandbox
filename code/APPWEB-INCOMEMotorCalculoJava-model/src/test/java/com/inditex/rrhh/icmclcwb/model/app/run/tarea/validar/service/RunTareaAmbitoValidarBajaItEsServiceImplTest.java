...
public class RunTareaAmbitoValidarBajaItEsServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarBajaItEsServiceImpl runTareaAmbitoValidarBajaItEsServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findBajasItEs(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarBajaItEsServiceImpl.execute(runTareaDto, tareaAmbitoDto, tareaFaseAccionDto);
    ...
    verify(this.primaryTemporaryTableRepositoryCustom, timeout(1000).times(1))
        .createTempComisBajaIt();
    verify(this.primaryTemporaryTableRepositoryCustom, timeout(1000).times(1))
        .insertTempComisBajaIt(ArgumentMatchers.any(List.class));
    verify(this.primaryTemporaryTableRepositoryCustom, timeout(1000).times(1))
        .validateTempComisBajaIt(ArgumentMatchers.any(TareaDto.class));
    verify(this.primaryTemporaryTableRepositoryCustom, timeout(1000).times(1))
        .deleteTempComisBajaIt();
