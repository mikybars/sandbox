...
public class ChallengeJornadaDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @InjectMocks
  private ChallengeJornadaDesplazamientoV1RunAlgoritmo challengeJornadaDesplazamientoV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(ChallengeJornadaDesplazamientoV1RunAlgoritmo.class);
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoChallengeJornadaDesplazamientoV1RepositoryCustom)
