...
public class DirectoVentaPresenciaPorcentajeV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @Mock
  private TareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom;
  ...
  @InjectMocks
  private DirectoVentaPresenciaPorcentajeV1RunAlgoritmo directoVentaPresenciaPorcentajeV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPresenciaPorcentajeV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);

    final String result = this.directoVentaPresenciaPorcentajeV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDTO());
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom.calcular(
    ...
    this.directoVentaPresenciaPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);

    verify(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom,
        times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaPorcentajeV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaPorcentajeV1RepositoryCustom)
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaPorcentajeV1RunAlgoritmo :: Personas: {}",
