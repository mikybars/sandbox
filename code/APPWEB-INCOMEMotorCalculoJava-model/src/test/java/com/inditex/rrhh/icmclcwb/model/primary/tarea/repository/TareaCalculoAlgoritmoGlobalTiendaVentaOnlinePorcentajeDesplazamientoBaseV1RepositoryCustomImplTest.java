...
class TareaCalculoAlgoritmoGlobalTiendaVentaOnlinePorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
  ...
  void getMapValuesTest(@Random final IdTipoDatoDto tipoDatoVenta1, @Random final IdTipoDatoDto tipoDatoVenta2,
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoGlobalTiendaVentaOnlinePorcentajeDesplazamientoBaseV1RepositoryCustom
  ...
  void calcularTest(@Random final IdTipoDatoDto tipoDatoVenta1, @Random final IdTipoDatoDto tipoDatoVenta2,
    ...
    this.tareaCalculoAlgoritmoGlobalTiendaVentaOnlinePorcentajeDesplazamientoBaseV1RepositoryCustom.calcular(algoritmo, tarea, personas);
  ...
  void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoGlobalTiendaVentaOnlinePorcentajeDesplazamientoBaseV1RepositoryCustom
