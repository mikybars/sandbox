...
public class ManualV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @Mock
  private TareaCalculoAlgoritmoManualV1RepositoryCustom tareaCalculoAlgoritmoManualV1RepositoryCustom;
  ...
  @InjectMocks
  private ManualV1RunAlgoritmo manualV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(ManualV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoManualV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);
    assertEquals(SQL_CALCULAR, this.manualV1RunAlgoritmo.getSqlCalcular(new AlgoritmoDTO()));
  }
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoManualV1RepositoryCustom.calcular(
    ...
    this.manualV1RunAlgoritmo.execute(runTarea, algoritmo);

    verify(this.tareaCalculoAlgoritmoManualV1RepositoryCustom, times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: ManualV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    doThrow(exception).when(this.tareaCalculoAlgoritmoManualV1RepositoryCustom)
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: ManualV1RunAlgoritmo :: Personas: {}",
