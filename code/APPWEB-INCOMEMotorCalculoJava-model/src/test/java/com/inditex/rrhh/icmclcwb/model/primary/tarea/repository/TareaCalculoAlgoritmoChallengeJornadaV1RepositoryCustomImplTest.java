...
public class TareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustomImpl tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom, "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom, "sqlCalcularBase",
        SQL_BASE, true);
  }
  ...
  public void idsTest() {
    ...
    final List<IdPersonaLocalDto> ids = this.tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom.ids(
        algoritmo,
        tarea);
  ...
  public void getMapValuesTest() {
    ...
    final Map<String, Object> result = this.tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom
  ...
  public void calcularTest() {
    ...
    this.tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom.calcular(algoritmo, tarea, personas);
  ...
  public void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoChallengeJornadaV1RepositoryCustom
