...
public class PorVentaSinDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(PorVentaSinDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo.class);
  ...
  public void executeTest() {
    ...
    verify(this.tareaCalculoAlgoritmoPorVentaSinDevolucionPorcentajeDesplazamientoBaseV1RepositoryCustom, times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: PorVentaSinDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void executeExceptionTest() {
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: PorVentaSinDevolucionPorcentajeDesplazamientoBaseV1RunAlgoritmo :: Personas: {}",
