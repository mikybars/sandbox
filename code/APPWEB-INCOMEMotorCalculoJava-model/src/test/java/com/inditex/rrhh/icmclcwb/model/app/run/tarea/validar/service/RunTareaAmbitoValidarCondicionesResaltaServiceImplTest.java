...
public class RunTareaAmbitoValidarCondicionesResaltaServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesResaltaServiceImpl runTareaAmbitoValidarCondicionesResaltaServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesResalta(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesResaltaServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);

    verify(this.comisAsyncService, timeout(1000).times(1))
        .findCondicionesResalta(
