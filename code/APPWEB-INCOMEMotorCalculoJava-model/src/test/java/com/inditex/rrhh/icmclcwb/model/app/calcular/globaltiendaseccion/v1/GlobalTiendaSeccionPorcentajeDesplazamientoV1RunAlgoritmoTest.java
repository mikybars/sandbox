...
public class GlobalTiendaSeccionPorcentajeDesplazamientoV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  public void calcularTest() {
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Inicio :: GlobalTiendaSeccionPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
    ...
    verify(this.log, times(1))
        .info("Trabajo[{}]Tarea[{}] :: Fin :: GlobalTiendaSeccionPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}",
            idTrabajo, idTarea, 3);
  }
  ...
  public void calcularExceptionTest() {
    ...
    verify(this.log, times(1))
        .error("Trabajo[{}]Tarea[{}] :: GlobalTiendaSeccionPorcentajeDesplazamientoV1RunAlgoritmo :: KO :: Personas: {}",
