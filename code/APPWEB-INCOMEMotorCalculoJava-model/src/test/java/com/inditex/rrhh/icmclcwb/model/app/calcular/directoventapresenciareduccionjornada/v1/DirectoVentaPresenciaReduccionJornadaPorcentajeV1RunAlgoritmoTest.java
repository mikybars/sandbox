...
public class DirectoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmoTest implements RunAlgoritmoTest {
  ...
  @Mock
  private TareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeV1RepositoryCustom tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeV1RepositoryCustom;
  ...
  @InjectMocks
  private DirectoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo directoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo;
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory.getLogger(DirectoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo.class);
  ...
  public void getSqlCalcularTest() {
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeV1RepositoryCustom
        .getSqlCalcular(any(AlgoritmoDTO.class))).thenReturn(SQL_CALCULAR);

    final String result = this.directoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo
  ...
  public void calcularTest() {
    ...
    when(this.tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeV1RepositoryCustom.calcular(
    ...
    this.directoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo.execute(runTarea, algoritmo);


    verify(this.tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeV1RepositoryCustom, times(1))
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
  ...
  public void calcularExceptionTest() {
    ...
    assertEquals(Level.INFO, this.listAppender.list.get(0).getLevel());
    assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaReduccionJornadaPorcentajeV1RunAlgoritmo :: Personas: {}",
