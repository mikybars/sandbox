...
public class RunTareaRecolectarValidarEstructurasServiceImplTest {

  @Mock
  private TareaValidarAsyncService tareaValidarAsyncService;

  @InjectMocks
  private RunTareaRecolectarValidarEstructurasServiceImpl runTareaRecolectarValidarEstructurasServiceImpl;
  ...
  public void run() {
    ...
    when(this.tareaValidarAsyncService.countEstructuras(any(Long.class)))
        .thenReturn(cf);

    this.runTareaRecolectarValidarEstructurasServiceImpl.run(runTareaDto);
