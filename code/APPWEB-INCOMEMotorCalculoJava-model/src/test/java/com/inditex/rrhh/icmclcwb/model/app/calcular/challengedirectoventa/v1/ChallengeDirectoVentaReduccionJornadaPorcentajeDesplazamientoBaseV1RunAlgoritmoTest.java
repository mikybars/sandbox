...
public class ChallengeDirectoVentaReduccionJornadaPorcentajeDesplazamientoBaseV1RunAlgoritmoTest {

  private static final String SQL_CALCULAR = "SELECT * FROM TABLE WHERE 1";
  ...
  @InjectMocks
  private ChallengeDirectoVentaReduccionJornadaPorcentajeDesplazamientoBaseV1RunAlgoritmo challengeDirectoVentaReduccionJornadaPorcentajeDesplazamientoBaseV1RunAlgoritmo;
  ...
  void executeTest() {
    ...
    when(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom
    ...
    final CompletableFuture<Void> result = this.challengeDirectoVentaReduccionJornadaPorcentajeDesplazamientoBaseV1RunAlgoritmo
        .execute(runTareaPrueba, algoritmoPrueba);

    assertNotNull(result);
    verify(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom, times(1))
        .calcular(any(AlgoritmoDTO.class), any(TareaDto.class), anyList());
    verify(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom, times(1))
        .ids(any(AlgoritmoDTO.class), any(TareaDto.class));
  }
  ...
  void getSqlCalcularTest() {
    ...
    // Then
    final String result = this.challengeDirectoVentaReduccionJornadaPorcentajeDesplazamientoBaseV1RunAlgoritmo
  ...
  void executeTestWithInstancio(final List<IdPersonaLocalDto> ids,
    ...
    // When
    doReturn(ids).when(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom)
    ...
    doReturn(completableFuture).when(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom)
  ...
  void getSqlCalcularTestWithInstancio(final AlgoritmoDTO algoritmoInstancio) {
    // Given - When
    doReturn(SQL_CALCULAR).when(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom)
  ...
  void executeTestWithEmptyIds() {
    ...
    verify(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom, times(0))
        .calcular(any(AlgoritmoDTO.class), any(TareaDto.class), anyList());
  }
  ...
  void executeTestWithLargeBatch() {
    ...
    verify(this.tareaCalculoAlgoritmoChallengeDirectoVentaPorcentajeDesplazamientoBaseV1RepositoryCustom, times(3))
        .calcular(any(AlgoritmoDTO.class), any(TareaDto.class), anyList());
  }
