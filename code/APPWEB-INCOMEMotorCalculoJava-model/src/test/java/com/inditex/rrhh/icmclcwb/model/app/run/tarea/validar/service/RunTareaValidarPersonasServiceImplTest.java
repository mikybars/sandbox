...
class RunTareaValidarPersonasServiceImplTest {
  ...
  @Mock
  private RunTareaAmbitoValidarPersonasService runTareaAmbitoValidarPersonasService;
  ...
  void executeValidacionesConErroresTest(@Random final RunTareaDto runTarea, @Random final TareaFaseAccionDto tareaFaseAccion) {
    ...
    when(this.runTareaAmbitoValidarPersonasService.execute(any(RunTareaDto.class),
    ...
    for (final TareaAmbitoDto ambito : tarea.getAmbito()) {
      ...
      verify(this.runTareaAmbitoValidarPersonasService, timeout(1000).times(1)).execute(runTarea, ambito, tareaFaseAccion);
    }
  ...
  void executeSinValidacionesTest(@Random final RunTareaDto runTarea, @Random final TareaFaseAccionDto tareaFaseAccion) {
    ...
    verify(this.runTareaAmbitoValidarPersonasService, timeout(1000).times(0)).execute(any(RunTareaDto.class),
