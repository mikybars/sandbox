...
public class RunTareaAmbitoValidarCondicionesResaltaEsServiceImplTest {
  ...
  @InjectMocks
  private RunTareaAmbitoValidarCondicionesResaltaEsServiceImpl runTareaAmbitoValidarCondicionesResaltaEsServiceImpl;
  ...
  public void execute() {
    ...
    when(this.comisAsyncService.findCondicionesResaltaEs(any(RunTareaDto.class), any(TareaAmbitoDto.class)))
        .thenReturn(cf);

    this.runTareaAmbitoValidarCondicionesResaltaEsServiceImpl.execute(runTareaDto, tareaAmbitoDto,
        tareaFaseAccionDto);

    verify(this.comisAsyncService, timeout(1000).times(1))
        .findCondicionesResaltaEs(
