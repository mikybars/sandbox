...
public class RunTareaValidarPresenciasMismaFechaDistintaTiendaImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaServiceImpl runTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaService;
  ...
  @InjectMocks
  private RunTareaValidarPresenciasMismaFechaDistintaTiendaImpl runTareaValidarPresenciasMismaFechaDistintaTienda;
  ...
  void execute() {
    ...
    when(this.runTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarPresenciasMismaFechaDistintaTienda.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarPresenciasMismaFechaDistintaTiendaService, timeout(1000).times(1))
        .execute(
