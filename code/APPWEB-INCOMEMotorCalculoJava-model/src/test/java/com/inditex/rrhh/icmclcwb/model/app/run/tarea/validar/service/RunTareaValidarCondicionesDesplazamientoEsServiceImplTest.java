...
public class RunTareaValidarCondicionesDesplazamientoEsServiceImplTest {

  @Mock
  private TareaFaseAccionService tareaFaseAccionService;

  @Mock
  private RunTareaAmbitoValidarCondicionesDesplazamientoEsService runTareaAmbitoValidarCondicionesDesplazamientoEsService;

  @Mock
  private AccionService accionService;

  @InjectMocks
  private RunTareaValidarCondicionesDesplazamientoEsServiceImpl runTareaValidarCondicionesDesplazamientoEsService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesDesplazamientoEsService.execute(
    ...
    this.runTareaValidarCondicionesDesplazamientoEsService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesDesplazamientoEsService, timeout(1000).times(1))
        .execute(
