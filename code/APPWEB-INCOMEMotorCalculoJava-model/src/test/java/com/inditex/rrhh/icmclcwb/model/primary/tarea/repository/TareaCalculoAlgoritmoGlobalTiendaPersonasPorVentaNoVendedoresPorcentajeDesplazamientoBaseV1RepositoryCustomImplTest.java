...
class TareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustomImplTest {
  ...
  @InjectMocks
  private TareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustomImpl tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom;

  @BeforeEach
  public void setup() throws IllegalAccessException {
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom,
        "sqlCalcular",
        SQL_CALCULAR, true);
    FieldUtils.writeField(this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom,
        "sqlCalcularBase",
  ...
  @Test
  void getMapValuesTest(@Random(type = IdTipoDatoDto.class, size = 11) final List<IdTipoDatoDto> tiposDatoVenta,
      @Random(type = IdTipoDatoDto.class, size = 5) final List<IdTipoDatoDto> tiposDatoPresencia,
    ...
    expected.put(SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION,
        TipoDatoEnum.INDICADOR_PRESENCIA_LOCALIZACION_PERSONA_TIPOHORA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION.getId());
  ...
  @Test
  void calcularTest(@Random(type = IdTipoDatoDto.class, size = 11) final List<IdTipoDatoDto> tiposDatoVenta,
      @Random(type = IdTipoDatoDto.class, size = 5) final List<IdTipoDatoDto> tiposDatoPresencia, @Random final AlgoritmoDTO algoritmo,
      @Random final TareaDto tarea,
      @Random(type = IdPersonaLocalDto.class, size = 9) final List<IdPersonaLocalDto> personas) {
    ...
    verify(this.tipoDatoService, times(9))
        .findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.PRESENCIA_LOCALIZACION_SECCION_PERSONA_TIPOHORA.getId());
    verify(this.tipoDatoService, times(9)).findTipoDatoByTipoGrupoDato(TipoGrupoDatoEnum.VENTA_LOCALIZACION_SECCION.getId());
  ...
  void getSqlCalcularTest() {
    ...
    final String result = this.tareaCalculoAlgoritmoGlobalTiendaPersonasPorVentaNoVendedoresPorcentajeDesplazamientoBaseV1RepositoryCustom
