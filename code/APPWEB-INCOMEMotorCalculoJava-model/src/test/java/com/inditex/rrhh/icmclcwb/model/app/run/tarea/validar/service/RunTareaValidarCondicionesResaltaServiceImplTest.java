...
public class RunTareaValidarCondicionesResaltaServiceImplTest {
  ...
  @InjectMocks
  private RunTareaValidarCondicionesResaltaServiceImpl runTareaValidarCondicionesResaltaService;
  ...
  public void execute() {
    ...
    when(this.runTareaAmbitoValidarCondicionesResaltaService.execute(ArgumentMatchers.any(RunTareaDto.class),
        ArgumentMatchers.any(TareaAmbitoDto.class),
        ArgumentMatchers.any(TareaFaseAccionDto.class)))
            .thenReturn(validacion);

    this.runTareaValidarCondicionesResaltaService.execute(runTareaDto, tareaFaseAccionDto);
    ...
    verify(this.runTareaAmbitoValidarCondicionesResaltaService, timeout(1000).times(1))
        .execute(
