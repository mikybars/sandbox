...
public class DirectoVentaPresenciaReduccionJornadaPorcentajeDesplazamientoV1RunAlgoritmoTest implements
  ...
  public void setup() {
    final ch.qos.logback.classic.Logger logger =
        (ch.qos.logback.classic.Logger) LoggerFactory
            .getLogger(DirectoVentaPresenciaReduccionJornadaPorcentajeDesplazamientoV1RunAlgoritmo.class);
  ...
  public void calcularTest() {
    ...
    verify(this.tareaCalculoAlgoritmoDirectoVentaPresenciaReduccionJornadaPorcentajeDesplazamientoV1RepositoryCustom,
      ...
      assertEquals("Trabajo[{}]Tarea[{}] :: Fin :: DirectoVentaPresenciaReduccionJornadaPorcentajeDesplazamientoV1RunAlgoritmo :: Personas: {}", this.listAppender.list.get(3).getMessage());
