...
public class SqlPrimaryConstants {
    ...
    public static final String SQL_PARAM_ID_TIPO_DATO_VENTA_RANGO_CONGELADA_LOCALIZACION_SECCION =
        "idtipoVentaRangoCongeladaLocalizacionSeccion";
    ...
    public static final String SQL_PARAM_ID_TIPO_DATO_INDICADOR_PRESENCIA_DESPLAZAMIENTO_BASE_DESPLAZAMIENTO_MISMA_LOCALIZACION =
    ...
    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_ENTREGA_TIENDA_LOCALIZACION_SECCION =
        "idTipoDatoVentaEntregaTiendaLocalizacionSeccion";

    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_LOCALIZACION_PERSONAS_POR_VENTA =
    ...
    public static final String SQL_PARAM_ID_TIPO_DATO_PRESENCIA_LOCALIZACION_PERSONAS_POR_VENTA =
        "idTipoDatoPresenciaLocalizacionPersonasPorVenta";
    ...
    public static final String SQL_PARAM_ID_TIPO_DATO_VENTA_SIN_DEVOLUCION_LOCALIZACION_SECCION =
    ...
    public static final String SQL_PARAM_ID_TIPO_DATO_REPARTO_VENDEDOR_0 = "idTipoDatoRepartoVendedor0";
    ...
    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_ENTREGA_DOMICILIO_LOCALIZACION_SECCION_TRASLADADA =
    ...
    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_SINT_LOCALIZACION_SECCION_TRASLADADA =
    ...
    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_IPOD_LOCALIZACION_SECCION_TRASLADADA =
        "idTipoDatoVentaIpodLocalizacionSeccionTrasladada";

    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_ENTREGA_TIENDA_LOCALIZACION_TRASLADADA =
        "idTipoDatoVentaEntregaTiendaLocalizacionTrasladada";

    public static final String SQL_PARAM_ID_TIPO_IMPORTE_VENTA_ENTREGA_TIENDA_LOCALIZACION_SECCION_TRASLADADA =
