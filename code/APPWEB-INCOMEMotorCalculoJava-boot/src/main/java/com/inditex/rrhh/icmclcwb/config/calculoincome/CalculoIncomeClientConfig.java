...
public class CalculoIncomeClientConfig {
  ...
  @Bean(name = "coeficientesJornadaCalculoIncomeApiClient")
  public CoeficientesJornadaApi coeficientesJornadaCalculoIncomeApiClient(@Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new CoeficientesJornadaApi(apiClient);
  }
  ...
  public EmpleadosDesplazadosApi empleadosDesplazadosCalculoIncomeApiClient(
      @Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new EmpleadosDesplazadosApi(apiClient);
  }

  @Bean(name = "empleadosPresenciaCalculoIncomeApiClient")
  public EmpleadosPresenciaApi empleadosPresenciaCalculoIncomeApiClient(@Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new EmpleadosPresenciaApi(apiClient);
  }
  ...
  @Bean(name = "periodosCalculoIncomeApiClient")
  public PeriodosApi periodosCalculoIncomeApiClient(@Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new PeriodosApi(apiClient);
  }

  @Bean(name = "sistemasDestinoCalculoIncomeApiClient")
  public SistemasDestinoApi sistemasDestinoCalculoIncomeApiClient(@Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new SistemasDestinoApi(apiClient);
  }

  @Bean(name = "desplazamientosRealesCalculoIncomeApiClient")
  public DesplazamientosRealesApi desplazamientosRealesCalculoIncomeApiClient(
      @Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new DesplazamientosRealesApi(apiClient);
  }

  @Bean(name = "desplazamientosMultiempresaCalculoIncomeApiClient")
  public DesplazamientosMultiempresaApi desplazamientosMultiempresaCalculoIncomeApiClient(
      @Qualifier("calculoIncomeApiClient") final ApiClient apiClient) {
    return new DesplazamientosMultiempresaApi(apiClient);
  }
