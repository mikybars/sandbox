...
public final class QueryPropertiesLoader {
  ...
  private QueryPropertiesLoader() {
    // utility class
  }

  public static PropertiesFactoryBean loadBean(final ResourceLoader resourceLoader, final String resource,
