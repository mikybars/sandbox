# `code-sonarcloud-fallback`

[`code-sonarcloud-fallback.yml`](../code-sonarcloud-fallback.yml) workflow allows to pass Required "SonarCloud Code Analysis" Status Checks in pull request with changes outside the monitored paths:
- `code/**`
